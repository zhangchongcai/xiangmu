...
<script>
// import { getMoviePlanList, getSchPlanLang, getPriceSystem } from 'src/http/ctm/index.js'
import FixStepTool from "../../../../components/fix-step-tool/fix-step-tool";
import fixStepMixin from "../../../../mixins/ctm/fixStepTool.js";
import index from '../../../../vuex/ctm/tagNav';
        ...
        .then(ret => {
          ...
          if(ret.data){
            ...
            self.sizeForm.tmList = result.tmList.map((item,index)=>{
              ...
              if(item.monday == 1 && item.tuesday == 1 && item.wednesday == 1 && item.thursday == 1 && item.friday == 1 ){
                item.weekDay_checkAll= true
                item.isIndeterminate_week= false
              }else if(item.monday == 0 && item.tuesday == 0 && item.wednesday == 0 && item.thursday == 0 && item.friday == 0){
            ...
            //影片量处理
            if(result.schBashMovieList.length>0){
