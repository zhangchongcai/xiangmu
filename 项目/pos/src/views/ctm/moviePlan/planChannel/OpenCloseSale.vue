...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBaseChannelList() {
                this.$api.getBaseChannelList(this.searchForm).then( res => {
                    console.log(res)
                    if(res.code === 200) {
            ...
            setChannelStatus() {
                ...
                if(this.openStopFlag === 'open') {
                    this.$api.setChannelOpen({ channelList, planUids }).then( res => {
                        console.log(res)
                        if(res.code === 200) {
                            this.success('渠道开售成功！')
                    ...
                    this.$api.setChannelStop({ channelList, planUids }).then( res => {
                        console.log(res)
                        if(res.code === 200) {
                            this.success('渠道停售成功！')
                            this.dialogVisible = false
