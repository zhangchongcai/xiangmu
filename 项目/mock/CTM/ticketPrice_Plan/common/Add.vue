            ...
            <div class="table-bottom-menu">
              <div class="prcie-promise">
                <el-checkbox
                  label="允许包厢单卖"
                  name="type"
                  v-model="sizeForm.ciPriceProgram.permit_sale_box"
                ></el-checkbox>
              </div>
              <div class="prcie-promise">
                <el-checkbox
                  label="允许营销活动折扣、会员折扣"
                  name="type"
                  v-model="sizeForm.ciPriceProgram.permit_discount"
                ></el-checkbox>
              </div>
...
export default {
  ...
  methods: {
    ...
    movieListChange() {
      ...
      // console.log(' self.sizeForm.schBashMovieList', self.sizeForm.schBashMovieList)
    },
    ciPriceHallTypeChange() {
      ...
      console.log('self.sizeForm.schBashHallTypeList',self.sizeForm.schBashHallTypeList)
    },
    // *************************************************************************************************
    // 保存价格方案
    priceprogramSave(rulesSizeForm) {
      ...
      this.$refs[rulesSizeForm].validate(valid => {
        if (valid) {
          ...
          //包厢
          if (self.sizeForm.ciPriceProgram.permit_sale_box) {
            ciPriceProgram.permit_sale_box = 1;
          } else {
            ciPriceProgram.permit_sale_box = 0;
          }
          //折扣
          if (self.sizeForm.ciPriceProgram.permit_discount) {
            ciPriceProgram.permit_discount = 1;
          } else {
            ciPriceProgram.permit_discount = 0;
          }
