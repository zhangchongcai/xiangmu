  ...
  <div class="content">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>{{typeText}}采购入库单</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    >
      ...
      <div>
        ...
        <el-row>
          <el-col :span="10">
            <el-form-item label="采购单号" class="select-input">
            ...
            <el-form-item>
              <div slot="label">
                <el-select v-model="queryData.storageType">
                  <el-option key="0" label="入库仓库" value="0"></el-option>
                  <el-option key="1" label="入库货架" value="1"></el-option>
                </el-select>
              </div>
              <el-select v-model="queryData.storageName">
                <el-option key="0" label="总仓" value="0"></el-option>
                <el-option key="1" label="分仓" value="1"></el-option>
                <el-option key="2" label="前仓" value="2"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
