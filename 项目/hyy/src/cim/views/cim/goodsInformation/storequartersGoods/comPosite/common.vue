...
<!--    </div>-->
    ...
    <channel-dialog ref="myChannelDialog" @onSumit="onChanneSumit" :multiple="multipleCinemal"
                    ...
                    :check="routeQuery.type==3 &&  queryData.saleChannel!=1" :dialogFeedbackData="queryData.cinemaSaleChannelVoList"></channel-dialog>
    <!-- 选择销售地点 -->
    <sales-place ref="mySalesPlaceDialog" @onSumit="onSalesPlaceSumit" :cinemaUid="routeQuery.cinemaUid" :multiple="multipleCinemal"
                 :check="routeQuery.type==3 && queryData.salePlace!=1"  :title="salesPlaceTittle" :dialogFeedbackData="queryData.cinemaSalePlaceVoList"></sales-place>
    <!-- 选择商品 -->
    <selected-goods
