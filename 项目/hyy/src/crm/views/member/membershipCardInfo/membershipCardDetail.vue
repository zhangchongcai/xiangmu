  ...
  <div class="member-detail">
    ...
    <div class="crumbs-wrap">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>
          <router-link class="itemLink" :to="{path : '/membershipCard/list'}">会员卡信息管理</router-link>
        </el-breadcrumb-item>
    ...
    <div class="member-basic-info">
      <el-card shadow="hover" class="card-item">
        ...
        <div class="term-of-validity" v-if="cardDetail.cardTypeCode != 'stored_card'">{{cardDetail.startTime}}-{{cardDetail.endTime}}</div>
        ...
        <div class="status-wrap">
          ...
          <div class="change-status-btn" @click="handleChangeStatus(cardDetail.cardNo,'frozen')" v-if="cardDetail.status == 'normal'">冻结</div>
          <div class="change-status-btn" @click="handleChangeStatus(cardDetail.cardNo,'normal')" v-if="cardDetail.status == 'frozen'">解冻</div>
        </div>
      </el-card>
      ...
      <el-collapse-item title="交易记录" name="1">
        <el-form :inline="true" :model="formData" ref="formData" class="form-data-wrap">
          <el-form-item label="查询时间：" prop="date">
            <el-date-picker style="width:270px" v-model="formData.date" type="daterange" align="right" unlink-panels
          ...
          <el-form-item label="交易类型：" prop="source">
            <el-select v-model="formData.source" placeholder="全部类型" clearable style="width:206px">
        ...
        <div class="_m-member-table-custom">
          <el-table :data="tableDataList" stripe style="width: 100%" v-loading="listLoading" element-loading-text="拼命加载中...">
            ...
            <!-- <el-table-column prop="phone" label="订单号" min-width="120" show-overflow-tooltip></el-table-column> -->
            ...
            <el-table-column prop="amount" label="交易金额" min-width="100" show-overflow-tooltip></el-table-column>
            <el-table-column prop="totalBalance" label="余额" min-width="100" show-overflow-tooltip></el-table-column>
            <el-table-column prop="channelName" label="交易渠道" min-width="100" show-overflow-tooltip></el-table-column>
          </el-table>
        </div>
        <!-- 分页 start -->
        <div class="page-wrap">
