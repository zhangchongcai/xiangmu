<template>
  <div class="_add-member-tags">
          ...
          <div class="_member-label-basic-set">
            ...
            <el-form-item label="选择标签颜色：" prop="labelColor">
              <ul class="_label-color-wrap">
                <li v-for="(item, index) of labelColorArr" :key="index" class="_label-color-item"
                  :class="item.color==ruleForm.labelColor?'isSelectedColor':''"
                  :style="`background-color:${item.color}`" @click="handleSelectLabelColor(item.color)"></li>
              </ul>
            </el-form-item>
          ...
          <div class="_member-condition-setting">
            ...
            <div class="_member-condition-body">
              <ul class="_member-condition-left-radio-wrap">
                <li v-for="(item, index) of selectedRadioArr" :key="index" class="_member-condition-radio"
                  :class="item.flag==selectedRadio?'isSelectedRadio':''" @click="handleSelectRadio(item.flag)">
              ...
              <div v-for="(item, index) of checkboxArr" :key="index" style="position:relative">
                <div class="_member-condition-center-checkbox-wrap" v-if="item.flag == selectedRadio">
                  <el-checkbox-group v-model="item.selectedConditions"
                    @change="handleCheckedConditionsChange($event,item.flag)">
                    <el-checkbox v-for="condition in item.subCheckbox" :disabled="condition.code=='mobileNum'"
                      :label="condition.code" :key="condition.code">{{condition.name}}</el-checkbox>
                  </el-checkbox-group>
                </div>
              </div>
              <div class="_member-condition-right-content-wrap">
                ...
                <div class="_member-selected-condition">
                  ...
                  <el-form-item label="生日：" prop="birthday" v-if="itemIsShow('birthday')">
                    <el-date-picker v-model="ruleForm.birthday" type="daterange" value-format="yyyy-MM-dd"
                  ...
                  <el-form-item label="消费影院：" prop="cinema" v-if="itemIsShow('cinema')">
                    <div class="_consumer-cinema">
                      ...
                      <div class="_select-cinema-wrap">
                        <div class="_select-cinema-btn" v-show="!(ruleForm.cinema && ruleForm.cinema.length > 0)"
                          @click="chooseCinema">选择</div>
                        ...
                        <div slot="reference" class="cinema-list" v-show="ruleForm.cinema && ruleForm.cinema.length > 0"
                          @mouseover="isCinemaDelete=true" @mouseout="isCinemaDelete=false">
                          {{getArrCinemaListName(ruleForm.cinema)}}
                          <i v-if="isCinemaDelete" class="el-tag__close el-icon-close myclose"
                            @click.stop="clearSelectedCinema"></i>
                        </div>
                        <!-- </el-popover> -->
                        <div class="_edit-cinema-btn" v-show="ruleForm.cinema && ruleForm.cinema.length > 0"
                          @click="chooseCinema">
                          编辑
                        </div>
                      </div>
                  ...
                  <el-form-item label="会员卡类型：" prop="cardType" v-if="itemIsShow('cardType')"
                    class="_multiple-rows-lable">
                    <el-select v-model="ruleForm.cardType" multiple placeholder="请选择" class="_member-card-type">
                      <el-option v-for="item in cardTypeOptions" :key="item.code" :label="item.desc"
                  ...
                  <el-form-item label="开卡时间：" prop="openDate" v-if="itemIsShow('openDate')">
                    <div class="_openDate-type-wrap">
                      ...
                      <el-date-picker v-if="ruleForm.openDateType=='fixTime'" class="_openDate-fix-time"
                        v-model="ruleForm.openDateFixTime" type="daterange" value-format="yyyy-MM-dd"
                        range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                      </el-date-picker>
                  ...
                  <el-form-item label="卡到期时间：" prop="endTime" v-if="itemIsShow('endTime')" class="_multiple-rows-lable">
                    <div class="_openDate-type-wrap">
                      ...
                      <el-date-picker v-if="ruleForm.endTimeType=='fixTime'" class="_openDate-fix-time"
                        v-model="ruleForm.endTimeFixTime" type="daterange" value-format="yyyy-MM-dd" range-separator="至"
                  ...
                  <el-form-item label="可用券名称：" prop="couponName" v-if="itemIsShow('couponName')"
                    class="_multiple-rows-lable">
                    <div class="_select-cardType-wrap">
                      <div class="_select-cardType-btn"
                        v-show="!(ruleForm.couponName && ruleForm.couponName.length > 0)" @click="chooseCouponName">选择
                      </div>
                      <!-- <el-popover placement="bottom-start" popper-class="_member-custom-popover-style" :visible-arrow="false"
                        width="150" trigger="hover">
                        <ul>
                      ...
                      <div slot="reference" class="cardType-list"
                        v-show="ruleForm.couponName && ruleForm.couponName.length > 0"
                        @mouseover="isCouponNameDelete=true" @mouseout="isCouponNameDelete=false">
                        {{getArrCouponName(ruleForm.couponName)}}
                        <i v-if="isCouponNameDelete" class="el-tag__close el-icon-close myclose"
                          @click.stop="clearSelectedCouponName"></i>
                      </div>
                      <!-- </el-popover> -->
                      <div class="_edit-cardType-btn" v-show="ruleForm.couponName && ruleForm.couponName.length > 0"
                        @click="chooseCouponName">
                        编辑
                      </div>
                    </div>
                  </el-form-item>
                  <el-form-item label="消费渠道：" prop="channel" v-if="itemIsShow('channel')" class="_consumption-channels">
                    <el-select v-model="ruleForm.channel" multiple placeholder="请选择">
                      <el-option v-for="item in channelOptions" :key="item.code" :label="item.desc"
                        :value="item.desc+','+item.code">
                      </el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item label="消费次数：" prop="consumeTimes" v-if="itemIsShow('consumeTimes')">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.consumeTimesType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.consumeTimesFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="充值次数：" prop="chargeTimes" v-if="itemIsShow('chargeTimes')">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.chargeTimesType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.chargeTimesFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="累计消费金额：" prop="totalConsumeAmount" v-if="itemIsShow('totalConsumeAmount')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      <el-select v-model="ruleForm.totalConsumeAmountType" class="_three-types-select"
                        placeholder="请选择">
                        <el-option label="任意时间" value="anyTime"></el-option>
                        <el-option label="固定时间" value="fixTime"></el-option>
                        <el-option label="相对时间" value="relativeTime"></el-option>
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.totalConsumeAmountType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.totalConsumeAmountFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="累计充值金额：" prop="totalChargeAmount" v-if="itemIsShow('totalChargeAmount')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.totalChargeAmountType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.totalChargeAmountFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="影票消费次数：" prop="movieConsumeTimes" v-if="itemIsShow('movieConsumeTimes')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.movieConsumeTimesType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.movieConsumeTimesFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="影票消费金额：" prop="movieConsumeAmount" v-if="itemIsShow('movieConsumeAmount')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      <el-select v-model="ruleForm.movieConsumeAmountType" class="_three-types-select"
                        placeholder="请选择">
                        <el-option label="任意时间" value="anyTime"></el-option>
                        <el-option label="固定时间" value="fixTime"></el-option>
                        <el-option label="相对时间" value="relativeTime"></el-option>
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.movieConsumeAmountType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.movieConsumeAmountFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="卖品消费次数：" prop="shopConsumeTimes" v-if="itemIsShow('shopConsumeTimes')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.shopConsumeTimesType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.shopConsumeTimesFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="卖品消费金额：" prop="shopConsumeAmount" v-if="itemIsShow('shopConsumeAmount')"
                    class="_multiple-rows-lable">
                    <div class="_three-types-wrap">
                      ...
                      <div class="_right-content">
                        <el-date-picker v-if="ruleForm.shopConsumeAmountType=='fixTime'" class="_openDate-fix-time"
                          v-model="ruleForm.shopConsumeAmountFixTime" type="daterange" value-format="yyyy-MM-dd"
                          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                  ...
                  <el-form-item label="距上次消费天数：" prop="lastConsume" v-if="itemIsShow('lastConsume')"
                    class="_multiple-rows-lable">
                    <div class="_openDate-type-wrap">
    ...
    <!-- 使用影院弹层 -->
    <frameMultiCinema :dialogVisible.sync="dialogVisible" :innerCinemaMultiData="{type:2}" :disabledData="[]"
      :reviewData="innerCinemaMultiData" @frameCinemaDialogCallBack="handleCallBack" />
    <!-- 可用券名称弹层 -->
    <crmAvailableCoupon :dialogVisible.sync="CouponNameDialogVisible" :reviewData="innerCouponNameMultiData"
      @crmAvailableCouponDialogCallBack="handleCouponNameCallback" />
  </div>
</template>
<script>
      ...
      return totalArr.map(item => {
        ...
        if (item == "cardType") {
          return {
            lableType: "cardType",
            conditionType: "normal",
            conditionDetail: this.ruleForm.cardType.map(item => {
              return { desc: item.split(",")[0], code: item.split(",")[1] };
            }),
            unit: ""
          };
        }
        ...
        if (item == "channel") {
          return {
            lableType: "channel",
            conditionType: "normal",
            conditionDetail: this.ruleForm.channel.map(item => {
              return { desc: item.split(",")[0], code: item.split(",")[1] };
            }),
            unit: ""
          };
