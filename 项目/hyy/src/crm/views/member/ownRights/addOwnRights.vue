<template>
  <div class="add-own-rights-type">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" size="medium" label-width="105px" label-position="left">
      <el-collapse v-model="activeNames" class="card-type-content">
          ...
          <div class="card-type-basic-set">
            ...
            <el-form-item v-if="ruleForm.equityType == 'consumer_type'" label="权益类别：" :rules="{required:true}">
              <el-select v-model="ruleForm.equityCategory" placeholder="请选择" @change="equityCategoryChange">
                <el-option v-for="(item, index) in equityCategoryList" :key="index" :label="item.name"
            ...
            <el-form-item label="icon：" prop="logoPic">
              <div style="float:left">
                <label for="imgupload">
                  <img v-show="this.ruleForm.logoPic" style="width:148px;height:148px" :src="this.ruleForm.logoPic"
                    alt="">
                </label>
              </div>
        ...
        <el-collapse-item :title="stepData.stepList[1]?stepData.stepList[1].name:''" name="2"
          v-if="ruleForm.equityType == 'consumer_type' && ruleForm.equityCategory">
                    ...
                    <div class="unified-setup">
                      ...
                      <el-form-item label="优惠方式：" :prop="'movieList.'+ index" :rules="{
                        ...
                        <el-select v-model="domain.ticketSaleType" placehaolder="请选择" size="medium">
                          <el-option v-for="(item,index) in setOptions" :key="index" :label="item.label"
                            :value="item.value"></el-option>
                        </el-select>
              ...
              <div class="sale-preference">
                <div class="applicable-cinema-hall-wrap">
                  <div class="applicable-cinema-hall-inner">
                    <div class="unified-setup">
                      <!-- 卖品折扣 -->
                      <el-form-item label="适用影院：" class="shiyong_yingyuan" prop="goods.cinemaList"
                        :rules="{required: true, validator: checkSaleCinema, trigger: 'blur'}">
                        <div class="select-btn"
                          v-show="!(ruleForm.goods.cinemaList && ruleForm.goods.cinemaList.length > 0)"
                      ...
                      <el-form-item label="适用卖品：" class="shiyong_yingyuan" prop="goods.goodsList"
                        :rules="{required: true, validator: checkSaleName, trigger: 'change'}">
                        <div class="select-btn"
                          v-show="!(ruleForm.goods.goodsList && ruleForm.goods.goodsList.length > 0)"
                      ...
                      <el-form-item label="优惠方式：" prop="goods" :rules="{
                        ...
                        <el-select v-model="ruleForm.goods.goodsSaleType" placehaolder="请选择" size="medium">
                          <el-option v-for="(item,index) in goodsSaleDataList" :key="index" :label="item.label"
                            :value="item.value"></el-option>
                        </el-select>
                        <el-input v-model="ruleForm.goods.goodsSaleData" placeholder="请输入内容"
                          :disabled="!ruleForm.goods.goodsSaleType" size="medium"></el-input>
                      </el-form-item>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="applicable-cinema-hall-inner">
                    <div class="unified-setup">
                        ...
                        <el-row :gutter="20" align="middle">
                          <el-col :span="6">
                            <el-form-item label-width="100px" label="销售单号：" :prop="'ticketList.'+index+'.ticketNo'"
                              ...
                              <el-input readonly v-model="item.ticketNo" placeholder="销售单号" size="medium"
                                @focus="showccmSaleList('dai',index)">
                              </el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span="4">
                            <el-form-item label-width="50px" label="张数" class="maximum-subsidy-wrap"
                              :prop="'ticketList.'+index+'.totalNum'"
                            ...
                            <el-form-item label-width="120px" label="发放时间与张数：" required class="maximum-subsidy-wrap">
                              <div class="grid-content bg-purple">
                                <el-row :gutter="20">
                                  ...
                                  <el-col :span="9">
                                    <el-form-item :prop="'ticketList.'+index+'.num'"
                                      :rules="{required: true, validator: checkIntNum, trigger: 'blur'}">
                                      <div class="grid-content bg-purple" style="text-align: center">
                      ...
                      <div style="color:#3b74ff;margin-top:10px;margin-left:10px">
                        <el-row>
                          <el-col :span="1" style="width:25px">
                            <div class="grid-content bg-purple cursor" @click="addTicket"><i
                                class="el-icon-circle-plus-outline" style="color:#3b74ff;font-size:20px;"></i></div>
                          </el-col>
                          <el-col :span="1">
                    ...
                    <div class="unified-setup">
                      ...
                      <div>
                        <el-form-item label="发送时间：" prop="birthday.issueType" required class="birthday-time">
                          ...
                          <el-radio v-model="ruleForm.birthday.issueType" label="SAME_MONTH"
                            @change="clearBirthdayTime">生日当月首日</el-radio>
                        </el-form-item>
                        ...
                        <el-form-item>
                          <div v-if="ruleForm.birthday.birthdayCodeOrId.indexOf('代金券') != -1"
                            style="background:#f5f5f5;width:500px;padding-left: 13px;">
                            ...
                            <div style="margin-left:20px">
                              <el-form-item v-for="(voucheritem, index) in ruleForm.birthday.voucherList" :key="index"
                                ...
                                <el-row>
                                  ...
                                  <el-col :span="7">
                                    <div class="grid-content bg-purple">
                                      <div class="grid-content bg-purple">
                                        <el-form-item label="张数" label-width="50px"
                                          :prop="'birthday.voucherList.'+index"
                                  ...
                                  <el-col :span="2">
                                    <div class="grid-content bg-purple"
                                      v-show="ruleForm.birthday.voucherList.length > 1">
                              ...
                              <div style="color:#3b74ff;margin-top:8px;margin-left:10px">
                                <el-row>
                                  <el-col :span="1" style="width:25px">
                                    <div class="grid-content bg-purple cursor" @click="addVoucher"><i
                                        class="el-icon-circle-plus-outline"
                                        style="color:#3b74ff;font-size:20px;margin-top:8px"></i></div>
                                  </el-col>
                                  <el-col :span="2">
                                    <div class="grid-content bg-purple-light cursor" style="font-size:12px"
                                      @click="addVoucher">添加</div>
                                  </el-col>
                                </el-row>
                              </div>
                            </div>
                          </div>
                          <div v-if="ruleForm.birthday.birthdayCodeOrId.indexOf('兑换码') != -1"
                            style="background:#f5f5f5;width:500px;padding-left: 13px;">
                            ...
                            <div style="margin-left:20px">
                              ...
                              <div style="color:#3b74ff;margin-top:8px;margin-left:10px">
                                <el-row>
                                  <el-col :span="1" style="width:25px">
                                    <div class="grid-content bg-purple cursor" @click="addCdkey"><i
                                        class="el-icon-circle-plus-outline"
                                        style="color:#3b74ff;font-size:20px;margin-top:8px"></i></div>
                                  </el-col>
                                  <el-col :span="2">
                                    <div class="grid-content bg-purple-light cursor" style="font-size:12px"
                                      @click="addCdkey">添加</div>
                                  </el-col>
                                </el-row>
                              </div>
                            </div>
    ...
    <!-- 使用影院弹层 -->
    <frameMultiCinema :dialogVisible.sync="dialogVisible" :innerCinemaMultiData="{type:2}" :whereUse="whereUse"
