<template>
    <div class="details">
        ...
        <div class="content">
            <table>
                <tbody>
                    <tr><th>票版名称：</th><td>{{attribute.name}}</td></tr>
                    <tr><th>票版宽度：</th><td>{{Math.ceil(attribute.width/3.99)}}毫米</td></tr>
                    <tr><th>票版高度：</th><td>{{Math.ceil(attribute.height/3.99)}}毫米</td></tr>
                    <tr><th>第三方票类专用：</th><td>{{attribute.isOtherUse?"是":"否"}}</td></tr>
                    <tr><th>打印标题：</th><td>{{attribute.isPrinTitle?"是":"否"}}</td></tr>
                    <tr><th>打印方向：</th><td>{{attribute.printMode==1?"横向":"纵向"}}</td></tr>
                </tbody>
            </table>
            <div class="btn">   
