                    ...
                    <div class="input-box">
                        <div>
                            ...
                            <el-form-item label="本次收款日期：" prop="dateOfApplication" >
                                <el-date-picker v-model="form.dateOfApplication" align="right" type="date" placeholder="选择日期" ></el-date-picker>
                            </el-form-item>
                        </div>
                        <div>
                            <el-form-item label="支付方式：" prop="payTypeName" >
                                ...
                                :readonly=true 
                                >
                                <i slot="suffix" class="el-icon-circle-close close"  @click="clearInputValue()" v-show="form.payTypeName"></i>
                                </el-input>
...
<script>
import payType from 'ccm/dialogs/payType'
export default {
    components: {
        payType
    },
