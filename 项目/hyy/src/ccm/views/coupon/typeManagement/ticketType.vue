...
<div class="coupon-addTicket">
    ...
    <el-form :model="form" :rules="rules" ref="form" label-width="80px">
        ...
        <section class="flex-base flex-center">
            <el-row>
                <el-button type="primary" @click="confirm('form')" style="width:80px;heigth:32px;">确定</el-button>
                <el-button @click="returnPage(true)" style="width:80px;heigth:32px;margin-left:27px">取消</el-button>
            </el-row>
        </section>
    </el-form>
</div>
