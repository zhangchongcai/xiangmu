<template>
    <div class="page-wrapper">
        ...
        <frame-singlecinema :framedialogVisible="singleCinemaVisible" :whereUse="whereUse" type="1" 
        :innerData="innerDataSingle" @callBackSingle="handleSingleCallBack" ref='frameSingleCinema'>
            <div slot="footerId">
