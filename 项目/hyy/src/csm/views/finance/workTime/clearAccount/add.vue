<template>
  <div class="cinemaList">
    ...
    <myDialog  ref="myDialog" :title="title" :dialogTableVisible.sync="dialogTableVisible" :isVip="isVip" :isOther="isOther"
      :isTwo="isTwo" :gridData="gridData" @chooseuUserName='chooseuUserName'
