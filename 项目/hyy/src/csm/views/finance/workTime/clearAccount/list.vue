  ...
  <div class="cinemaList">
      ...
      <el-form :inline="true" class="demo-form-inline search-form" size="small" label-width="100px">
        ...
        <!-- 弹出层2 -->
          <el-dialog title="查找制单人" :visible.sync="dialogTableVisible2">
            <el-form :model="searchAdition" label-width="60px" :inline="true">
              ...
              <el-button type="primary"  @click="getCreater">查询</el-button>
            </el-form>
            ...
            <div class="block">
             <el-pagination  @current-change="handleCurrentChange" background
                :current-page.sync="dialog.currentPage" :page-size="100" layout="prev, pager, next, jumper, total"
                :total="dialog.total">
              </el-pagination>
            </div>
        ...
        <el-form-item>
          <div class="search-time">
            ...
            <el-date-picker v-model="timeRange" type="daterange" unlink-panels range-separator="~" start-placeholder="yyyy-MM-dd"
        ...
        <el-form-item label="单据状态:">
          <el-select v-model="searchAdition.status">
            ...
            <el-option label="已情机" value="3">已情机</el-option>
          </el-select>
        </el-form-item>
    ...
    <div class="content">
      ...
      <div class="page-wrap">
        <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="current"
          :page-sizes="[10, 20, 30]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total"></el-pagination>
      </div>
    </div>
    <!-- 弹出层1 -->
    <el-dialog title="查找收银员" :visible.sync="dialogTableVisible1" required>
            <el-form :model="searchAdition" label-width="60px" :inline="true">
              ...
              <el-button type="primary" @click="getWorker" style="margin-top:4px;">查询</el-button>
            </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$csmList.clearaccountList(Object.assign({}, addition),this.current,this.pageSize)
          .then(data => {
            console.log(data)
