    ...
    <div class="cinemaList">
          ...
          <el-row :gutter="21">
            ...
            <el-col :span="14">
              <el-form-item label="关联单号:">
                <span v-for="(item,index) in relationBill" :key="index" class="can_click"
                  @click="relationPage(item)">{{item}}</span>
      ...
      <div class="table_div">
        <p class="div_title">
          ...
          <el-button plain class="title_btn" type="primary" @click="readGoodCode" style="width:100px" v-if="!canShow">查看取货码</el-button>
            ...
            .then(data => {
              ...
              if (data && data.code === 200) {
                ...
                this.goodList.map(item => {
                  ...
                  item.rejectReturnStatus = item.rejectReturnStatus == "1" ? "已生效" : item.rejectReturnStatus == "2" ?"未生效":"——"
