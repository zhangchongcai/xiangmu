      ...
      <el-form label-width="" :inline="true">
        <div style="position:relative"  v-if="windowType=='选择用户'">
            <el-form-item label="用户账号" class="two_search">
                <el-input v-model="userId" style="width:152px"></el-input>
            </el-form-item>
        ...
        <div style="position:relative"  v-if="windowType=='选择角色'">
            <el-form-item label="角色名称" class="two_search">
                <el-input v-model="name" style="width:152px"></el-input>
            </el-form-item>
            <el-form-item label="状态:">
                <el-select v-model="userStatus" style="width:184px">
                    <el-option label="全部" value>全部</el-option>
      ...
      <div class="choose_table">
        <div >
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0}
             ref="multipleTable" @select-all="selectAll"  :row-key="getRowKeys" @selection-change="select" v-if="windowType=='选择用户'">
          ...
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0}
             ref="multipleTable" @select-all="selectAll"  :row-key="getRowKeys" @selection-change="select" v-if="windowType=='选择角色'">
            <el-table-column type="selection" width="40" :reserve-selection="true"></el-table-column>
