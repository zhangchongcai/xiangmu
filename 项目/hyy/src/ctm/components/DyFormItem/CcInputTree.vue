<!--Created by 詹陈龙 on 2019/5/29.-->
<template>
  <div>
    <el-popover :popperClass="'dialog-popover'" ref="popover" placement="bottom" trigger="click" v-model="show">
      <el-tree ref="tree" :data="options" :show-checkbox="multiSelect" v-on="$listeners" :highlight-current="true" :default-expanded-keys="selectedKeys" :node-key="valueField" check-on-click-node :check-strictly='false' :props="props" v-if="forceUpdate" v-bind="$attrs" @check-change="checkChange"></el-tree>
    </el-popover>
