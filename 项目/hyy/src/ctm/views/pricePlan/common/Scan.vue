                    ...
                    <div class="basic-info">
                        ...
                        >
                            ...
                            <el-form-item label="适用影片：">
                               ...
                               <span v-if="sizeForm.schBashMovieList &&sizeForm.schBashMovieList.length==0" class="cinema-stock-scan-text">
                                        不限影片
                                </span>
                            </el-form-item>
                            ...
                            <el-tab-pane label="柜台/自助" name="first">
                                ...
                                <el-form-item label="适用渠道：">
                                        <template v-for="(ciPriceSaleChannelVoItem,index) in sizeForm.ciPriceSaleChannelVoList">
                                         ...
                                         <span class="cinema-stock-scan-text" v-if='outLineFlag'>
                                                暂无
                                        </span>
                                    </el-form-item>
                            ...
                            <el-tab-pane label="线上网售" name="second">
                                ...
                                >
                                    <el-form-item label="适用渠道：">
                                        ...
                                        <span class="cinema-stock-scan-text"  v-if='onlilneFlag'>
                                                暂无
                                        </span>
                                    </el-form-item>
                                    <el-form-item label="定价方案：">
             ...
             getDatas() {
                ...
                self.$ctmList
                    ...
                    if(ret.data){
                        ...
                        if(self.sizeForm.ciPriceSaleChannelVoList.every((item)=>{return item.feeFlag != 0})){
                            self.outLineFlag = 1
                        }
                        if(self.sizeForm.ciPriceSaleChannelVoList.every((item)=>{return item.feeFlag != 2})){
                            self.onlilneFlag = 1
                        }
                    }
