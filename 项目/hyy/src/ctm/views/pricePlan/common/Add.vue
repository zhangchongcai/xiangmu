<template>
  <div class="movie-price-plan">
          ...
          > -->
            ...
            <el-form-item label="适用影厅：" prop="ciPriceHallType">
              <el-select v-model="sizeForm.ciPriceProgram.ciPriceHallType" placeholder="请选择影厅"
                @change='ciPriceHallTypeChange' multiple remove-tag>
            ...
            <el-form-item label="有效日期：" prop="tiemStart_end">
              <el-date-picker v-model="sizeForm.ciPriceProgram.tiemStart_end" value-format="yyyy-MM-dd" type="daterange"
              ...
              <div class="time-interval" v-for='(item, index) in sizeForm.tmList' :key="index">
                ...
                <div class="time-interval-1">
                  ...
                  <div class="time-interval-week">
                    ...
                    <el-checkbox v-model="item.wednesday" @change="handleCheckedWeekChange($event,index)" true-label="1"
                      false-label="0">周三</el-checkbox>
                    <el-checkbox v-model="item.thursday" @change="handleCheckedWeekChange($event,index)" true-label="1"
                      false-label="0">周四</el-checkbox>
                ...
                <div class="time-interval-2">
                  ...
                  <div class="time-interval-weekend">
                    ...
                    <el-checkbox v-model="item.sunday" @change="handleCheckedWeekendChange($event,index)" true-label="1"
                      false-label="0">周日</el-checkbox>
                  </div>
            ...
            <el-tabs v-model="activeTab" type="card" @tab-click="handleClick">
              <el-tab-pane label="柜台/自助" name="first">
                ...
                <el-form-item label="适用渠道：" style="margin-bottom: 0;" prop="price_Channel_1">
                  <el-checkbox-group v-model="price_Channel_1" @change='handleCheckedChannel_change_1'>
                    <el-checkbox v-for="chanel in channelsList_1" :key="chanel.uid" :label="chanel.uid">{{chanel.name}}
                    </el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
                ...
                <el-form-item label="适用票类：">
                  ...
                  <div>
                    ...
                    <el-table :data="ttVoList" ref="multipleTable1" @selection-change="handleSelectionTtVoListChange">
                        ...
                        <template slot-scope="scope">
                          ...
                          <span class="input-con">
                            <el-input type="number" maxlength="9" v-model="scope.row.price"
                              @change="priceChange1(scope.row.price,scope.$index)"></el-input><i class="rmb-hover">¥</i>
                          </span>
                        </template>
                      </el-table-column>
                    </el-table>
              ...
              <el-tab-pane label="线上网售" name="second">
                ...
                <div>
                  ...
                  <el-table class="edit-cichannel-table" ref="multipleTable2" :data="priceNetSale"
    ...
    <div class="price-add-button-wrap">
      <div class="btn-area">
        <el-button type="primary" @click="priceprogramSave('rulesSizeForm')">保存</el-button>
      ...
      priceprogramSave(rulesSizeForm) {
        ...
        this.$refs[rulesSizeForm].validate(valid => {
          if (valid) {
            ...
            //判断适用时段是否选择
            if (!self.sizeForm.tmList.some((item, index) => {
