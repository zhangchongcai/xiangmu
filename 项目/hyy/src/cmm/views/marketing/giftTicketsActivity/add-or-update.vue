...
<div class="movie-plan_default" :class="{isTableCheck:isEdit == 'detail'}">
        ...
        <el-form :model="basicDataForm" :rules="basicDataRule" ref="basicDataForm" label-width="120px" class="common-form">
            ...
            <el-collapse-item title="设置活动条件" name="2">
                <el-row class="flex-base">
                    <el-form-item :label="basicDataForm.activityType == 30?'注册影院:':'交易影院:'" prop="tradingMerchant">
                        <el-select v-model="basicDataForm.tradingMerchant" :disabled="disabled" @change="clearSelfValidate(basicDataForm.tradingMerchant)">
                            <el-option label="包含" value="normalIn"></el-option>
                            <el-option label="不包含" value="normalNotIn"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item prop="tradingMerchantInput" class="tradingMerchantInput">
                        ...
                        <el-tooltip placement="bottom" v-show="basicDataForm.tradingMerchantInput">
                            <el-input class="chooseWidth1" v-model="basicDataForm.tradingMerchantInput" v-if="basicDataForm.tradingMerchant=='normalIn'" readonly></el-input>
                            <div slot="content">
                    ...
                    <el-form-item label="放映有效期:">
                        <el-row class="flex-base">
                            ...
                            <el-form-item v-if="basicDataForm.screeningValidity=='TimeBetweenOperator'" prop="screeningValidityOption">
                                <el-date-picker v-model="basicDataForm.screeningValidityOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" :disabled="disabled" style="position: relative;top: 3px;margin-top: 0;" @change="setOpenCardDate"></el-date-picker>
                            </el-form-item>
                ...
                <el-form-item label="首充金额:" v-if="basicDataForm.activityType==30">
                    <el-row class="flex-base">
                        <el-select v-model="basicDataForm.firstChargeAmount" :disabled="disabled">
                            <el-option label="不限" value=""></el-option>
                            <el-option label="大于" value="normalGreater"></el-option>
                            <el-option label="等于" value="normalEqual"></el-option>
                            <el-option label="小于" value="normalLess"></el-option>
                ...
                <div v-if="basicDataForm.activityType==31">
                    ...
                    <el-form-item label="单次充值金额:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.chargeAmount" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                    ...
                    <el-form-item label="累计充值金额:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.chargeAmountSum" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                                <el-option label="大于" value="normalGreater"></el-option>
                                <el-option label="等于" value="normalEqual"></el-option>
                                <el-option label="小于" value="normalLess"></el-option>
                    ...
                    <el-form-item label="累计消费金额:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.consumeAmountSum" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                                <el-option label="大于" value="normalGreater"></el-option>
                                <el-option label="等于" value="normalEqual"></el-option>
                                <el-option label="小于" value="normalLess"></el-option>
                    ...
                    <el-form-item label="生日:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.birthday" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                    ...
                    <el-form-item label="开卡年限:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.openCardYears" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                                <el-option label="大于" value="normalGreater"></el-option>
                                <el-option label="等于" value="normalEqual"></el-option>
                                <el-option label="小于" value="normalLess"></el-option>
                            ...
                            <div v-if="basicDataForm.openCardYears=='BetweenOperator'||basicDataForm.openCardYears=='not_BetweenOperator'">
                                <el-row class="flex-base">
                                    <el-form-item :prop="'openCardYearsLimits.'+0" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[0]" :disabled="disabled" placeholder="请输入"></el-input>
                                    </el-form-item>
                                    <span>-</span>
                                    <el-form-item :prop="'openCardYearsLimits.'+1" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[1]" :disabled="disabled" placeholder="请输入"></el-input>
                                    </el-form-item>
                                </el-row>
                            </div>
                        </el-row>
                    ...
                    <el-form-item label="开卡月限:">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.openCardMonths" :disabled="disabled">
                                <el-option label="不限" value></el-option>
                                <el-option label="大于" value="normalGreater"></el-option>
                                <el-option label="等于" value="normalEqual"></el-option>
                                <el-option label="小于" value="normalLess"></el-option>
                            ...
                            <div v-if="basicDataForm.openCardMonths=='BetweenOperator'||basicDataForm.openCardMonths=='not_BetweenOperator'">
                                <el-row class="flex-base">
                                    <el-form-item :prop="'openCardMonthsLimits.'+0" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[0]" :disabled="disabled" placeholder="请输入"></el-input>
                                    </el-form-item>
                                    <span>-</span>
                                    <el-form-item :prop="'openCardMonthsLimits.'+1" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[1]" :disabled="disabled" placeholder="请输入"></el-input>
                                    </el-form-item>
                                </el-row>
                            </div>
                        </el-row>
                ...
                <el-form-item label="开卡日期:" v-if="basicDataForm.activityType!=32">
                    <el-row class="flex-base">
                        ...
                        <el-form-item prop="openDateCardOption" v-if="basicDataForm.openCardDate=='DateRangeContainOperator'||basicDataForm.openCardDate=='not_DateRangeContainOperator'">
                            <el-date-picker v-model="basicDataForm.openDateCardOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" :disabled="disabled" style="position: relative;top: 3px;margin-top: 0;" @change="setOpenCardDate"></el-date-picker>
                        </el-form-item>
            ...
            <el-collapse-item title="设置优惠方案" name="3">
                <el-form-item label="选择赠送票券:" prop="giftTicketInput">
                    <el-input class="input-type-166" v-model="basicDataForm.giftTicketInput"  :disabled="disabled" readonly></el-input>
                ...
                <el-form-item label="数量:" prop="num">
                    <el-input class="input-type-94" v-model="basicDataForm.num" :disabled="disabled" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="是否发送短信:">
                    <el-select v-model="basicDataForm.isSendSms" :disabled="disabled">
                ...
                <!-- <div v-if="basicDataForm.isSendSms == 'send'">
                    <el-form-item label="选择方式:">
                        <el-form-item>
                            ...
                            <el-select v-if="basicDataForm.messageMode == 'template'" v-model="basicDataForm.messageTemplate" :disabled="disabled">
                    ...
                    <el-form-item label="短信内容:">
                        <el-input type="textarea" :rows="8" style="width: 400px;" v-model="basicDataForm.messageContent" :disabled="disabled" placeholder="请输入短信内容(提醒:一条短信超过70个字的部分，以新的短信计算)" ></el-input>
    ...
    <section class="alert-group">
        ...
        <!-- 票券批次弹窗 -->
        <couponBatchDialog
            :title="couponBatchDialog.title" 
            :dialogTableVisible.sync="couponBatchDialog.couponBatchDialogVisible" 
            ref="giftCouponBatchDialog"
            @callBack="handleGiftCouponBatchCallBack"
        >
        </couponBatchDialog>
        <!-- 票券批次单选弹窗 -->
        <couponBatchSingleDialog
            :title="couponBatchSingleDialog.title" 
            :dialogTableVisible.sync="couponBatchSingleDialog.couponBatchSingleDialogVisible" 
            ref="giftCouponBatchSingleDialog"
            @callBack="handleGiftCouponBatchSingleCallBack"
        >
        </couponBatchSingleDialog>
        <!-- 交易渠道弹窗 -->
                ...
                this.$cmmList
                    ...
                    .then(res => {
                        if (res && res.code === 200) {
                            ...
                            console.log(this.basicDataForm.validDateOption)
