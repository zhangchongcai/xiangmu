  ...
  <div class="movie-plan_default">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item
          class="primary"
        >{{isEdit=="update" ? '修改' : (isEdit=="detail" ? '查看' : (isEdit=="copy" ? '复制' : '新建'))}}赠送票券活动</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
        ...
        <el-collapse-item title="设置活动条件" name="2">
          ...
          <div v-if="basicDataForm.activityType==32">
            <el-form-item label="放映效果">
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.projectionEffect!=''"
                v-model="basicDataForm.projectionEffectInput"
                readonly
              ></el-input>
              <el-button
                type="primary"
            ...
            <el-form-item label="影厅类型">
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.studioType!=''"
                v-model="basicDataForm.studioTypeInput"
                readonly
              ></el-input>
              <el-button
                type="primary"
            ...
            <el-form-item label="影片">
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.film!=''"
                v-model="basicDataForm.filmInput"
                readonly
              ></el-input>
              <el-button
                type="primary"
            ...
            <el-form-item label="影片类型">
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.filmType!=''"
                v-model="basicDataForm.filmTypeInput"
                readonly
              ></el-input>
              <el-button
                type="primary"
            ...
            <el-form-item label="放映有效期">
              ...
              <el-date-picker
                v-if="basicDataForm.screeningValidity=='TimeBetweenOperator'"
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.screeningValidity=='DayContainOperator'||basicDataForm.screeningValidity=='not_DayContainOperator'"
                v-model="basicDataForm.screeningValidityInput"
                :disabled="disabled"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="最低发行价">
              ...
              <span v-if="basicDataForm.issuePrice!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.issuePriceInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
            ...
            <el-form-item label="商品名称" prop="tradeName">
              ...
              <el-input
                class="chooseWidth1"
                v-if="basicDataForm.tradeName!=''"
                v-model="basicDataForm.tradeNameInput"
                readonly
              ></el-input>
              <el-button
                type="primary"
            ...
            <el-form-item label="卖品单价" prop="goodsSold">
              ...
              <span v-if="basicDataForm.goodsSold!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.goodsSoldInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
          ...
          <div v-if="basicDataForm.activityType==31">
            ...
            <el-form-item label="单次充值金额">
              ...
              <span v-if="basicDataForm.sumPrice!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.chargeAmountInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
            ...
            <el-form-item label="累计充值金额">
              ...
              <span v-if="basicDataForm.chargeSum!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.chargeAmountSumInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
            ...
            <el-form-item label="累计消费金额">
              ...
              <span v-if="basicDataForm.consumeSum!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.consumeAmountSumInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
            ...
            <el-form-item label="生日">
              ...
              <span v-if="basicDataForm.birthday=='EqualCurrentMonthOffset'">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.birthdayInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
              </span>
            ...
            <el-form-item label="开卡年限">
              ...
              <span v-if="basicDataForm.openYears!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.openCardYearsInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
              </span>
            ...
            <el-form-item label="开卡月限">
              ...
              <span v-if="basicDataForm.openMonths!=''">
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.openCardMonthsInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
              </span>
          ...
          <el-form-item label="开卡日期" v-if="basicDataForm.activityType!=32">
            ...
            <el-date-picker
              v-if="basicDataForm.openCardDate=='DateRangeContainOperator'||basicDataForm.openCardDate=='not_DateRangeContainOperator'"
              v-model="basicDataForm.openDateCardOption"
              type="daterange"
              range-separator="至"
              start-placeholder="开始日期"
              end-placeholder="结束日期"
              value-format="yyyy-MM-dd"
              :disabled="disabled"
              @change="setOpenCardDate"
            ></el-date-picker>
            <el-date-picker
              v-if="basicDataForm.openCardDate!='DateRangeContainOperator'&&basicDataForm.openCardDate!='not_DateRangeContainOperator'&&basicDataForm.openCardDate!=''"
              v-model="basicDataForm.openCardDateInput"
              style="width: 200px;"
              type="date"
              placeholder="选择日期"
              value-format="yyyy-MM-dd"
        ...
        <el-collapse-item title="设置优惠方案" name="3">
          <el-form-item label="选择赠送票券">
            <el-input
              ...
              v-model="basicDataForm.giftTicketInput"
              :disabled="disabled"
              placeholder="请输入"
            ></el-input>
        ...
        <el-collapse-item title="设置活动预算" name="4">
          <el-form-item label="活动总预算" prop="activityBudgetSum">
            ...
            <div v-if="basicDataForm.activityBudgetSum==1">
              <span v-if="basicDataForm.activityType==30">开卡总数量限制</span>
              <span v-if="basicDataForm.activityType==31">充值次数限制</span>
              <span v-if="basicDataForm.activityType==32">交易次数限制</span>
              <el-input
                style="width:20%;"
                v-model="basicDataForm.activityBudgetSumInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span v-if="basicDataForm.activityType==30">张</span>
              <span v-else>次</span>
            </div>
          </el-form-item>
          <el-form-item label="单用户限制" prop="singleUserLimit" v-if="basicDataForm.activityType!=30">
            ...
            <div v-if="basicDataForm.singleUserLimit==1">
              ...
              <el-input
                style="width:20%;"
                v-model="basicDataForm.singleUserLimitInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>次</span>
  ...
  data() {
    return {
      ...
      basicDataRule: {
        ...
        activityBudgetSum: [
          { required: true, message: "活动总预算不能为空", trigger: "change" }
        ],
        singleUserLimit: [
          { required: true, message: "单用户限制不能为空", trigger: "change" }
        ]
      },
      ...
      basicDataForm: {
       ...
       /* 基础信息-时段范围 */
        ...
        screeningPeriod: "",
        screeningPeriodOptions: [{ screeningPeriodOption: "" }], //放映时段范围
  ...
  methods: {
   ...
   /*时段范围- 全选工作日 */
    ...
    alertWindowMerchant(data) {
      ...
      this.basicDataForm.tradingMerchantInput = data.data.param1.join(",");
    },
    // 会员等级
