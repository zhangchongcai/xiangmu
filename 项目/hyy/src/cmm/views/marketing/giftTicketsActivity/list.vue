...
<div class="mod-user">
    ...
    <!-- 打开新建、编辑页 -->
    <add-gift-tickets v-if="pageShow=='addAct'" ref="addOrUpdate" @refreshDataList="search"></add-gift-tickets>

</div>
</template>

<script>
import AddGiftTickets from './add-or-update';
    ...
    methods: {
        ...
        setParam() {
            ...
            let pageData = {
                ...
                ruleTemplateId: this.searchParam.ruleTemplateId ? this.searchParam.ruleTemplateId : '30,31,32',
