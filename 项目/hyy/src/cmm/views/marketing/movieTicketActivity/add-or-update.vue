  ...
  <div class="movie-plan_default">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item>影票营销活动</el-breadcrumb-item>
        <el-breadcrumb-item>影票活动总览</el-breadcrumb-item>
        <el-breadcrumb-item
          class="primary"
        >{{isEdit=="update" ? '修改' : (isEdit=="detail" ? '查看' : (isEdit=="copy" ? '复制' : '新建'))}}影票活动</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
        ...
        <el-collapse-item title="活动基础信息" name="1">
          ...
          <el-form-item label="执行策略" size="mini" prop="executeMode">
            <el-radio-group v-model="basicDataForm.executeMode" :disabled="disabled">
              <el-radio :label="'AUTO_MATCH'">自动执行</el-radio>
              <el-radio :label="'AUTO_MATCH_RECOMMEND'">推荐执行</el-radio>
              <el-popover
...
当同一个优先级存在多个匹配的活动时，系统提示操作员手工选择执行。">
        ...
        <el-collapse-item title="设置活动条件" name="2">
          ...
          <el-form-item label="消费者身份">
            ...
            <el-input
              class="chooseWidth1"
              v-if="basicDataForm.consumerIdentity=='AppointMember'"
              v-model="consumerIdentityInput"
              readonly
            ></el-input>
            <el-button
              type="primary"
          ...
          <el-form-item label="放映有效期">
            <el-select
              v-model="basicDataForm.screeningValidity"
              :disabled="disabled"
              clearable
        ...
        <el-collapse-item title="设置优惠方案" name="3">
          <!-- 打折 -->
          <el-form-item label="优惠设置" v-if="basicDataForm.activityType==14">
            <span>折扣</span>
            <el-input
              style="width:20%; margin-right:6px;"
          ...
          <el-form-item label="优惠设置" v-if="basicDataForm.activityType==15">
            <span>立减</span>
            <el-input
              style="width:20%;"
              v-model="basicDataForm.discount"
          ...
          <!-- 减至 -->
          <el-form-item label="优惠设置" v-if="basicDataForm.activityType==16">
            <span>定价</span>
            <el-input
              style="width:20%;"
              v-model="basicDataForm.discount"
          ...
          <el-form-item label="低于最低价时">
            <el-select v-model="basicDataForm.miniPrice" :disabled="disabled" clearable>
            ...
            <span v-if="basicDataForm.miniPrice=='cinemaPay'">
              <span>最多补贴N元</span>
              <el-input
                style="width:20%; margin-right:6px;"
                v-model="basicDataForm.miniPriceInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
            </span>
          ...
          <el-form-item label="调价商品数量">
            <el-select v-model="basicDataForm.roundingNum" :disabled="disabled" clearable>
            ...
            <span v-if="basicDataForm.roundingNum!='all'">
              <span>数量</span>
              <el-input
                style="width:20%;"
                v-model="basicDataForm.roundingNumInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>个</span>
        ...
        <el-collapse-item title="设置活动预算" name="4">
          ...
          <el-form-item label="活动总预算" prop="activityBudgetSum">
            ...
            <div v-if="basicDataForm.activityBudgetSum==1">
              ...
              <el-input
                style="width:20%;"
                v-model="basicDataForm.totalTicketsAmount"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>张</span>
              ...
              <el-input
                style="width:20%;"
                v-model="basicDataForm.totalDiscountAmount"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>元</span>
          ...
          <el-form-item label="活动总预算周期限制" prop="activityBudgetCycle">
            <div>
              <el-select
                v-model="basicDataForm.activityBudgetCycle"
                :disabled="disabled"
                @change="handleActivityBudgetChange"
              >
                <el-option label="不限制" value></el-option>
              ...
              <el-date-picker
                v-if="basicDataForm.activityBudgetCycle == 'appointTimeRange'"
                v-model="basicDataForm.activityBudgetCycleDate"
                type="daterange"
                range-separator="至"
                start-placeholder="开始日期"
                end-placeholder="结束日期"
            ...
            <span v-if="basicDataForm.activityBudgetCycle!=''">
              ...
              <el-input
                style="width:20%;"
                v-model="basicDataForm.activityBudgetCycleInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>个</span>
...
export default {
  data() {
    ...
    return {
      ...
      basicDataRule: {
        ...
        amountCalculation: [
          { required: true, message: "预算金额计算不能为空", trigger: "change" }
        ],
        activityBudgetSum: [
      ...
      isShowAlertMerchant: false, //是否显示选择商户弹窗
  ...
  methods: {
            ...
            if (res && res.code === 200) {
              ...
              for (let item of ruleConditions) {
                if (item.key == "businessCode") {
                  ...
                  this.basicDataForm.screeningPeriodOptions = item.value != "" ? JSON.parse(item.value) : [];
    ...
    buildCommonInfoData() {
      ...
      if (this.basicDataForm.excludeDate.indexOf('指定排除日期范围')!=-1) {
        ...
        let targetValue = this.basicDataForm.excludeDateOptions.map(item => {
          if (item.excludeDateOption) {return item.excludeDateOption;}
        });
        this.commonInfo.push({
          category: "CommonInfo",
    ...
    buildBizPropertyMap() {
      ...
      this.bizPropertyMap = {
        runAmount:this.basicDataForm.activityBudgetCycle?this.basicDataForm.activityBudgetCycleInput:'',
        budgetSet: this.basicDataForm.amountCalculation? this.basicDataForm.amountCalculation : "",
        runRestrainType: this.basicDataForm.activityBudgetCycle? this.basicDataForm.activityBudgetCycle: "",
    ...
    dataFormSubmit(flag) {
      ...
      let ruleGroup = {
        ...
        priority:this.basicDataForm.priority == 1? this.basicDataForm.priorityNum: 100,
