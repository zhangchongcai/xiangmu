  ...
  <div class="movie-plan_default">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item
          class="primary"
        >{{isEdit=="update" ? '修改' : (isEdit=="detail" ? '查看' : (isEdit=="copy" ? '复制' : '新建'))}}赠送余额</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
当同一个优先级存在多个匹配的活动时，系统提示操作员手工选择执行。"
        ...
        <el-collapse-item title="设置活动条件" name="2">
          ...
          <el-form-item label="首充金额" v-if="basicDataForm.activityType==27">
            ...
            <span v-if="basicDataForm.firstChargeAmount!=''">
              <el-input
                style="width:20%; margin-right:6px;"
                v-model="basicDataForm.firstChargeAmountInput"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>元</span>
        ...
        <el-collapse-item title="设置活动预算" name="4">
          <el-form-item label="活动总预算" prop="activityBudgetSum">
            ...
            <div v-if="basicDataForm.activityBudgetSum==1">
              <span v-if="basicDataForm.activityType==27">开卡总数量限制</span>
              <span v-if="basicDataForm.activityType==28">充值次数限制</span>
              <span v-if="basicDataForm.activityType==29">交易次数限制</span>
              <el-input
                style="width:20%;"
                ...
                placeholder="请输入"
              ></el-input>
              <span v-if="basicDataForm.activityType==27">张</span>
              <span v-else>次</span>
            </div>
          </el-form-item>
