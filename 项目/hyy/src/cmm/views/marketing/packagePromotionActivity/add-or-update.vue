  ...
  <div class="movie-plan_default">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item
          class="primary"
        >{{isEdit=="update" ? '修改' : (isEdit=="detail" ? '查看' : (isEdit=="copy" ? '复制' : '新建'))}}套票活动</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
        ...
        <el-collapse-item title="设置活动条件" name="2">
          ...
          <el-form-item label="消费者身份">
            ...
            <el-input
              ...
              v-model="basicDataForm.consumerIdentityInput"
              readonly
            ></el-input>
            <el-button
              type="primary"
          ...
          <div class="combination">
            组合商品设置
            <span class="ticketSetting">影票设置</span>
            <el-form-item label="影票数量" prop="ticketNum">
              <el-input
                v-model="basicDataForm.ticketNum"
                placeholder="请输入影票数量"
                :disabled="disabled"
              ></el-input>
            </el-form-item>
            ...
            <span class="ticketSetting" style="margin-left: 60px;">卖品设置</span>
            ...
            <el-form-item label="卖品数量">
              <span>
                <el-input
                  style="width:20%; margin-right:6px;"
                  v-model="basicDataForm.goodsNumInput"
                  :disabled="disabled"
                  placeholder="请输入"
                ></el-input>
                <span>元</span>
  ...
  data() {
    return {
      ...
      basicDataRule: {
        ...
        ticketNum: [
          { required: true, message: "影票数量不能为空", trigger: "blur" }
        ]
      },
