...
<div class="mod-user">
    ...
    <!-- 打开新建、编辑页 -->
    <add-gift-points v-if="pageShow=='addAct'" ref="addOrUpdate" @refreshDataList="search"></add-gift-points>

</div>
</template>

<script>
import AddGiftPoints from './add-or-update';
    ...
    methods: {
        ...
        setParam() {
            ...
            let pageData = {
                ...
                ruleTemplateId: this.searchParam.ruleTemplateId ? this.searchParam.ruleTemplateId : '23,24,25,26',
