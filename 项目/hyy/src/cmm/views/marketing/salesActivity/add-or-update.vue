...
2.推荐执行策略：在交易时系统匹配并提示操作人员选择执行的策略；在自助体系（网站、手机APP及自助购票机等）的交易过程中，系统只匹配自动执行策略。例：“会员半价”，这种活动在系统识别会员时打折，建议设置自动执行策略；“刷招行信用卡25元购票”，对于这种活动必须由柜台操作员判断顾客是否持有相应的信用卡支付，确认后需手工点选实现打折，建议设置为推荐执行策略；当同一个优先级存在多个匹配的活动时，系统提示操作员手工选择执行。">
                ...
                <el-form-item label="交易渠道:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item class="margin-left-5" v-if="basicDataForm.tradingChannel!=''" prop="tradingChannelState">
                            <el-select :disabled="disabled" v-model="basicDataForm.tradingChannelState" multiple collapse-tags @change="handleChangeSelect" :title="basicDataForm.tradingChannelStateName.join(',')" clearable>
            ...
            <el-collapse-item title="设置活动条件" name="2">
                <el-form-item label="交易商户:" prop="tradingMerchant">
                    <el-row class="flex-base">
                        ...
                        <el-form-item class="margin-left-5" prop="tradingMerchantInput">
                            ...
                            <el-button type="primary" style="margin-left:10px;" @click="cinemaClick('movieTicketDialog')" plain :disabled="disabled">选择</el-button>
                        </el-form-item>
                    </el-row>
                </el-form-item>
                <el-form-item label="消费者身份:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item class="margin-left-5" v-if="basicDataForm.consumerIdentity=='AppointMember'" prop="consumerIdentityInput">
                            ...
                            <el-button type="primary" v-if="basicDataForm.consumerIdentity=='AppointMember'" style="margin-left:10px;" @click="membershipLevelClick('movieTicketConsumerIdentityDialog')" plain :disabled="disabled">选择</el-button>
                        </el-form-item>
                    </el-row>
                </el-form-item>
                <el-form-item label="商品名称:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item class="margin-left-5" v-if="basicDataForm.tradeName!=''" prop="tradeNameInput">
                            ...
                            <el-button type="primary" v-if="basicDataForm.tradeName!=''" style="margin-left:10px;" @click="selectGoodsClick('selectedGoods',basicDataForm.tradeNameInput)" plain :disabled="disabled">选择</el-button>
                        </el-form-item>
                    </el-row>
                </el-form-item>
                ...
                <el-form-item label="支付方式:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item v-if="basicDataForm.payType!=''" class="margin-left-5" prop="payTypeInput">
            ...
            <el-collapse-item title="设置优惠方案" name="3">
                <el-form-item label="商品:" prop="goodsInput">
                    ...
                    <el-button type="primary" style="margin-left:10px;" @click="selectGoodsClick('salesSelectedGoods')" plain :disabled="disabled">选择</el-button>
                </el-form-item>
                <!-- 打折 -->
                ...
                <el-form-item label="调价商品数量:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item v-if="basicDataForm.roundingNum!=2" class="margin-bottom-0-important">
                            <el-row class="flex-base">
            ...
            <el-collapse-item title="设置活动预算" name="4">
                ...
                <el-form-item label="活动总预算周期限制:">
                    <el-row class="flex-base">
                        ...
                        <el-form-item v-if="basicDataForm.activityBudgetCycle == 'appointTimeRange'" prop="activityBudgetCycleDate" class="margin-left-5 margin-top-5">
