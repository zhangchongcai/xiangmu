  ...
  <div class="movie-plan_default">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item
          class="primary"
        >{{isEdit=="update" ? '修改' : (isEdit=="detail" ? '查看' : (isEdit=="copy" ? '复制' : '新建'))}}卖品活动</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
当同一个优先级存在多个匹配的活动时，系统提示操作员手工选择执行。"
        ...
        <el-collapse-item title="设置优惠方案" name="3">
          ...
          <el-form-item label="优惠设置" v-if="basicDataForm.activityType==18">
            <div v-for="(item,index) in basicDataForm.discountSetting" :key="index">
              <span>满¥</span>
              <el-input
                style="width:20%; margin-right:6px;"
          ...
          <el-form-item label="调价商品数量">
            ...
            <span v-if="basicDataForm.roundingNum!=2">
              <span>数量</span>
              <el-input
                style="width:20%;"
        ...
        <el-collapse-item title="设置活动预算" name="4">
          <el-form-item label="预算金额计算" prop="activityBudgetAmount">
            ...
            <div v-if="basicDataForm.activityBudgetAmount==1">
              ...
              <el-input
                style="width:20%;"
                v-model="basicDataForm.totalOrdersAmount"
                :disabled="disabled"
                placeholder="请输入"
              ></el-input>
              <span>单</span>
   ...
   /*时段范围- 全选工作日 */
    ...
    buildBizPropertyMap() {
      ...
      this.bizPropertyMap = {
        ...
        totalDiscountAmount:
          this.basicDataForm.activityBudgetAmount != "" &&
          this.basicDataForm.totalDiscountAmount
            ? this.basicDataForm.totalDiscountAmount
            : "", //总优惠金额限制
        totalOrdersAmount:
