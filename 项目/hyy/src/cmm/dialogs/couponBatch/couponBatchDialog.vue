      ...
      <el-form label-width="" :inline="true">
        <div style="position:relative">
          ...
          <!-- <el-form-item label="影院编码" class="two_search">
            <el-input v-model="couponType" style="width:152px"></el-input>
          </el-form-item>
          <el-form-item label="影院名称">
            <el-input v-model="salesMode" style="width:184px"></el-input>
          </el-form-item> -->
      ...
      <div class="choose_table">
        <div>
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0}
            ...
            <el-table-column property="applyCode" label="票券销售单号" width="200"></el-table-column>
            <el-table-column property="couponName" label="票券名称" width="150"></el-table-column>
            <el-table-column property="couponTypeRight.couponType" label="票券类型" width="100" :formatter="couponTypeFormatter">
