    ...
    <el-dialog :title="title" :visible.sync="mydialogTableVisible">
      <el-form label-width="" :inline="true">
        <div style="position:relative">
          ...
          <el-form-item label="影片编码" class="two_search">
            <el-input v-model="filmCode" style="width:152px"></el-input>
          </el-form-item>
      ...
      <div class="choose_table">
        <div>
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0}
            ...
            <el-table-column property="code" label="影片编码" width="294"></el-table-column>
            <el-table-column property="filmName" label="影片名称" width="294"></el-table-column>
          </el-table>
          <!-- 分页 -->
          <div class="block">
...
<script>
import {getFilmData} from "rpt/http/interface.js"
  export default {
    props: {
      dialogTableVisible: {
        type: Boolean,
