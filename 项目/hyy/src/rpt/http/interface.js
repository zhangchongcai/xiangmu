...
//支付方式
export const getPayTypeData = (cinemaUids, payTypeName, currentPage, pageSize) => {
  let url;
  switch (document.domain) {
    case '127.0.0.1':
      // url = 'http://apidevpos.oristarcloud.com/faPayTypeCinema/findPayTypeCinema'
      url = 'http://apitestpos.oristarcloud.com/faPayTypeCinema/findPayTypeCinema'
      break;
...
//票类
export const gitTicketData = (currentPage, pageSize, cinemaUid, ticketTypeName) => {
  return axios({
