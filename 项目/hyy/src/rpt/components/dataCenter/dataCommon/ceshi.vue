<template>
  <div>
    ...
    <!-- 弹窗 -->
    <getAgency :title="title" :dialogTableVisible.sync="dialogTableVisible" :gridData="gridData" :pageData="pageData"
  ...
  export default {
    ...
    methods: {
      ...
      getData(page, type, name) {
        ...
        // console.log(this.$csmList.getDitch())
