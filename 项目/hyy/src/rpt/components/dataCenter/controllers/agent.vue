<template>
  <div class="query-dialog-wrapper">
    ...
    <div class="my_dialog">
      <el-dialog title="代理商" :visible.sync="dialigVisible" @close="closeDialog">
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <!-- <el-table-column property="type" label="代理商类型" width="294"></el-table-column> -->
              <el-table-column property="agent" label="代理商名称"></el-table-column>
            </el-table>
            <!-- 分页 -->
            <div class="block">
              <el-pagination
...
export default {
  ...
  methods: {
    handleIconClick() {
      ...
      this.selectedData = [];
      this.selectObj = {};
      this.$emit("selectTransactionChannelData", this.transactionChannelValue);
    },
    showIcon() {
    ...
    comfirmClick() {
      ...
      if (this.selectedData.length !== 0) {
        this.selectedData.forEach(element => {
          ...
          agentUid += `${element.uid},`;
        });
      } else {
        this.transactionChannelValue = "";
      }

      this.$emit("selectAgentData", agentUid);
