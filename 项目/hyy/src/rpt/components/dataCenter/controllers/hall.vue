  ...
  <div class="query-dialog-wrapper">
    <div class="input-button">
      <div @mouseenter="showIcon" @mouseleave="hideIcon">
        <el-input v-model="hallValue" :disabled="true">
          <i
            v-if="isShowIcon"
    ...
    <!-- <el-input v-model="hallValue" v-on:click.native="openDialog"></el-input> -->
    <div class="my_dialog">
      <el-dialog title="影厅" :visible.sync="dialigVisible" @close="closeDialog">
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <el-table-column prop="name" label="影厅名称" show-overflow-tooltip></el-table-column>
              <el-table-column prop="code" label="影厅编码" show-overflow-tooltip></el-table-column>
              <el-table-column prop="type" label="影厅类型" show-overflow-tooltip></el-table-column>
            </el-table>
            <!-- 分页 -->
            <div class="block">
              <el-pagination
...
export default {
  ...
  methods: {
    handleIconClick() {
      ...
      this.selectedData = [];
      this.selectObj = {};
      this.$emit("selectHallData", this.hallValue);
    },
    showIcon() {
      if (this.hallValue) this.isShowIcon = true;
    },
    hideIcon() {
    ...
    openDialog() {
      if (this.cinemaUid !== "") {
        ...
        // this.getData(1, 10, "745498", this.name);
      } else {
        this.$message({
          message: "请先选择影院",
    ...
    //切换分页请求数据
    currentChange(val) {
      this.getData(val, 10, this.cinemaUid, this.name);
      // this.getData(val, 10, '745498', this.name);
    },
    //清空所选数据
    clearClick() {
    ...
    //发请求获取数据的方法
    getData(page, pageSize, cinemaUid, name) {
      this.$rptList
        .gitHallData(page, pageSize, cinemaUid, name)
        .then(res => {
          if (res.code === 200) {
