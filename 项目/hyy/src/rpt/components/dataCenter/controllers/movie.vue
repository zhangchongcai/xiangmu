  ...
  <div class="query-dialog-wrapper">
    <div class="input-button">
      <div @mouseenter="showIcon" @mouseleave="hideIcon">
        <el-input v-model="filmValue" :disabled="true">
          <i
            v-if="isShowIcon"
    ...
    <!-- <el-input v-model="filmValue" v-on:click.native="openDialog"></el-input> -->
    <div class="my_dialog">
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <el-table-column prop="filmName" label="影片全称" show-overflow-tooltip></el-table-column>
            </el-table>
            <!-- 分页 -->
            <div class="block">
              <el-pagination
          ...
          <div class="choose_ul">
            ...
            <ul class="ul_body">
              <li v-for="(item,index) in selectedData" :key="index">
                <div class="choose_name">{{item.filmName}}</div>
...
export default {
  ...
  methods: {
    ...
    //切换分页请求数据
    currentChange(val) {
      this.getData(val, "10", this.filmName, this.filmCode);
    },
    //清空所选数据
    clearClick() {
    ...
    comfirmClick() {
      ...
      if (this.selectedData.length !== 0) {
        this.selectedData.forEach(element => {
          this.filmValue += `${element.filmName},`;
        });
      } else {
        this.filmValue = "";
      }
