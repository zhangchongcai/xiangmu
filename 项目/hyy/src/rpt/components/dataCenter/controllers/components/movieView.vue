      ...
      <el-form label-width :inline="true">
        <div style="position:relative">
          <el-form-item label="影片ID：">
            <el-input v-model="filmId" style="width:184px"></el-input>
          </el-form-item>
      ...
      <div class="choose_table">
        <div>
          ...
          >
            ...
            <!-- <el-table-column prop="cityName" label="城市地区" show-overflow-tooltip></el-table-column> -->
          </el-table>
          <!-- 分页 -->
          <div class="block">
            <el-pagination
...
export default {
  ...
  methods: {
    ...
    searchUser() {
      ...
      this.$emit("searchUser", searchFilmData);
    },
    // 删除
    delateSpan(item) {
      console.log(item);
