  ...
  <div class="query-dialog-wrapper">
    <div class="input-button">
      <div @mouseenter="showIcon" @mouseleave="hideIcon">
        <el-input v-model="transactionChannelValue" :disabled="true">
          <i
            v-if="isShowIcon"
    ...
    <div class="my_dialog">
      <el-dialog :title="queryName" :visible.sync="dialigVisible" @close="closeDialog">
        <el-form label-width :inline="true">
          <div style="position:relative">
            <el-form-item label="渠道类型:">
              <el-select popper-class="rpt-select" v-model="dealType" style="width:184px">
                <el-option label="线下渠道" value="0">线下渠道</el-option>
                <el-option label="直营线上" value="1">直营线上</el-option>
                <el-option label="网络代售渠道" value="2">网络代售渠道</el-option>
              </el-select>
            </el-form-item>
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <el-table-column property="type" label="渠道类型" width="294"></el-table-column>
...
export default {
  ...
  methods: {
    handleIconClick() {
      this.transactionChannelValue = "";
      this.selectedData = [];
      this.selectObj = {};
      this.$emit(
        "selectTransactionChannelData",
        this.transactionChannelValue,
        this.queryName
      );
    },
    showIcon() {
      if (this.transactionChannelValue !== "") this.isShowIcon = true;
    },
    hideIcon() {
    ...
    comfirmClick() {
      ...
      if (this.selectedData.length !== 0) {
        this.selectedData.forEach(element => {
          this.transactionChannelValue += `${element.name},`;
        });
      } else {
        this.transactionChannelValue = "";
      }
      ...
      this.$rptList.getDitch(Object.assign({}, limit)).then(data => {
        if (data && data.code === 200) {
          ...
          ret.list.forEach(element => {
            element.nature === 0 ? (element.type = "线下渠道") : null;
            element.nature === 1 ? (element.type = "直营线上") : null;
            element.nature === 2 ? (element.type = "网络代售渠道") : null;
          });
          this.tableData = ret.list;
          this.pageNationData = ret;
