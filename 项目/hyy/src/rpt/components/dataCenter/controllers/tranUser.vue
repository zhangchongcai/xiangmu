  ...
  <div class="query-dialog-wrapper">
    <div class="input-button">
      <div @mouseenter="showIcon" @mouseleave="hideIcon">
        <el-input v-model="userNameValue" :disabled="true">
          <i
            v-if="isShowIcon"
    ...
    <!-- <el-input v-model="userNameValue" v-on:click.native="openDialog"></el-input> -->
    <div class="my_dialog">
      <el-dialog title="收银员/授权人" :visible.sync="dialigVisible" @close="closeDialog">
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <el-table-column property="loginName" label="账号" width="294"></el-table-column>
              <el-table-column property="fullName" label="收银员/授权人" width="294"></el-table-column>
            </el-table>
            <!-- 分页 -->
            <div class="block">
              <el-pagination
          ...
          <div class="choose_ul">
            ...
            <ul class="ul_body">
              <li v-for="(item,index) in selectedData" :key="index">
                <div class="choose_name">{{item.fullName}}</div>
...
export default {
  ...
  methods: {
    handleIconClick() {
      ...
      this.selectedData = [];
      this.selectObj = {};
      this.$emit("selectUserData", "");
    },
    showIcon() {
      if (this.userNameValue !== "") this.isShowIcon = true;
    },
    hideIcon() {
    ...
    comfirmClick() {
      ...
      if (this.selectedData.length !== 0) {
        this.selectedData.forEach(element => {
          this.userNameValue += `${element.fullName},`;
          tranUserUidArr += `${element.uid},`;
        });
      } else {
        this.userNameValue = "";
      }

      this.$emit("selectUserData", tranUserUidArr);
