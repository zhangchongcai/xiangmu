  ...
  <div class="query-dialog-wrapper">
    <div class="input-button">
      <div @mouseenter="showIcon" @mouseleave="hideIcon">
        <el-input v-model="comboGoodsName" :disabled="true">
          <i
            v-if="isShowIcon"
    ...
    <div class="my_dialog">
      <el-dialog title="套餐商品" :visible.sync="dialigVisible" @close="closeDialog">
        ...
        <div class="choose_table">
          <div>
            ...
            >
              ...
              <el-table-column property="merName" label="套餐商品名称"></el-table-column>
              <el-table-column property="merCode" label="套餐商品编码"></el-table-column>
            </el-table>
            <!-- 分页 -->
            <div class="block">
              <el-pagination
...
export default {
  ...
  methods: {
    handleIconClick() {
      ...
      this.selectedData = [];
      this.selectObj = {};
      this.$emit("selectComboGoodsData", this.comboGoodsName);
    },
    showIcon() {
      if (this.comboGoodsName !== "") this.isShowIcon = true;
    },
    hideIcon() {
    ...
    selectAll(selection) {
      ...
      this.selectedData = this.selectedData.reduce((item, next) => {
        hash[next.merCode]
          ? ""
          : (hash[next.merCode] = true && item.push(next));
        return item;
      }, []);
    },
    //点击表格某一行
    ...
    comfirmClick() {
      ...
      this.dialigVisible = false;
      this.comboGoodsName = "";
      let comboGoodsNameCode = "";
      if (this.usefulData.length !== 0) {
        this.usefulData.forEach(element => {
          this.comboGoodsName += `${element.merName},`;
          comboGoodsNameCode += `${element.merCode},`;
        });
      } else {
        this.comboGoodsName = "";
      }
      this.$emit("selectComboGoodsData", comboGoodsNameCode);
