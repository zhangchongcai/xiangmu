<template>
  <el-container>
    <el-aside :width="this.isCollapse ? '60px' : '136px'">
      ...
      <el-menu @select="handleSelect" background-color="#21376B" text-color="#fff" active-text-color="#fff" :defaultOpeneds="defaultOpenedsArr">
        ...
        <div class="second">
          <el-submenu index="2">
            ...
            <el-menu :collapse="true" style="width:100%;background-color:#21376b">
              <el-submenu :index="'2-'+i" v-for="(item, i) in list" :key="i">
                <template slot="title">
                  <i class="el-icon-setting" style="color:#fff;font-size: 14px">
                    {{item.menuName}}
                  </i>
                </template>
                <div style="max-height:500px;overflow-y:scroll;">
                  <el-menu-item-group :index="'2-'+i+'-'+s" v-if="item.submenu.length>0" v-for="(sub, s) in item.submenu">
    ...
    <el-container>
      ...
      <el-main>
        <el-breadcrumb separator-class="el-icon-arrow-right" v-if="Boolean(level.level3)">
...
import { modifyUserPassword, menuList, getUrl } from 'frame_cpm/http/interface.js'
export default {
  data () {
    return {
      // defaultActive: "",
