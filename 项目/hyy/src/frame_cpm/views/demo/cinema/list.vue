    ...
    <div class="page-wrapper">
        ...
        <div class="list-wrapper detail">
            <div>
                ...
                <div></div> -->
                 <span class="table-btn-mini" @click="chooseCinema(1)">编辑影院多选1</span>
                 <div> <el-tag
                        size="small"
                        v-for="tag in selectedCinemas.editData"
                        :key="tag.id"
                        closable
                        :type="tag.type">
                        {{tag.name}}
                      </el-tag></div>
                <span class="table-btn-mini" @click="chooseCinema(2)">编辑影院多选2</span>
                 <div> <el-tag
                        size="small"
                        v-for="tag in selectedCinemas2.editData"
                        :key="tag.id"
                        closable
                        :type="tag.type">
                        {{tag.name}}
        ...
        <frame-multicinema :dialogVisible="multiCinemaVisible" :whereUse="whereUse" :innerData="innerData" :isListprop="true" @callBack="handleCallBack" ref='frameMultiCinema'>
            <div slot="footerId">
        ...
        <frame-singlecinema :dialogVisible="singleCinemaVisible" :innerData="innerDataSingle" :isListprop="true" @callBackSingle="handleSingleCallBack" ref='frameSingleCinema'>
            <div slot="footerId">
                <el-button @click="closeDialogCinemaDialog(false)">取 消</el-button>
  ...
  export default {
    ...
    methods: {
        ...
        handleCallBack (opt) {
            ...
            console.log(this.selectedCinemas)
            debugger
        },
        handleSingleCallBack(opt) {
            debugger
            this.selectedCinemaSingle = opt.data
            this.singleCinemaVisible = opt.dialogVisible;
        },
        to() {
