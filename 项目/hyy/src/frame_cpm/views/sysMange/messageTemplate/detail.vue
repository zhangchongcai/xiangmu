...
<div class="page-wrapper page-justsee-message-channel page-justsee-basecenema-edit">
    <!-- <div class="breadcrumb">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>查看短信模板</el-breadcrumb-item>
        </el-breadcrumb>
    </div> -->
    <div class="clearboth" style="margin-top:30px;"></div>
             <!--基本信息-->
             <section class="film-base-page">
                 <el-form ref="messageTemplate" :model="messageTemplate" label-width="110px" label-position="right" label-height='60px'>
                   <el-row :gutter="20">
                    <el-col :span="8">
                ...
                <el-row :gutter="20">
                    <el-col :span="12" class="temp-content">
                        ...
                        <el-input type="textarea" v-model="messageTemplate.content" resize="none" :disabled="isJustSee" placeholder="请选择短信场景" @change="templateTextareaFunc" @blur="templateTextareaFunc"></el-input>
...
<script>
import { createSmsChannel, querySmsTemplate, updateSmsTemplate, querySmsScene,sendSingleMsg, createSmsTemplate} from 'src/frame_cpm/http/interface'
    ...
    export default {
            ...
            return{
               ...
               rules:{
                   ...
                   content:[
                    ...
                    //        if(value.length>67){
                    //             return callback(new Error('模板字符数最多67个'));
                    //        }else{
                    //             callback();
                    //        }
                    //    }, trigger: 'blur'}
        ...
        methods:{
            ...
            querySmsScene() {
                ...
                querySmsTemplate({postObj})
              .then(returnData => {
                if(returnData&&returnData.code==200){
                  // _this.pageNum = ret.data.pageNum
                  // _this.pageSize = ret.data.pageSize
                  // _this.total = ret.data.total
                  let wholeTmpList = returnData.data
                  let pageId = this.$route.query.id
                  let currentPageObjArr =  wholeTmpList.filter(item=>item.id == pageId)
                  let currentPageObj = currentPageObjArr && currentPageObjArr[0]
                  ...
                  querySmsScene(postObj).then(ret => {
                        ...
                        if(this.$route.query.isModify){
                            ...
                            // currentPageobj = currentPageObjArr && currentPageObjArr[0]
