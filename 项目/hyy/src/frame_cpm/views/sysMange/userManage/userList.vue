                ...
                <el-table
                    ...
                    <el-table-column label="操作" width="250" fixed="right">
                        <template slot-scope="scope">
                            ...
                            >查看</el-button>
                            <el-button
                                    v-auth="'system_userManage_update'"
                                    class="table-btn-mini"
                                    @click="editUser(scope.row)"
                                    type="text"
                            >编辑</el-button>
                            <el-button
                                    v-auth="'system_userManage_reSetPs'"
                                    class="table-btn-mini"
                                    @click="diaPwd(scope.row)"
                                    type="text"
                            >重置密码</el-button>
                        </template>
                    </el-table-column>
...
<script>
    import {userList,resetPassword,orgList,attributeType} from 'frame_cpm/http/interface.js'
