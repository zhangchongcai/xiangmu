    ...
    >
      ...
      <div class="box">
        <div class="box-left">
          <el-table
            :data="filmList"
            @selection-change="changePageCoreRecordData"
            height="308px"
            ref="filmListRef"
            class="diy-header"
            stripe
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="framedialogVisible = !framedialogVisible,confirmData()">取 消</el-button>
        <el-button type="primary" @click="framedialogVisible = !framedialogVisible,confirmData()">确 定</el-button>
...
import { authQueryUserCinemas, cpmFilmList,cpmFilmCodeList } from "frame_cpm/http/interface.js";
export default {
  props: {
    // framedialogVisible: {
    //   type: Boolean,
  ...
  methods: {
    ...
    confirmData() {
      ...
      _this.$emit("frameFilmBaseMultiCallBack", {
        data: this.multipleSelectionAll,
    ...
    listAuthCommCinemas() {
      ...
      if(this.$attrs.type == 1 || this.$attrs.type == undefined || this.$attrs.type == null || this.$attrs.type == '' ){
          ...
          if (ret && ret.code === 200) {
            ...
            let disabledObj = this.innerData.disabledData;
    ...
    setSelectRow() {
      debugger
      if (!this.multipleSelection && this.multipleSelection.length && !this.multipleSelectionAll || this.multipleSelectionAll.length <= 0) {
        return;
      }
      debugger
      // 标识当前行的唯一键的名称
