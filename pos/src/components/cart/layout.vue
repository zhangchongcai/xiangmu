    ...
    <div class="cart" >
        ...
        <footer class="footer">
            ...
            <ul class="pay-ment">
                ...
                <li>
                    <span>未付：</span>    
                    <span class="not-pay">{{cartData.notPayAmount?cartData.notPayAmount:0}}.</span>
                    <span>{{decimal}}元</span>
                </li>                    
            </ul>
            <div class="button-warp">
                <el-button plain @click="empty">清空</el-button>
                <el-button plain @click="preparemeals">备餐</el-button>
                <el-button plain>挂单</el-button>
                <el-button plain @click="detail">详情</el-button>
            </div>
        </footer>
    </div>
</template>
...
import { findCart , clearAllTicket , releaseSeat } from 'src/http/apis.js'
import {mapMutations,mapGetters} from 'vuex'
import {GET_CART_GOODSLIST,GET_CART_DATA,GET_CART_BILLCODE , RENDER_SELECTION_AFTER_RELEASE ,CLEAR_SELECTION} from 'types'
export default {
