...
<section class="planWindow">
    <div class="window_2">
        ...
        <div class="window_3">
            ...
            <filmScale
                    ...
                    :width="windowWidth ? windowWidth - filmScale_deleteWidth : normalWidth - filmScale_deleteWidth"
            ></filmScale>
            <!-- 放映计划 -->
            <filmPlan
                    ref="filmPlan"
                    ...
                    :width="windowWidth ? windowWidth - filmPlan_deleteWidth: normalWidth - filmPlan_deleteWidth"
                    :rooms="rooms"
                    :contentSize="contentSize"
    ...
    <filmTips
            ref="filmTips"
            :width="windowWidth ? windowWidth - filmTips_deleteWidth: normalWidth - filmTips_deleteWidth"
            :filmTips="filmTips"
    ></filmTips>
</section>
</template>
