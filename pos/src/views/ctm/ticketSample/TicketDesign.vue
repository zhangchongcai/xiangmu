                    ...
                    <div class="edi_ele">
                        ...
                        <div class="curren_eleSel">
                            <div class="option-warp">
                                ...
                                <div class="content">{{current_element.text}}</div>
                            </div>
                            <div class="option-warp">
...
export default {
    data() {
      return {
            ...
            defualt_background:require('../../../assets/images/ticketSample/ticket.jpg'),
            qrcode:require('../../../assets/images/ticketSample/qrcode.jpg'),
            barcode:require('../../../assets/images/ticketSample/barcode.jpg'),
    ...
    methods: {
        ...
        changePrintTitle(val) {
            if(val==2) {
                console.log(val)
                this.current_element.isPrintTitle = 0
        ...
        elementCurrentValChange(item) {
            // this.model =item.code=="k014"? true : false //如果是电影票信息码则只能是二维码
        ...
        getElemendetil(uid) {
            ...
            this.$api.ticketsampleQuery(uid) .then(res => {
                if(res && res.code==200){
                    let data = res.data;
                    console.log(data)
        ...
        getChannelList() {
            this.$api.getUserInfo().then(res => {
                ...
                this.$api.ticketGetChannelList({"cinemaUid":cinemaUid,"type":2}) .then( data => {
                    if(data && data.code ===200) {
                        console.log(data)
        ...
        newBuild() {
            let flag = this.judge();
            let data = Object.assign(this.edi_ele)
            ...
            if(flag){
                ...
                this.$api.ticketelementAdd(data).then( data => {
                    if(data && data.code ===200 ){
                        this.$message({
                            message:'新建成功！',
                            type: 'success',
        ...
        ticketSampleupdata(){
            ...
            if(flag){
                data.width = this.edi_ele.width*this.mmToPixel
                data.height = this.edi_ele.height*this.mmToPixel
                this.$api.ticketSampleUpdata(data).then( data => {
                    if(data && data.code == 200){
                        this.$message({
                            message:"修改成功！",
                            type:"success",
