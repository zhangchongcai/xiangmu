  ...
  <div>
    ...
    <div class="cinema-stock-table">
      ...
      >
        ...
        >
         <template slot-scope="scope">
           {{scope.row.datePublicShow?scope.row.datePublicShow.substr(0,10):''}}
          </template>
        ...
        >
         <template slot-scope="scope">
           {{scope.row.dateShowFirst?scope.row.datePublicShow.substr(0,10):''}}
          </template>
        </el-table-column>
        <el-table-column
          prop="dateShowOff"
        ...
        >
        <template slot-scope="scope">
           {{scope.row.dateShowOff?scope.row.datePublicShow.substr(0,10):''}}
          </template>
        </el-table-column>
        <el-table-column
          label="影片状态"
