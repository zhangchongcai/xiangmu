    ...
    methods: {
        ...
        setParam(param) {
            ...
            let _param = {
                ...
                startId: exitsParam ? param.startId.value : exitsSearhParam ? pointer.searchParam.startId.value : '',
                endId: exitsParam ? param.endId.value : exitsSearhParam ? pointer.searchParam.endId.value : '',
                ...
                createUserName: exitsParam ? param.createUserName : exitsSearhParam ? pointer.searchParam.createUserName : '',
