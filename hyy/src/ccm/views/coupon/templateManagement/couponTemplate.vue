        ...
        <el-collapse v-model="activeNames">
            <el-collapse-item title="元素库" name="elementLibary">
                <div class="element-item-top" >
                    <div @mousedown="drag($event,element,ind)" 
                    v-for="(element,ind) in config.element" 
                    :key="ind" 
                    v-show="!element.isSele"
                    :class="['print-item',element.require=='1'?'star_required':'indent']"
                    >
            ...
            <div class="curren_eleSel">
                ...
                <div class="option-warp">
                    ...
                    <div class="content">
                        ...
                        <el-select v-model="selected_element.style" placeholder="请选择" @change="fontStyle_change">
                            <el-option
                            v-for="item in config.fontStyle"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value">
                            </el-option>
                ...
                <div class="option-warp" v-if="selected_element.itemCode==config.code && selected_element.itemCode">
                    ...
                    <div class="content">
                        <div class="inputFrame nowrap">
                            <el-input type="input" 
                            v-model="selected_element.description"
                            clearable
...
export default {
    ...
    mounted() {
        ...
        // let warp = document.querySelector('.content-wrapper')
        // warp.style.overflowY='hidden'
...
.coupon-template {
        ...
        .design_box {
            ...
            .scale_X{
                ...
                ul{
                    margin-left: 40px;
                    li{
                        float: left;margin-left: 10px;width: 1px;height: 10px;background: #999;
                    }
            ...
            .scale_Y{
                ...
                ul{
                    margin-top: 40px;
                    li{
                        margin-top: 10px;width: 10px;height: 1px;background: #999;
                    }
                    li:nth-child(1){margin: 0px;}
                }
            }
    ...
    .aside-right {
        ...
        .option-warp{
            ...
            .name{margin-right: 8px;color: #666;font-size: 12px;}
        ...
        .attribute{
            ...
            .ticketSize{
                ...
                .el-input__inner{width: 62px;font-size: 12px!important;padding: 0 10px!important;text-align: center}
            }
            .qudao{
                white-space: nowrap;
