    ...
    :visible.sync="Visible">
        <el-collapse v-model="activeNames">
            <el-collapse-item title="销售申请单信息" name="baseInfo">
                ...
                <!-- 分页 -->
                <section class="pagination-section flex-base flex-center pageStyle" v-if="tableData.length>10">
                    <el-pagination 
...
export default {
    ...
    methods: {
        search(id) {
            ...
            let params = {
                id:id?id:this.formData.receivableId?this.formData.receivableId:'',
