  ...
  <div class="commodityListReportDetail">
    ...
    <div class="member-list-table _m-member-table-custom">
      <el-table :data="tableData" stripe style="width: 100%" :empty-text="tipMessage">
        ...
        <el-table-column prop="memberLevelName" :formatter="emptyShow" label="会员等级" min-width="120"
          show-overflow-tooltip></el-table-column>
        <el-table-column prop="receiveTime" :formatter="emptyShow" label="获取时间" min-width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="offsetTime" :formatter="emptyShow" label="核销时间" min-width="120" show-overflow-tooltip></el-table-column>=
