  ...
  <div class="_different-industry-goods-list">
    <el-form :inline="true" :model="formData" ref="formData" class="form-data-wrap">
      ...
      <el-form-item class="btn-wrap">
        ...
        <el-button type="primary" @click="handleAddGoods" class="el-btn-custom">新建</el-button>
      </el-form-item>
    </el-form>
    <div class="member-level-title">
      <div class="add-btn" @click="handleGoodsType">商品类型管理</div>
    </div>
      ...
      <el-table :data="tableData" stripe style="width: 100%" :empty-text="tipMessage">
        ...
        <el-table-column fixed="right" label="操作" min-width="200">
          <template slot-scope="scope">
            ...
            <el-button @click="handleEditGoods(scope.row)" type="text" size="small" class="operation-button" v-if="scope.row.status=='not_on'?true:false">修改</el-button>
            <el-button @click="handleStartUse(scope.row)" type="text" size="small" class="operation-button" v-if="scope.row.status=='not_on'?true:false">上架</el-button>
            <el-button @click="handleStopUse(scope.row)" type="text" size="small" class="operation-button" v-if="scope.row.status=='has_been_on'?true:false">下架</el-button>
...
export default {
  ...
  methods: {
    ...
    handleStartUse(scope) {
      let _this = this;
      _this
        .$confirm(`确定要上架 ${scope.goodsName} 吗？`, "提示", {
    ...
    handleStopUse(scope) {
      ...
      let _this = this;
      _this
        .$confirm(`确定要下架 ${scope.goodsName} 吗？`, "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        })
