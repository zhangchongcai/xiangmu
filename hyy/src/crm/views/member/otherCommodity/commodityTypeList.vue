  ...
  <div class="commodityList">
    ...
    <div class="member-list-table _m-member-table-custom">
      <el-table :data="tableData" stripe style="width: 100%" :empty-text="tipMessage">
        ...
        <el-table-column prop="createTime" :formatter="emptyShow" label="创建时间" min-width="120" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" min-width="200">
          <template slot-scope="scope">
            ...
            <el-button @click="handleMemberEdit(scope.row)" type="text" size="small" class="operation-button">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
