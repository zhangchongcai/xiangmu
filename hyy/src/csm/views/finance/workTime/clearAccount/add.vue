<template>
  <div class="cinemaList">
    ...
    <div class="searchAdition">
      <el-form :inline="true" class="demo-form-inline search-form" size="small" label-width="100px">
        ...
        <el-form-item label="票纸编号:">
          <el-col :span="11">
            <el-input v-model="tpCodeStart" placeholder="票纸编号"></el-input>
          </el-col>
          <el-col class="line" :span="2" style="text-align:center">-</el-col>
          <el-col :span="11">
            <el-input v-model="tpCodeEnd" placeholder="票纸编号"></el-input>
          </el-col>
        </el-form-item>
      </el-form>
    </div>
    ...
    <!-- 弹窗 -->
    <myDialog :title="title" :dialogTableVisible.sync="dialogTableVisible" :isVip="isVip" :isOther="isOther"
      :isTwo="isTwo" :gridData="gridData"  :pageData="pageData" @chooseuUserName='chooseuUserName'
    ...
    methods: {
      ...
      getWorker(current) {
        ...
        this.$csmList.getCashier(Object.assign({}, limit))
          .then(data => {
            if (data && data.code === 200) {
              this.workerGridData = data.data.records;
              this.gridData = this.workerGridData;
              this.workerPageData = data.data;
            }
          })
      },
      // 上班登记  
      ...
      openworkerName(index) {
        ...
        this.isOther = false;
        this.gridData = this.workerGridData;
        this.pageData = this.workerPageData
      },
      // 会员卡领用记录
      openVipDialog(index) {
        this.index = index;
