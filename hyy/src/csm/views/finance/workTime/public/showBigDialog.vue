  ...
  <div class="my_dialog">
    <el-dialog :title="title" :visible.sync="mydialogTableVisible">
      <el-form :inline="true">
        ...
        <div v-if="parentDialog =='isboxOffice'">
          ...
          <el-form-item label="影票编号：">
            <el-input v-model="search.movieCode" style="width:184px;"></el-input>
          </el-form-item>
      ...
      <el-table :data="gridData" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0}
        ...
        <el-table-column property="cinemaTicketCode" label="影票编号" width="96" show-overflow-tooltip></el-table-column>
        <el-table-column property="moiveName" label="影片" width="96" show-overflow-tooltip></el-table-column>
        <el-table-column property="filmTime" label="放映场次" width="96" show-overflow-tooltip></el-table-column>
        <el-table-column property="position" label="座位编号" width="96" show-overflow-tooltip></el-table-column>
      ...
      <!-- 分页 -->
      <div class="block" v-if="parentDialog=='isDetail' || parentDialog=='isboxOffice'">
