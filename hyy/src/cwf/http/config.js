...
switch (domain) {
    case '127.0.0.1':
        // config.baseURL = 'http://192.168.100.24:8030';//yiyi
        // config.baseURL = 'http://192.168.100.43:8030';//亚哥
        config.baseURL = 'http://apidev.oristarcloud.com';
        // config.baseURL = 'http://rap.tech.nanhaicorp.com/mockjsdata/42';
        // config.baseURL = 'http://39.98.97.116:8083';
        // config.baseURL = 'http://192.168.100.42:8081';
        // config.baseURL = 'http://39.98.97.116:8083';
