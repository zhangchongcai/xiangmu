<template>
    ...
    <el-dialog  width="80%"  :title="contentText" :visible.sync="dialogVisible" :modal-append-to-body="false" @close="close">
            <div class="detail">
                <div class="cinema-item" v-if="treeArr.length">
                    指定商户:
                    <el-tree
                        :data="treeArr"
                        show-checkbox
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="16">
                            <div class="grid-content bg-purple-light">
                                <div>
                                    <el-select v-model="optionsValue[`${item.businessNo}`]" placeholder="请选择" >
                                        <el-option
...
        getCheckedNodes(){   
        ...
        editAllData(){
            ...
            this.defaultCheckedKeys=this.dataInfo.orginizationId.split(",")
