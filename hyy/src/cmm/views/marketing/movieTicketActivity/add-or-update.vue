        ...
        <el-form :model="basicDataForm" :rules="basicDataRule" ref="basicDataForm" label-width="150px" class="common-form">
            ...
            <el-collapse-item title="活动基础信息" name="1">
                ...
                <el-form-item label="活动名称:" prop="activityName">
                    <el-input class="input-type-217" v-model="basicDataForm.activityName" placeholder="请输入活动名称" :disabled="disabled" maxlength="15" @blur="valActivityName"></el-input>
                </el-form-item>
...
当同一个优先级存在多个匹配的活动时，系统提示操作员手工选择执行。">
                ...
                <el-form-item label="执行优先级:" size="mini" prop="priorityNum" class="priorityNum">
                    <el-radio-group v-model="basicDataForm.priority" :disabled="disabled">
                        <el-row class="flex-base">
                            ...
                            <el-input style="margin-right: 30px;" class="input-type-94" v-if="basicDataForm.priority==1" v-model="basicDataForm.priorityNum" :disabled="disabled" placeholder="数值越大优先级越高(0-99)" min="0" max="99"></el-input>
                ...
                <el-form-item label="交易渠道:">
                    ...
                    <el-select class="chooseWidth1" v-if="basicDataForm.tradingChannel!=''" :disabled="disabled" v-model="tradingChannelState" multiple collapse-tags @change="handleChangeSelect" :title="tradingChannelStateName.join(',')" clearable>
            ...
            <el-collapse-item title="设置活动条件" name="2">
                <el-form-item label="交易商户:" prop="tradingMerchant">
                    ...
                    <el-button type="primary" :disabled="disabled" style="margin-left:10px;" @click="tradingMerchantClick()" plain>选择</el-button>
                </el-form-item>
                <el-form-item label="消费者身份:">
                    ...
                    <el-button type="primary" :disabled="disabled" v-if="basicDataForm.consumerIdentity=='AppointMember'" style="margin-left:10px;" @click="consumerIdentityClick()" plain>选择</el-button>
                </el-form-item>
            ...
            <el-collapse-item title="设置活动预算" name="4">
                ...
                <el-form-item label="活动总预算周期限制:" prop="activityBudgetCycle">
                    <el-row class="flex-base">
                        ...
                        <el-form-item class="margin-left-5 margin-top-0" prop="activityBudgetCycleDate">
