                    ...
                    <el-radio-group v-model="basicDataForm.priority" style="width:70%;" :disabled="disabled">
                        <el-row class="flex-base">
                            ...
                            <el-form-item v-if="basicDataForm.priority==1" prop="priorityNum">
                                <el-input class="input-type-94" v-model="basicDataForm.priorityNum" :disabled="disabled" placeholder="数值越大优先级越高(0-99)" min="0" max="99"></el-input>
                            </el-form-item>
                ...
                <div v-if="basicDataForm.activityType==31">
                    ...
                    <el-form-item label="生日:">
                        <el-row class="flex-base">
                            ...
                            <el-form-item v-if="basicDataForm.birthday=='EqualCurrentMonthOffset'">
