...
<div class="mod-user">
    ...
    <!-- 打开新建、编辑页 -->
    <add-package-promotion v-if="pageShow=='addAct'" ref="addOrUpdate" @refreshDataList="search"></add-package-promotion>

</div>
</template>

<script>
import AddPackagePromotion from './add-or-update';
    ...
    methods: {
        ...
        setParam() {
            ...
            let pageData = {
                ...
                ruleTemplateId: this.searchParam.ruleTemplateId ? this.searchParam.ruleTemplateId : '21,22',
