...
},
{
    ...
    component:  (resolve) => require(['ctm/views/filmShow/index'], resolve),
    ...
    children: [{
      ...
      component: (resolve) => require(['ctm/views/filmShow/list.vue'], resolve),
      name: '排期展示终端管理'
    }, {
      path: 'add',
      meta: {
      ...
      component: (resolve) => require(['ctm/views/filmShow/add.vue'], resolve),
      name: '慧影云排期展示首页'
    }, {
      path: 'editor',
      meta: {
      ...
      component: (resolve) => require(['ctm/views/filmShow/editor.vue'], resolve),
      name: '排期展示模板编辑'
    },{
      path: 'login',
      meta: {
      ...
      component: (resolve) => require(['ctm/views/filmShow/login.vue'], resolve),
      name: '慧影云排期展示首页'
    },{
      path: 'swiperList',
      meta: {
      ...
      component: (resolve) => require(['ctm/views/filmShow/swiperList.vue'], resolve),
      name: '慧影云排期展示首页'
    },{
      path: 'manageList',
      meta: {
      ...
      component: (resolve) => require(['ctm/views/filmShow/manageList.vue'], resolve),
      name: '慧影云排期展示首页'
    }]
  },
]
