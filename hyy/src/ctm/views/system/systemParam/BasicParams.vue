    ...
    <div class="basic-params">
        <div class="content">
            ...
            >   
                ...
                <el-form-item label="零售终端票券交付方式：	"  style="display:inline-block" >
                    ...
                    <div v-if="data.basicParams.ticket_delivery_ctrl==1" class="ticket_deliver_mode" >
                        <el-checkbox-group v-model="data.basicParams.ticket_delivery_mode">
                            <el-checkbox label="sms" >发短信</el-checkbox>
                ...
                <el-form-item label="交易过程需打印的凭据：" class="checkGround">
                ...
                <div class="title"> 销售 </div>
                    ...
                    <div  v-for="(item,ind) in data.specialCapitalRatioList" :key="ind+100">
                        ...
                        :rules="[{ required: true, message: '专资比例不能为空',trigger: 'blur'}]"
                        >
                            ...
                            <span class="delete" @click="deleSpecialCap(ind)" v-if="data.specialCapitalRatioList>1">删除</span>
                            <span class="add" @click="addSpecialCap()"><i class="iconfont icon-neiye-tianjia-"></i>添加</span>
                        </el-form-item>
                    </div>
                    <div  v-for="(item,ind) in data.taxRateList" :key="ind" >
                        ...
                        >
                            ...
                            <span class="delete" @click="deletaxRate(ind)" v-if="data.taxRateList>1">删除</span>
                            <span class="add" @click="addtaxRate()"><i class="iconfont icon-neiye-tianjia-"></i>添加</span>
                        </el-form-item>
                    </div>
            </el-form>
        </div>
        <el-row class="footer">
            <el-button type="primary" @click="saveBasicParam">修改</el-button>
...
export default {
    ...
    methods: {
        ...
        //零售终端票券交付方式
        ticket_delivery_ctrl(val) {
            if(val){
                this.data.basicParams.ticket_delivery_mode=['sms', 'print','mcard']
            }else{
                this.data.basicParams.ticket_delivery_mode= 'mcard'
            }
        },
        //初始化查询
        initData() {
...
<style lang="scss">
    .basic-params{
        ...
        .el-input--small{width: 70px}
        .el-input--suffix{width: 150px;display: inline-block;}
        .suffix{
        ...
        .content{
            height: 600px;
            overflow: auto;
            .delete,.add{cursor: pointer;}
        }
        .checkGround .el-checkbox-group{
            width: 600px;
            .el-checkbox{width:150px}
        }
        .ticket_deliver_mode{
