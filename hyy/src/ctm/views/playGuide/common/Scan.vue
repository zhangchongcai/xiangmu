    ...
    <div class="form-wrapper">
      ...
      >
        ...
        >
          ...
          <el-col :span="4">
            <el-button
              ...
              @click.prevent="showSingleFilmModel"
            >选择</el-button>
          </el-col>
        </el-form-item>
        <el-form-item
        ...
        >
          ...
          <el-col :span="4">
            <el-button
              v-show="dataForm.useCinema==0 && false"
        ...
        >
          <el-row>
            <span style="position:relative;">
              <el-input-number
                style="width:100px;"
                ref="timeRatioLowerInput"
                v-model="dataForm.timeRatioLower"
                :precision="2"
                :min="0"
                :max="100"
                :disabled="!enabledEdit"
              ...
              <span
                style="position:absolute;right:8px;top:2px;line-height:1;color:#b0b0b0;"
                slot="suffix"
              >%</span>
            </span>
            <span>--</span>
            <span style="position:relative;">
              <el-input-number
                style="width:100px;"
                v-model="dataForm.timeRatioUpper"
                :precision="2"
                :min="0"
                :max="100"
                :disabled="!enabledEdit"
        ...
        >
          <el-row>
            <span>
              <el-input-number
                style="width:100px;"
                ref="timeNumLowerInput"
                v-model="dataForm.timeNumLower"
                :precision="0"
                :min="0"
                :max="10000"
                :disabled="!enabledEdit"
        ...
        <el-form-item v-if="enabledEdit">
          <el-button
            ...
            :loading="saveLoading"
            type="primary"
            :disabled="!enabledEdit || saveLoading"
          >确定</el-button>
