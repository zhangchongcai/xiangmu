          ...
          <el-collapse-item title="价格体系" name="3">
            ...
            <div class="table-bottom-menu">
              <el-form-item label="分区定价：" class="m-t-10">
                ...
                <el-table :data="tableData" style="width: 262px;margin-top:10px" v-if="pricing == 1">
                  ...
                  <div>
                    ...
                    >
                      <el-input
                        ...
                        placeholder="0"
                        @change="changeNumer(item.attendanceRate,index)"
                      ></el-input>
      ...
      self.$ctmList
        ...
        .then(res => {
          ...
          if (res.code == 200) {
            ...
            console.log(this.price_Channel_2,self.ciPriceSaleChannelVoList_2)
            var val = [];
            var val1 = [];
