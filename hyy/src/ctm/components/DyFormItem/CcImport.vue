...
<template>
  <div v-loading="loading">
    <el-upload ref="upload" class="upload" :action="uploadUrl" :headers="{token: token}" drag :on-change="onChange" :before-upload="beforeUpload" :on-success="onSuccess" :on-error="onError" :auto-upload="false" :limit="2" :file-list="fileList">
