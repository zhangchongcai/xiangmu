...
<div class="page-wrapper page-justsee-message-channel page-justsee-messagetml-edit">
    ...
    <div class="clearboth" style="margin-top:30px;"></div>
             ...
             <section class="film-base-page">
                 ...
                 <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="场景变量：" prop="seceneParam" style="margin-bottom:8px;">
                ...
                <el-row :gutter="20">
                    <el-col :span="12" class="temp-content">
                        ...
                        <el-input type="textarea" rows="4" colos="50" resize="none" v-model="messageTemplate.content" style="width:360px;" :disabled="isJustSee" placeholder="请选择短信场景" @change="templateTextareaFunc" @blur="templateTextareaFunc"></el-input>
