                ...
                <el-form-item label="所属角色：" prop="rolesName" >
                    <div class="box">
                        <ul class="tool" v-if="multipleSelection.length">
                            <i class="el-icon-close" style="top: -29px;left: 300px;position: absolute;font-weight: bolder;color:#3b74ff;font-size: medium" @click="clear(1)"></i>
                ...
                <el-form-item label="数据权限：" prop="deptName">
                    <div class="box">
                        <ul class="tool" v-if="deptNameArr.length">
                            <i class="el-icon-close" style="top: -27px;left: 300px;position: absolute;font-weight: bolder;color:#3b74ff;font-size: medium" @click="clear(3)"></i>
...
<script>
    ...
    import {editUser,orgList,roleTree,deptTree,onlyUser,attributeType} from 'frame_cpm/http/interface.js'
    export default {
        name: "editUser",
