<template>
  <section class="datacenter-box">
    <data-query
      ...
      :initStyleColArr="initStyleColArr"
    ...
    <data-table
      ...
      :mergeTableObj="mergeTableObj"
      :sonTableLoading="sonTableLoading"
      @setSonTableLoading="setSonTableLoading"
    ...
    <merge-table
      ...
      :styleExtQueryArr="styleExtQueryArr"
      :styleColArr="styleColArr"
      :mergeTableLoading="mergeTableLoading"
      :Pagination="Pagination"
      :mergeTableObj="mergeTableObj"
      @setMergeTableLoading="setMergeTableLoading"
    ></merge-table>
    <data-show
      :datatable="Jdata"
      :Pagination="Pagination"
      ...
      if (array1 && array2) {
        array1.forEach(element1 => {
          array2.forEach(element2 => {
            if (element1.queryColKey === element2.queryColKey)
