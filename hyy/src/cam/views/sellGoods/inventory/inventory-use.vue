    ...
    <div class="header-fixed">
        <div class="time-wrap clearfix">
            ...
            <div class="time-item">
              ...
              <el-cascader class="reset-cascader"
                  size="small"
          ...
          <el-table border :data="tableData">
            <el-table-column prop="goodSku" label="SKU编码"  min-width="110"></el-table-column>
             <el-table-column prop="goodName" label="商品名称"  min-width="120">
                <template slot-scope="scope">
                  <div @click="goDetail(scope.row.goodSku)" class="text-blue cursor">
  ...
  methods: {
   Time(){
    ...
    getOut(){
        ...
        let downUrl =`${this.baseURL}/analysis/sellGoods/psi/exportDetailData?userId=${this.userId}&startDate=${this.startTime}&endDate=${this.endTime}&dateType=${this.timeType}&token=${this.$store.state.loginToken}`;
        window.location.href = downUrl;
    },
    // 趋势导出
    getTrendOut(){
        // let baseURL = config.baseURL;
        let downUrl = `${this.baseURL}/analysis/sellGoods/psi/exportData?userId=${this.userId}&startDate=${this.startTime}&endDate=${this.endTime}&dateType=${
            this.timeType
        }&token=${
    ...
    // 前往商品
    goDetail(id){
      this.$router.push({name:'商品详情',query:{
        goodSku:id
      }})
    },
    // 分页/大小
