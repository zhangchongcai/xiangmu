<template>
  <div class="cinemaList">
          ...
          <el-col :span="24">
            <el-form-item label="适用影院:" required>
              ...
              <div v-show="isSome" class="cinemaDiv">
                <el-input v-model="cinemaName" clearable class="cinema" disabled>
                </el-input>
                <el-button @click="selectTreeEvent" style="border:1px solid #3B74FF;color: #3B74FF;">选择</el-button>
              </div>
    ...
    <el-dialog title="影院选择" :visible.sync="selectTreeValue" width="448px" :before-close="handleClose" :lock-scroll="false">
      <el-tree @node-click="nodeClick" :data="newselectValue" show-checkbox default-expand-all node-key="index" ref="tree" highlight-current v-loading="this.loading" :props="defaultProps"></el-tree>
