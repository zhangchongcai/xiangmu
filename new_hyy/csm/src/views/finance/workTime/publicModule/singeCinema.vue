<template>
  <el-dialog title="影院选择" :visible.sync="opendialog" width="448px" :lock-scroll="false">
    <el-tree :data="data" node-key="id" default-expand-all :expand-on-click-node="false" :render-content="renderContent" v-loading="this.loading"></el-tree>
