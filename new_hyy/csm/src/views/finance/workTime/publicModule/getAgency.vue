  ...
  <div class="my_dialog">
    <el-dialog :title="title" :visible.sync="dialogTableVisible">
      ...
      <div class="choose_table">
        <div>
          <el-table :data="gridData" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0} @select="select" ref="multipleTable" @select-all="selectAll">
            <el-table-column type="selection" :reserve-selection="true" width="40"></el-table-column>
            <el-table-column property="code" label="渠道类型" width="294"></el-table-column>
