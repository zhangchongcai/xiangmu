<template>
  <div class="">
    ...
    <!-- 弹窗 -->
    <myDialog :title="title" :dialogTableVisible.sync="dialogTableVisible" :isVip="isVip" :isOther="isOther" :pageData="pageData" :gridData="gridData" @chooseuUserName='chooseuUserName' @changeDialogTableVisible="changeDialogTableVisible">
    </myDialog>
  </div>
</template>
