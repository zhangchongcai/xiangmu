    ...
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item v-if="tradeRuleShow" title="交易规则" name="tradeRule">
        <el-form :model="tradeRuleFormData" :rules="tradeRuleFormDataRules" ref="tradeRuleFormData" label-width="240px">
          <el-form-item label="网络代售费：" :prop="tradeRuleFormData.netSaleFeeMode === 2 ? 'saleFeePercentage' : 'saleFeeMoney'">
            <el-select @change="netSaleFeeModeChange" v-model="tradeRuleFormData.netSaleFeeMode" placeholder="请选择">
              <el-option v-for="item in netSaleFeeModeOptions" :key="item.keyCode" :label="item.keyName" :value="item.keyCode">
              </el-option>
            </el-select>
            <span v-show="tradeRuleFormData.netSaleFeeMode === 2">
              <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.saleFeePercentage">
              </el-input> %
            </span>
            <span v-show="tradeRuleFormData.netSaleFeeMode !== 2">
              <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.saleFeeMoney">
              </el-input> 元
            </span>
          ...
          <el-form-item label="售票截止时间：" prop="saleEndTime">
            <div>
              ...
              <span v-show="tradeRuleFormData.saleEndTimeType === 0">
                <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.saleEndTime">
                </el-input> 分钟（最大100分钟）
              </span>
            </div>
            <div>
          ...
          <el-form-item label="渠道可预售排期天数：" prop="presalePlanDays">
            <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.presalePlanDays">
            </el-input> （最大60天）
          </el-form-item>
          <el-form-item label="每笔订单可购影票最多张数：" prop="maxSaleTicketAmount">
            <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.maxSaleTicketAmount">
            </el-input> （最大20张）
          </el-form-item>
          <el-form-item label="每笔订单可购卖品最多数量：" prop="maxSaleGoodsAmount">
            <el-input style="width: 100px" placeholder="请输入" v-model="tradeRuleFormData.maxSaleGoodsAmount">
            </el-input> （最大20笔）
          </el-form-item>
