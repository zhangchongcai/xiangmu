<template>
  <div class="rep-params">
    <div class="component">
      <el-form :rules="rules" :model="data" size="small" inline ref="formData" label-width="150px">
        <el-collapse v-model="activeNames">
              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label="自动上报时间：" prop="statisticalReportParamVo.autoReportTime">
                    <el-time-select v-model="data.statisticalReportParamVo.autoReportTime" :picker-options="{
                                        start: '06:30',
                                        step: '00:30',
                                        end: '11:30'
          ...
          <el-collapse-item title="信息接口设置" name="messageInterface">
            <div>
              <el-radio v-model="radio" label=-1 @change="messageRadio" style="margin-left:10px">启用</el-radio>
              <el-row>
                <el-col :span="10">
                  <!-- <el-form-item label=""  prop="movieName"> -->
                  <span class="base-plant">对接平台：</span>
                  <el-input v-model="dockInterface" style="width:200px;"></el-input>
                  <!-- </el-form-item> -->
                </el-col>
              </el-row>
              <el-row>
            ...
            <div v-for="(item,ind) in data.platAddressInfoList" :key="ind" class="platAddressInfoList">
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="对接平台：" :prop="'platAddressInfoList.'+ind+'.platName'" :rules="[{ required: true, message: '名字不能为空',trigger: 'blur'}]">
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="通讯接口IP地址：" :prop="'platAddressInfoList.'+ind+'.platIpAddress'" :rules="[{required:true, message:'ip地址不能为空',trigger:'blur'}]">
                    <el-input v-model="item.platIpAddress"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="端口号：" :prop="'platAddressInfoList.'+ind+'.platPort'" :rules="[{required:true, message:'端口号不能为空',trigger:'blur'}]">
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="通讯接口备用地址：" :prop="'platAddressInfoList.'+ind+'.platSpareIpAddress'" :rules="[{required:true, message:'备用地址不能为空',trigger:'blur'}]">
                    <el-input v-model="item.platSpareIpAddress"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="端口号：" :prop="'platAddressInfoList.'+ind+'.platSparePort'" :rules="[{required:true,message:'备用端口号不能空',trigger:'blur'}]">
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="用户名：" :prop="'platAddressInfoList.'+ind+'.platUserName'" :rules="[{required:true,message:'用户名不能空',trigger:'blur'}]">
                    <el-input v-model="item.platUserName"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="密码：" :prop="'platAddressInfoList.'+ind+'.platPassword2'" :rules="[{required:true,message:'密码不能空',trigger:'blur'}]">
              ...
              <el-row>
                <el-form-item label="授权接口：">
                  <div class="interface">
                    ...
                    <el-checkbox-group v-model="item.interfaceCodes" @change="handleCheckedCitiesChange(...arguments,item)">
            ...
            <div style="padding-top:5px;">
              <i class="iconfont icon-neiye-tianjia- add" @click="addplatAddressInfo">添加</i>
            </div>
          </el-collapse-item>
        </el-collapse>
      </el-form>
