  ...
  <div>
    ...
    <div class="download-film-header">
      ...
      <div class="button-wrap">
        <el-button type="primary" size="small" class="button-reset" @click="getDatas('backPageOne')">查询</el-button>

      </div>
      <div class="button-wrap">
        <el-button class="button-reset" @click="resetHandle">重置</el-button>
      ...
      <el-dialog title="下载影片" :visible.sync="dialogVisible" width="448px" :before-close="handleClose">
        <div>
          <div class="block">
            ...
            <el-date-picker v-model="downLoadMovieTime" type="daterange" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" align="center" value-format="yyyy-MM-dd">
            </el-date-picker>
          </div>
        </div>
