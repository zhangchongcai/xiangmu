        ...
        <el-form :rules="rules" ref="ruleForm" :model="sizeForm" label-width="85px" size="small" inline>
          <el-collapse-item title="基础信息" name="1">
            <div class="basic-info">
              ...
              <div>
                <el-form-item label="影片英文名：" prop="movieenglishname">
              ...
              <div>
                ...
                <el-form-item label="公映日期：" prop="datePublicShow">
                  <span class="cinema-stock-edit-text" v-if='sizeForm.datePublicShow'>
              ...
              <div>
                ...
                <el-form-item label="下映日期：" prop="dateShowOff">
                  <el-date-picker value-format="yyyy-MM-dd" type="date" placeholder="选择日期" v-model="sizeForm.dateShowOff" style="width: 100%;" @change="changeMinPriceEndtTimeFun"></el-date-picker>
                </el-form-item>
              </div>
              <div>
          ...
          <el-collapse-item title="分账信息" name="3">
            <div class="basic-info">
              <div class="separate-accounts-wrap">
                <el-form-item label="最低票价：" prop="dateShowFirst">
                  <div v-for="(item,index) in priceList" style="margin-top:8px;" :key="index">
                    <div class="separate-accounts-price">
                      <el-input size="small" v-model="item.minPrice" @change="priceChange(item.minPrice,index)"></el-input>
                      <span>元 ，</span>
                    </div>
                    <div class="separate-accounts-date">
                      ...
                      <el-date-picker @change="priceDateEndFun($event,index)" :disabled="index == priceList.length*1-1" v-model="item.dateEnd" type="date" @focus='priceChangePickerOptionsFun(index)' value-format="yyyy-MM-dd" placeholder="选择日期" :picker-options="pickerOptions">
                      </el-date-picker>
                    </div>
                ...
                <el-form-item label="发行方分账：" prop="dateShowFirst" label-width="95px">
                  ...
                  <div v-for="(item,index) in rateList" style="margin-top:8px;" :key=index>
                    ...
                    <div class="separate-accounts-date">
                      ...
                      <el-date-picker @change="accountDateEndFun($event,index)" v-model="item.dateEnd" :picker-options="pickerOptions" @focus='rateChangePickerOptionsFun(index)' :disabled="index == rateList.length*1-1" type="date" value-format="yyyy-MM-dd" placeholder="选择日期">
                      </el-date-picker>
                    </div>
...
export default {
  ...
  methods: {
    // test
    testmovieothername () {
      console.log('this.sizform.movieothername:', this.sizeForm.testMovieothername);
    },
    moreInfoChange () {
      // 有数据再跳转
      if (!this.getInfo()) {
    ...
    getDatas () {
      ...
      self.$ctmList
        ...
        .then(ret => {
          if (ret.data) {
            let result = ret.data;
            Object.assign(self.sizeForm, result.schMovie);
