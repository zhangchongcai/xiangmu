<template>
    <div class="plan-guide-list">
        <div class="header-filter-container">
            <div class="filter-option filter-pick-time"><span class="option-name">适用日期:</span>
             <el-date-picker
            ...
            <div class="filter-option filter-pick-status"><span class="option-name">状态:</span>
            ...
            <div class="filter-btn-con">
                <el-button class="w80-btn" type="primary" @click="getTableData(1)">查询</el-button>
            </div>
        </div>
        ...
        <el-dialog title="影院周转率设置" :visible.sync="turnoverRateSet" width="892px" custom-class="turnover-set-dialog" @closed="rateSetclosed">
            <div style="padding-bottom: 14px; border-bottom: 1px solid #e5e5e5; margin-bottom: 12px;">
                <div class="filter-tool">
                    ...
                    <div class="filter-options hall-option" >
                        <span style="margin-right: 8px;">厅数</span>
...
<script>
import { getPlanGuiideList, delPlanGuiideDetail, getTurnoverRate, getAreaInfo, getCinemaAreaList, setTurnoverRate, planGuideApproveRecall } from 'ctmSrc/http/interface'
import areaDataOrigin from 'ctmSrc/assets/data/area'
    export default {
        data() {
            return {
                statusOptions: [{
