  ...
  <div class="cinemaWall_list">
    <div class="content">
      ...
      <el-table stripe :data="tableData">
        ...
        <el-table-column prop="aliases" label="影厅别名" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="code" label="影厅编码" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="seatnum" label="座位数" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="type" label="影厅类型" :formatter="typeFormat" show-overflow-tooltip>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    wall_build () {
      this.$router.push({
        path: '/ticket/cinemawall/addAndnew',
        query: {
    ...
    wall_comfirm (hallUid) {
      ...
      this.$confirm(`您确定要删除此记录吗?`, '提示', {
        ...
        this.$ctmList.deleteCiHall(datas).then(data => {
    ...
    getList () {
      ...
      this.$ctmList.cinemagetList(data).then(data => {
        if (data && data.code === 200) {
