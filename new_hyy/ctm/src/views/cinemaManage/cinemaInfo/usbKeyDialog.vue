<template>
  <div class="cinema-dialog">
    <el-dialog title="选择要绑定的usbKey" :visible.sync="dialogVisible" width="576px" :close-on-click-modal=false>
      <div class="film-body">
      ...
      <div class="inner-dialog">
        <el-dialog width="30%" title="失败" :visible.sync="innerVisible" append-to-body>
