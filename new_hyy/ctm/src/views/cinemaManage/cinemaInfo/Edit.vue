          ...
          <el-form ref="cinema" :model="cinemaData" :rules="rules" label-width="130px" label-height='60px'>
            <div class="item item-left">
              ...
              <el-form-item label="开业时间：" class="text-indent">
                <el-date-picker v-model="cinemaData.openTime" type="date" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd" placeholder="选择日期">
                </el-date-picker>
              </el-form-item>
            ...
            <div class="item">
              ...
              <div class="PCA">
                <el-form-item label="所属城市：" class="text-indent">
                  <el-select size="small" style="width: 100px;display:inline-block" v-model="cinemaData.area.pcode" placeholder="请选择省份" v-on:change="getProv($event)">
                    <el-option v-for="item in provs" :label="item.areaName" :value="item.areaCode" :key=item.value>
                    </el-option>
                  </el-select>
                  <el-select size="small" style="width: 100px;display:inline-block" v-model="cinemaData.area.ccode" placeholder="请选择城市" v-on:change="getCity($event)">
                    <el-option v-for="item in citys" :label="item.areaName" :value="item.areaCode" :key="item.value">
                    </el-option>
                  </el-select>
                  <el-select size="small" style="width: 100px;display:inline-block" v-model="cinemaData.area.acode" placeholder="请选择区域" v-on:change="getAreas($event)">
            ...
            <div class="item left">
              <el-form-item label="影院等级：" prop="fax" class="text-indent">
                <el-select v-model="cinemaData.gradeCinema" placeholder="请选择" @change="selectGradeFun(0)">
                  <el-option v-for="item in cinemaList_options" :key="item.propertyCode" :label="item.propertyName" :value="item.propertyCode">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="区域：" prop="fax" class="text-indent">
                <el-select v-model="cinemaData.gradeArea" placeholder="请选择" @change="selectGradeFun(2)">
                  <el-option v-for="item in areaList_option" :key="item.propertyCode" :label="item.propertyName" :value="item.propertyCode">
                  </el-option>
                </el-select>
              </el-form-item>
            </div>
            <div class="item">
              <el-form-item label="卖品等级：" prop="fax" class="text-indent">
                <el-select v-model="cinemaData.gradeMer" placeholder="请选择" @change="selectGradeFun(1)">
                  <el-option v-for="item in merList_options" :key="item.propertyCode" :label="item.propertyName" :value="item.propertyCode">
                  </el-option>
                </el-select>
              </el-form-item>
            </div>
...
export default {
  ...
  data () {
    ...
    let mgcode_limit = (rule, value, callback) => {
      ...
      if (this.cinemaData.mgCode.length < 6) {
