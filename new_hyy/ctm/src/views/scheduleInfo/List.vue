  ...
  <section class="schedule-info-list">
    <el-form :inline="true" :model="formData" class="demo-form-inline search-form" size="small">
      <el-form-item label="公映年月：">
        <el-date-picker v-model="formData.showMonth" type="month" value-format="yyyyMM" placeholder="请选择">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="影片名称：">
        <el-select v-model="formData.movieCode" filterable remote clearable reserve-keyword placeholder="请输入影片名称" @clear="remoteMethod" :remote-method="remoteMethod" :loading="loading">
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="showMonth" label="公映年月" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="versionNo" label="版本" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="hallCount" label="状态" show-overflow-tooltip>
      ...
      <el-table-column prop="createUserName" label="操作人" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="createTime" label="操作时间" width="260" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="approveUserName" label="审核人" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="approveTime" label="审核时间" width="260" show-overflow-tooltip>
      </el-table-column>
