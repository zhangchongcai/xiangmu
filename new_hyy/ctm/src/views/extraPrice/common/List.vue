...
import { cinemaList, fetchCitySortList, queryExtraPriceList, updateExtraPriceState, deleteExtraPrice, queryChannelList, queryMyChannelList, fetchCinemaList, getExtraPriceChannelList } from 'ctmSrc/http/interface';
