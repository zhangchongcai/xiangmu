<template>
  <div :class='["ticket_design",isZoom ? "full" : ""]'>
        ...
        <div class="edit_ele">
          ...
          <el-collapse v-model="activeNames">
            <el-collapse-item title="全部元素" name="1">
              <div v-for="(item,ind) in ele_list" :key="ind" :class="['print-item',item.require==1?'star_required':'indents']" v-show="!item.isSele" @mousedown="drag($event,item,ind)">
    ...
    <el-main>
      <div class="main">
        ...
        <div :class='["design_box",isZoom ? "" : ""]' ref="design_box">
          ...
          <div class="scale_box">
            <canvas ref="mouse_canvas" width="500px" height="500px" @mousedown="mouseCanves_Mdown"></canvas>
          </div>
        </div>
        <div class="del">
        ...
        <div class="edi_ele">
          ...
          <div class="option-warp">
            ...
            <div class="content">
              ...
              <div class="inputFrame nowrap" v-else>
                <el-input type="input" v-model="cinemaNameList" @focus="cinemaDialogShow" :readonly="true" class="popup-input">
                  <i slot="suffix" class="el-icon-close popup-close" @click="clearCinemaName()" v-if="cinemaNameList"></i>
                </el-input>
              </div>
            </div>
          </div>
          <div class="option-warp">
            ...
            <div class="content">
              ...
              <div class="inputFrame nowrap" v-else>
                <el-input type="input" v-model="edi_ele.name" :disabled="config.isDefualtticketSample"></el-input>
              </div>
            </div>
          </div>
          <div class="option-warp sample-size">
            ...
            <div class="content">
              ...
              <div class="sel-size">
                <el-radio-group v-model="size" @change="size_sel">
          ...
          <div class="option-warp" style="height:auto">
            ...
            <div class="content">
              ...
              <div class="qudao" v-else>
                <el-select v-model="channel_new" multiple size="mini" remove-tag placeholder="选择渠道" @change="channel_change" @visible-change="channel_handel" :disabled="config.isDefualtticketSample">
                  <el-option v-for="item in channels" :key="item.value" :label="item.name" :value="item.uid">
                  </el-option>
                </el-select>
              </div>
            </div>
          ...
          <div class="curren_eleSel">
              ...
              <div class="content">
                <div class="inputFrame">
                  <el-select v-model="selected_element.size" placeholder="请选择" @change="fontSize_change">
                    <el-option v-for="item in fontOption" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </div>
              </div>
            ...
            <div class="option-warp" v-show="edi_ele.isPrintTitle==1">
              ...
              <div class="content">
                <el-radio-group v-model="selected_element.isPrintTitle" @change="isPrintTitle_change " :disabled="selected_element.showMode =='1' || selected_element.showMode=='2'">
                  <el-radio :label="1">是</el-radio>
              ...
              <div class="content">
                <div class="inputFrame">
                  <el-select v-model="selected_element.textLength" placeholder="请选择" @change="fontLength_chang">
                    <el-option v-for="item in fontCount" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </div>
              </div>
    ...
    <!-- 选择影院弹窗 -->
    <single-cinema @callBackSingle="handleSingleCallBack" :type='2' :framedialogVisible='singleCinemaVisible' :innerData="innerData" ref="frameSingleCinema">
      <div slot="footerId">
  ...
  data () {
    return {
      ...
      */
      ...
      defualt_background: require('ctmSrc/assets/images/ticketSample/ticket.jpg'),
      qrcode: require('ctmSrc/assets/images/ticketSample/qrcode.jpg'),
      barcode: require('ctmSrc/assets/images/ticketSample/barcode.jpg'),
    ...
    getElemendetil (uid) {
      this.$ctmList.ticketsampleQuery(uid).then(res => {
        if (res && res.code == 200) {
          ...
          this.config.isDefualtticketSample = data.isDefault == 1;
          // 获取适用影院
