    ...
    <div class="content">
      <table>
        <tbody>
          ...
          <tr>
            <th>票版宽度：</th>
            <td>{{Math.ceil(data.width/3.99)}}毫米</td>
          </tr>
          <tr>
            <th>票版高度：</th>
            <td>{{Math.ceil(data.height/3.99)}}毫米</td>
          </tr>
          <tr>
            <th>第三方票类专用：</th>
            <td>{{data.isOtherUse?"是":"否"}}</td>
          </tr>
          <tr>
            <th>打印标题：</th>
            <td>{{data.isPrinTitle?"是":"否"}}</td>
          </tr>
          <tr>
            <th>打印方向：</th>
            <td>{{data.printMode==1?"横向":"纵向"}}</td>
          </tr>
          <tr>
            <th>渠道：</th>
            <td>{{data.ticketsampleChannelNames}}</td>
          </tr>
        </tbody>
      </table>
      <div class="btn">
