<template>
  <div class="movie-plan-continuity">
    ...
    <div class="basic-info" v-if="isEditMode && movieData.soldSeatCount == 0">
      <div class="base-info-title">选择连排影片 <el-button @click="showAddFilmDialog" :disabled="movieData.saleStatus =='STOP'">添加影片</el-button>
      </div>
      <el-table :data="movieTable">
        <el-table-column prop="showIndex" label="放映顺序">
        </el-table-column>
        <el-table-column prop="movieName" label="放映影片名称">
        </el-table-column>
        <el-table-column prop="movieLanguage" label="放映影片语言">
        </el-table-column>
        <el-table-column prop="timeLong" label="时长(分钟)">
        </el-table-column>
        ...
        <el-tab-pane label="柜台/自助" name="first">
          <el-form label-width="80px">
            <el-form-item label="适用票类：">
              <div>
                <el-table :data="ticketData" ref="ticketMultipleTable" tooltip-effect="dark" style="width: 100%" row-key="id" @selection-change="ticketSelChange">
                  <el-table-column type="selection" :selectable="rowIsDisabled" width="55">
                  </el-table-column>
                  <el-table-column prop="name" label="票类名称" width="100">
                  </el-table-column>
                  <el-table-column prop="price" label="票类价格">
                    <template slot-scope="scope">
                      <span class="input-con">
                        <el-input type="number" maxlength="4" max="1000" @blur="tableFixed(scope)" v-model="scope.row.price"></el-input><i class="rmb-hover">¥</i>
                      </span>
                    </template>
                  </el-table-column>
                </el-table>
        ...
        <el-tab-pane label="线上网售" name="second">
          <el-form label-width="80px">
            <el-form-item label="适用渠道：">
              <div>
                <el-table ref="channelMultipleTable" :data="channelData" tooltip-effect="dark" style="width: 100%" row-key="uid" @selection-change="channelSelChange" class="edit-cichannel-table">
                  <el-table-column type="selection" width="55">
                  </el-table-column>
                  <el-table-column prop="name" label="代理商" width="100">
                  </el-table-column>
                  <el-table-column prop="price" label="渠道价格">
                    <template slot-scope="scope">
                      <span class="input-con">
                        <el-input type="number" maxlength="4" max="1000" @blur="cichannelToFixed(scope)" v-model="scope.row.price"></el-input><i class="rmb-hover">¥</i>
                      </span>
                    </template>
                  </el-table-column>
                </el-table>
      ...
      <el-tabs v-model="activeTab" type="card">
        <el-tab-pane label="柜台/自助" name="first">
          <el-form label-width="80px">
            <el-form-item label="适用票类：">
              <div>
                <el-table :data="ticketData" tooltip-effect="dark" style="width: 100%" @selection-change="ticketSelChange">
                  <el-table-column prop="name" label="票类名称" width="100">
                  </el-table-column>
                  <el-table-column prop="price" label="票类价格(元)">
                    <template slot-scope="scope">
                      <span class="input-con">{{scope.row.price}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column label="开售状态">
                    <template slot-scope="scope">
        ...
        <el-tab-pane label="线上网售" name="second">
          <el-form label-width="80px">
            <el-form-item label="适用渠道：">
              <div>
                <el-table :data="channelData" tooltip-effect="dark" style="width: 100%" class="edit-cichannel-table">
                  <el-table-column prop="name" label="代理商" width="100">
                  </el-table-column>
                  <el-table-column prop="price" label="渠道价格(元)">
                    <template slot-scope="scope">
                      <span class="input-con">{{scope.row.price}}</span>
                    </template>
                  </el-table-column>
    ...
    <div class="basic-info" v-if="isEditMode">
      ...
      <el-table :data="movieTable">
        <el-table-column prop="showIndex" label="序号" width="100">
        </el-table-column>
        <el-table-column prop="movieName" label="放映影片名称" width="100">
        </el-table-column>
        <el-table-column label="票价分摊比例(%)">
          <template slot-scope="scope">
            <span class="input-con">
              <el-input type="number" maxlength="3" max="100" @blur="percentTableToFixed(scope)" v-model="scope.row.percentPrice"></el-input>
            </span>
          </template>
        </el-table-column>
        <el-table-column label="最低票价(元)">
          <template slot-scope="scope">
            <span class="input-con">
              <el-input type="number" maxlength="4" max="1000" @blur="percentTableToFixed(scope)" v-model="scope.row.minPrice"></el-input>
            </span>
          </template>
        </el-table-column>
        <el-table-column label="分账比例(%)">
          <template slot-scope="scope">
            <span class="input-con">
              <el-input type="number" maxlength="3" max="100" @blur="percentTableToFixed(scope)" v-model="scope.row.publisherRate"></el-input>
            </span>
          </template>
        </el-table-column>
      </el-table>
      <div class="table-bottom-menu">
        ...
        <div class="prcie-promise">
          <el-checkbox v-model="permitSaleBox">允许包厢单卖</el-checkbox>
        </div>
        <div class="prcie-promise">
          <el-checkbox v-model="permitDiscount">允许营销活动折扣、会员折扣</el-checkbox>
        </div>
      ...
      <el-form>
        <el-form-item class="serach-con">
          <div class="search-wrap">
            <span>影片名称：</span>
            <el-input v-model="searchMovieName">
            </el-input>
          </div>
        ...
        <el-form-item>
          <el-table ref="multipleTable" :data="addMovieTable" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55">
            </el-table-column>
            <el-table-column prop="movieName" label="影片名称" width="200">

            </el-table-column>
            <el-table-column prop="disVersion" label="发行版本" width="70">
            </el-table-column>
            <el-table-column prop="moviedesclanguage" label="语言" width="70">
            </el-table-column>
            <el-table-column prop="timeLong" label="时长" width="70">
            </el-table-column>
...
<script>
import { getmoviePlanDetails, getPlanMovieList, initTimeLine, datePlanList, updateMoviePlan } from 'ctmSrc/http/interface';
export default {
  data () {
    return {
      isEditMode: false,
  ...
  methods: {
    // 获取初始数据
    dataInit () {
      this.isEditMode = this.$route.query.mode ? this.$route.query.mode == 'edit' : false;
