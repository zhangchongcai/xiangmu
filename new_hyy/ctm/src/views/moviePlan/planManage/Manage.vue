    ...
    <el-dialog title="复制放映计划" :visible.sync="copyPlanFormVisible">
      <el-form ref="copyPlanForm" :model="copyPlanForm" size="small">
        ...
        <el-form-item label="目标放映日期：" :label-width="formLabelWidth" prop="targetPlanDate">
          <el-date-picker v-model="targetPlanDate" type="daterange" value-format="yyyy-MM-dd" :clearable="false" :editable="false" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
          </el-date-picker>
        </el-form-item>
