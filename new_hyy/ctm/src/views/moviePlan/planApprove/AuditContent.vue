  ...
  <div class="audit-content">
    ...
    <div v-show="showType === 'table'">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="hallName" label="影厅" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="submitUserName" label="提交人" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="approveUserName" label="审批人" show-overflow-tooltip>
        </el-table-column>
    ...
    <el-table v-show="approveRecordData.length > 0" :data="approveRecordData" style="width: 100%; margin-bottom: 10px">
      <el-table-column prop="approveStatus" label="审批结果" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column prop="approveUesrName" label="审批人" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="approveTime" label="审批时间" show-overflow-tooltip>
      </el-table-column>
    </el-table>
    ...
    <el-form class="approve-form" v-show="!isView" :model="approveForm" :rules="rules" ref="approveForm" label-width="100px">
      ...
      <el-form-item label="审批意见：" prop="approveRemark">
        <el-input style="width: 360px" type="textarea" :rows="3" placeholder="请输入" v-model="approveForm.approveRemark" maxlength="500">
        </el-input>
...
import moviePlan from 'ctmSrc/views/moviePlan/planApprove/components/moviePlan';
