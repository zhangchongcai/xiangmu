  ...
  <div class="cinemaList">
    <div class="searchAdition">
      ...
      <el-form size="small" label-width="100px" v-model="displayTemplateVo">
        ...
        <!-- <el-row style="height:68px;">
            <el-col :span="16">
              <el-form-item label="页面轮播速度: （单位：秒）">
          ...
          <el-col :span="8">
            <el-form-item label="票价使用:">
              <el-select v-model="displayTemplateVo.memberTicket" placeholder="请选择">
                <el-option v-for="item in options1" :key="item.$index" :label="item.ticketTypeName" :value="item.ticketTypeUid">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="会员价使用:">
              <el-select v-model="displayTemplateVo.nonMemberTicket" placeholder="请选择">
                <el-option v-for="item in options2" :key="item.$index" :label="item.ticketTypeName" :value="item.ticketTypeUid">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
    ...
    <div class="table_div" v-if="false">
      ...
      <!-- <p>轮播图片</p> -->
      <p class="p_photo">
        <el-upload class="upload-demo" :http-request="ossUpdata" action list-type="text" :file-list="fileList" :before-upload="beforeAvatarUpload">
    ...
    getList () { // 初始设置
      ...
      this.$ctmList.getSwiperSet(Object.assign({}, httpObj)).then(res => {
        ...
        if (res.code === 200 && res.data) {
          ...
          this.options1 = res.data.ticketTypeList;
          this.options2 = res.data.ticketTypeList;
          // res.data.ticketTypeList[1] && this.options2.push(res.data.ticketTypeList[1]);
