<template>
  <div class="ctm-select-single-cinema">
    <el-dialog title="选择影院" :visible.sync="dialogVisible" :show-close="true" @close="close">
      <div class="film-top p-h-20">
        <el-form :inline="true" ref="ruleForm" size="small" class="film-search">
          <el-form-item label="影院编码：">
            <el-input v-model="searchAdition.cinemaCode"></el-input>
          </el-form-item>
          ...
          <el-button type="primary" @click="searchFunc" style="margin-top: 1px;margin-left:8px;">搜索</el-button>
        </el-form>
      </div>
      <div class="film-body p-h-20">
        <!-- class="diy-header" -->
        <el-table :data="filmList" @row-click="showRow" @current-change="handleRowChange" height="358px" ref="filmListRef" highlight-current-row>
          <!-- <el-table-column
                        type="selection"
                        width="55">
                    </el-table-column> -->
        ...
        <div>
          <div v-show="total>pageSize" class="b-b b-l b-r p-v-10 a-c">
...
export default {
  ...
  created () {
    ...
    console.log(this.innerData.toString());
    if (this.innerData.toString() != '{}') { this.selectedId = this.innerData.id; };
