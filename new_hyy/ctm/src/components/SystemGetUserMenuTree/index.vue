<template>
  <div class="systemStree">
    <el-tree ref="treeBox" :data="dataTree" :props="defaultProps" @node-click="handleNodeClick" highlight-current node-key="menuName" :default-expanded-keys="defaulKeyMerk" :default-checked-keys="defaulKey">
