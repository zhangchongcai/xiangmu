<template>
  <div>
    <!-- <input type="text" > -->
    <el-dialog title="影院选择" :visible.sync="selectCinemaStatus" width="576px" :before-close="handleClose">
      <el-input placeholder="输入关键字进行过滤" v-model="filterText"></el-input>
      <el-tree class="filter-tree" :data="getCinemaTreeList" :props="defaultProps" default-expand-all :filter-node-method="filterNode" show-checkbox node-key="uid" ref="tree2"></el-tree>
...
export default {
  ...
  methods: {
    handleClose () {
      this.$emit('selectCinemaClose', false);
    },
