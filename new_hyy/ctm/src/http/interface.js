...
export const tickettypeList = (limit, data) => {
  return axios({
    url:
      '/ticket/tickettype/list' +
      `?page=${limit.page}&pageSize=${limit.pageSize}`,
    method: 'post',
    data
  });
};
...
export const checkChannelExsit = data => {
  return axios({
    url:
      '/ticket/ticketsample/check/channel/exsit/' +
      `${data.cinemaUid}/${data.channelUid}  `,
    method: 'get'
  });
};
// 导入导出
...
export const openTerminal = data => {
  // 切换终端开启状态
  return axios({
...
export const saveSwiperSet = data => {
  // 保存轮播图的设置
  return axios({
...
export const getSwiperSet = params => {
  // 轮播图设置的初始值
  return axios({
...
export const templatecinemaUid = params => {
  // 后台模版的详细
  return axios({
...
// 数据字典
// const devHttp1 = "http://192.168.101.90:2301"
export const findByPage = params => {
  // 数据字典主表分页查询
  return axios({
    url: '/ticket/dictionary/findByPage',
    method: 'get',
    params
  });
};

export const dictionarySave = data => {
  // 数据字典主表新增
  return axios({
    url: '/ticket/dictionary/save',
    method: 'post',
    data
  });
};

export const getDicKeyByCode = params => {
  // 数据字典编码查子字典
  return axios({
    url: '/ticket/dictionary/getDicKeyByCode',
    method: 'get',
    params
  });
};
...
export const dictionaryUpdate = data => {
  // 数据字典修改
  return axios({
    url: '/ticket/dictionary/update',
    method: 'post',
    data
  });
};

export const dictionaryStatus = data => {
  // 子字典启用/禁用
  return axios({
    url: '/ticket/dictionary/set/status',
    method: 'post',
    data
  });
};
