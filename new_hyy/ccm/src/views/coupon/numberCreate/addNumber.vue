      ...
      <el-collapse-item title="基础信息" name="baseConfig">
        <div class="baseConfig">
          <el-form ref="validateForm" :model="baseConfig" :rules="formRules" label-width="120px">
            ...
            <div v-if="baseConfig.couponNumber == '0'">
            ...
            <el-form-item label="导入票券数据：" v-if="baseConfig.couponNumber == '1'">
              <el-upload class="upload-demo" :auto-upload="false" action="" :http-request="beforeUpload" :limit="2" :before-upload="beforeUpload" ref="newupload" :on-remove="removeFile" :on-change="onUploadChange" :list-type="'excel'" :file-list="fileList" style="display:inline-block;">
                <el-button slot="trigger" size="small" type="primary" plain style="width:90px">选择文件</el-button>
              </el-upload>
              <el-button type="text" @click="downLoadTem">下载模板</el-button>
            </el-form-item>
            <el-form-item label="票纸颜色：">
