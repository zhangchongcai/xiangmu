<template>
  <div class="ccm_dialog">
    <el-dialog title="选择支付方式" :close-on-click-modal="false" :visible="mydialogTableVisible">
      ...
      <div class="choose-body">
        <div class="choose-table">
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0} ref="multipleTable" @row-click="select">
...
<script>
import { payType } from 'ccmSrc/http/interface.js';
export default {
  props: {},
  data () {
    return {
