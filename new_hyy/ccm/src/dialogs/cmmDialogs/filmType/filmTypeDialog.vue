      ...
      <div class="choose_table">
        <div>
          ...
          <el-table :data="tableList" :cell-style={padding:0} :row-style={height:30} :header-cell-style={padding:0} ref="multipleTable" @select-all="handleSelect" :row-key="getRowKeys" @select="handleSelect">
            ...
            <el-table-column property="propertyCode" label="影片类型编码" width="294"></el-table-column>
            <el-table-column property="propertyName" label="影片类型名称" width="294"></el-table-column>
          </el-table>
          <!-- 分页 -->
...
<script>
import { movieType } from "ccmSrc/http/interface.js"
export default {
  props: {
    dialogTableVisible: {
      type: Boolean,
    ...
    getFilmTypeList () {
      ...
      movieType().then(res => {
        if (res.data && res.code == 200) {
          ...
          // this.pageData.total=res.data.propertyList.length || 0
          //}
