<template>
  <div class="ccm_dialog">
    <el-dialog title="选择影院" :visible.sync="framedialogVisible" :close-on-click-modal="false">
      <div>
...
import { getCinemaList } from 'ccmSrc/http/interface.js';
export default {
  props: {
    innerData: {
      type: Object,
  ...
  data () {
    return {
      ...
      searchAdition: {
        ...
        cityName: '',
        regionName: '',
        userUid: this.$store.state.loginUser.uid
      },
      multipleSelection: [],
      filmList: [],
      provs: [],
