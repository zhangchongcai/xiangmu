  ...
  <section>
    <el-dialog title="选择支付方式" :visible.sync="dialogVisible">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="payTypeName" label="支付方式" show-overflow-tooltip>
        </el-table-column>
      </el-table>
...
<script>
import { selectForTenant } from '../../http/interface';
export default {
  name: "PayType",
  props: {
    cinemaUidList: {
