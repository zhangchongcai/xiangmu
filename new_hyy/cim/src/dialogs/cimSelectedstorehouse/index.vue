<template>
  <el-dialog class="good-select-dialog" width="70%" :title="title" :visible="dialogVisible" @close="handleDialog">
    <div>
      <el-row>
        <el-col :span="20">
          <div>
          ...
          <div>
            <el-row>
              <el-col :span="20">
                <div class="table-box">
                  <el-table ref="materialTable" :data="tableData" max-height="500" row-key="uid" @selection-change="handleSelectionMaterial">
                    <el-table-column type="selection" width="40" :selectable="isDisabled" disabled="true"></el-table-column>
                  ...
                  <div class="page-wrap">
                    <el-pagination @current-change="handleCurrentChange" :current-page="queryData.currentPage" :page-size="queryData.pageSize" layout="total, prev, pager, next,jumper" :total="this.total"></el-pagination>
                  </div>
                </div>
              </el-col>
              <el-col :span="4">
                <div class="empty-box">
                  ...
                  <ul class="empty-content">
                    <li v-for="(item) in selectedgoods" :key="item.code">
                      <el-tag size="small" @close="toggleRowSelection(item,false)" closable>{{item.merName || item.name}}</el-tag>
                    </li>
                  </ul>
                </div>
              </el-col>
