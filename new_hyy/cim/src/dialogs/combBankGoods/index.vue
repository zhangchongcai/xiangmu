        ...
        <el-row>
          <el-col :span="5">
            <div class="good-trees-box">
              <el-tree :data="categoryTrees" icon-class="iconfont icon-neiye-zhankaijiantou" :props="defaultProps" highlight-current node-key="categoryId" :default-expanded-keys="defaultExpanded" @node-click="handleaCtegoryTrees">
              </el-tree>
            </div>
          </el-col>
          <el-col :span="19">
                ...
                <el-col :span="5">
                  <div class="empty-box">
                    ...
                    <ul class="empty-content">
                      <li :key="item.skuUid || item.merCode" v-for="(item) in selectedgoods" class="clearfix">
          ...
          <el-col>
            <div>
              <el-row>
                <el-col>
                  <div class="table-box">
                    <el-table ref="materialTable" :data="newtableData" height="450" :row-key="getRowKey">
                      <!-- <el-table-column
                      type="selection"
                      width="40"
                      reserve-selection
                      ...
                      disabled="true"
                    ></el-table-column> -->
                      <el-table-column v-for="item in newtableColumn" :key="item.key" :prop="item.key" :label="item.label" :width="item.width" :formatter="item.formatter">
...
<script>
// combBankGoodsDialog
import combbankgoodsDialog from 'cimSrc/components/combBankGoodsDialog/cinemaDialog.vue';
export default {
  props: {
    title: {
      type: String,
