<template>
  <el-dialog class="cim-good-select-dialog retail-style" width="1016px" :title="title" :visible="dialogVisible" @close="closeCallBack" @open="openCallBack">
    <div>
      <el-row>
        <el-col :span="5">
