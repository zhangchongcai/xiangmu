<template>
  <div>
    <el-dialog title="选择商品" :visible.sync="ComBankdialogVisible" width="70%" :before-close="cancelComBtn">
      <div class="box">
        <div class="box-left">
          <el-tree :data="proThreedata" :props="proThreedefaultProps" @node-click="handleNodeClick">
          </el-tree>
        </div>
        <div class="box-right">
          ...
          <div class="box-right-main">
            <div class="box-main-table">
              ...
              <div class="page-wrap">
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="GoodsListQueryData.page" :page-sizes="[10,20,30]" :page-size="GoodsListQueryData.pageSize" layout="total, sizes, prev, pager, next, jumper" :total='this.total'>
                </el-pagination>
              </div>
            </div>
