<template>
  <el-dialog class="cim-good-classify-dialog" width="500px" :title="title" :visible="dialogVisible" @close="closeCallBack" @open="openCallBack">
    <div>
      <el-row>
        <el-col :span="24">
          <div class="good-trees-box">
            <el-tree :data="categoryTrees" ref="refCategoryTrees" icon-class="iconfont icon-neiye-zhankaijiantou" :props="defaultProps" highlight-current check-on-click-node check-strictly node-key="code" show-checkbox v-loading="categoryTableLoding" :default-expanded-keys="defaultExpanded" @node-click="handleaCtegoryTrees">
            </el-tree>
          </div>
        </el-col>
      </el-row>
