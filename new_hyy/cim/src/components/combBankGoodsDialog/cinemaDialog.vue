  ...
  <el-dialog class="cinema-dialog" :width="multiple ?'896px': '576px'" :title="title" :visible.sync="cinemalDialog" @open="openCallBack">
    ...
    <el-row>
      <el-col :span="multiple  ? 19 : 24">
        <el-table class="table-box" ref="cinemalTable" :data="cinemalTableData" row-key="cinemaUid" height="300" v-loading="tableLoding" @selection-change="handleSelectionCinemal">
          <div v-if="!check">
