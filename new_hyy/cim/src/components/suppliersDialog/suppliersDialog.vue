<template>
  <el-dialog class="suppliers-dialog" width="600" :title="title" :visible.sync="supplierDialog" @open="openCallBack">
    ...
    <div class="table-box">
      <el-table ref="supplierTable" :data="tableData" height="400" v-loading="tableLoding" row-key="supUid" @selection-change="handleSelectionsSupplier" stripe>
      ...
      <div class="page-wrap">
        <el-pagination background :current-page="queryData.currentPage" :page-size="queryData.pageSize" :total="total" @size-change="handleSizeChange" @current-change="handleCurrentChange" layout="total, prev, pager, next, jumper"></el-pagination>
      </div>
    </div>
    <span slot="footer">
