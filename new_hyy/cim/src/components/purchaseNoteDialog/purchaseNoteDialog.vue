<template>
  <div>
    <el-dialog class="purchase-note-dialog" width="1100px" title="选择采购单" :visible.sync="supplierDialog" @open="openCallBack">
    ...
    <el-dialog class="purchase-note-dialog" title="查看采购单" :visible.sync="checkPurchaseNoteDialog" width="1100px">
    ...
    return {
      ...
      purchaseNoteDetailTableColumn: [
        ...
        },
        {
          ...
          formatter (row, column, cellValue) {
            return row.excludingTaxCost.toFixed(4);
          }
        },
        {
          label: '不含税金额(元)',
          ...
          formatter (row, column, cellValue) {
            return row.excludingTaxAmount.toFixed(4);
          }
        },
        {
          label: '税额(元)',
          key: 'taxAmount',
          formatter (row, column, cellValue) {
            return row.taxAmount.toFixed(4);
          }
        }
      ]
    };
