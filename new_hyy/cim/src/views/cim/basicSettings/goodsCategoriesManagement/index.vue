<template>
  <div class="retail-style goods-categories-management">
    ...
    <div>
      <el-row>
        <el-col :lg="4">
          <div class="list-tree">
            <!-- 分类树 -->
            <el-tree :data="bigClassTeeData" :props="defaultProps" node-key="uid" highlight-current :default-expanded-keys="defaultExpanded" v-loading="treeLoding" @node-click="handleTreeNodeClick">
    ...
    <el-dialog class="change-dialog" :title="isNewBuile ? '新建商品分类':'修改商品分类'" :visible.sync="changeDialog" width="500px">
          ...
          <p>
            ...
            <el-popover placement="right" width="400" trigger="click">
              <div class="change-tree retail-style">
                <el-tree :data="buildBigClassTeeData" :props="defaultProps" accordion node-key="uid" icon-class="iconfont icon-neiye-zhankaijiantou" highlight-current @node-click="handleClassTreeNodeClick">
                  <span class="custom-tree-node" slot-scope="{ node, data }">
                    <el-radio v-model="customTree" :label="data.uid" :disabled="data.uid==0"></el-radio>
                    <span>{{ node.label }}</span>
                  </span>
                </el-tree>
              </div>
          ...
          <p>
            ...
            <el-popover class="retail-style" placement="right" width="400" trigger="click">
              <div class="change-tree norm-change-tree  retail-style">
                <el-tree :data="buildCriterionClassData" :props="defaultProps" accordion node-key="uid" icon-class="iconfont icon-neiye-zhankaijiantou" highlight-current @node-click="handleCriterionNodeClick">
                  <span class="custom-tree-node" slot-scope="{ node, data }">
                    <el-radio v-model="customTree" :label="data.uid" :disabled="data.uid==0"></el-radio>
                    <span>{{ node.label }}</span>
                  </span>
