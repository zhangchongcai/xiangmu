<template>
  <div class="retail-style goods-unit">
    <div class="common-header sales-type-header">
      <el-form :inline="true" :model="queryData" label-position="left" label-suffix="：">
        <el-form-item label="单位编码">
          <el-input v-model="queryData.unitCode" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="单位名称">
          <el-input v-model="queryData.unitName" placeholder="请输入"></el-input>
        </el-form-item>
    ...
    <el-dialog class="change-dialog" :title="isNewBuile ? '新建单位':'修改单位'" :visible.sync="changeDialog" width="400px">
      <el-form :inline="true" ref="changeForm" :model="changeData" label-position="left" label-width="100px" label-suffix=":" :rules="changeRules">
        ...
        <el-form-item label="单位类型" prop="unitType">
          <el-radio v-model="changeData.unitType" label="0" :disabled="!isNewBuile" @change="handleUnitTypeChange">基本单位</el-radio>
          <el-radio v-model="changeData.unitType" label="1" :disabled="!isNewBuile" @change="handleUnitTypeChange">采购单位</el-radio>
        </el-form-item>
      </el-form>
      <span slot="footer">
