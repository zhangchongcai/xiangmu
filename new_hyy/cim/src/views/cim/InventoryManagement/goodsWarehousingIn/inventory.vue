  ...
  <div class="grIn-style">
    <div class="content">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>{{typeText}}盘点赔偿入库</el-breadcrumb-item>
      </el-breadcrumb>
    </div> -->
          ...
          <el-collapse-item title="基础信息" name="1">
            <div>
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label="登记门店" class="select-input" prop="cinemaName" :rules="[{ required: routeQuery.type==3 ? false : true, message: '选择登记门店',trigger: 'change' }]">
              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label='' prop="storehouseCode" :rules="[{ required: true, message: '选择出库仓库或货架',trigger: 'change' }]">
