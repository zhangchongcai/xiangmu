        ...
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="基础信息" name="1">
            <div>
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="调入门店" class="select-input" prop="inCinemaName" :rules="[{ required: routeQuery.type==3 ? false : true, message: '选择调入门店',trigger: 'change' }]">
                ...
                <el-col :span="10">
                  <el-form-item label="调出门店" class="select-input" prop="outCinemaName" :rules="[{ required: routeQuery.type==3 ? false : true, message: '选择调出门店',trigger: 'change' }]">
                    <template v-if="routeQuery.type=='1' || routeQuery.type=='2'">
          ...
          if (valid) {
            ...
            if (this.goodList.length === 0) {
              ...
              if (newAvtive.a1 === true) {
                this.$message(newAvtive.a2.merName + ':调拨申请必须为大于0的正数');
              } else {
                this.queryData.detailList = this.goodList;
                if (this.routeQuery.type == '1') {
