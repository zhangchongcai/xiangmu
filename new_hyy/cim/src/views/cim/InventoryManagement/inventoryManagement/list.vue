    ...
    <div class="common-header">
      <el-form :inline="true" :model="queryData" label-position="left" label-suffix="：">
        ...
        <el-form-item label="盘点月份">
          <el-date-picker v-model="queryData.checkMonth" type="month" placeholder="选择月" format="yyyy-MM" value-format="yyyy-MM">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="制单日期">
          <el-date-picker class="basic-input" v-model="queryData.createTime" type="datetimerange" format="yyyy-MM-dd HH:mm" value-format="yyyy-MM-dd HH:mm" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        ...
        <el-table :data="tableData" stripe :height="this.defaultTableHeight">
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="{row}">
              ...
              <el-button type="text" size="small" @click.stop="handleOperateEvent('2', row)" v-if="row.status === 1 && row.approvalStatus === 0">编辑</el-button>
              <el-button type="text" size="small" @click.stop="handleOperateEvent('4', row)" v-if="row.status === 1 && row.approvalStatus === 0">删除</el-button>
              <el-button type="text" size="small" @click.stop="handleOperateEvent('5', row)" v-if="row.status === 2 && row.approvalStatus === 0">差异处理</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="page-wrap">
