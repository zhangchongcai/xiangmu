    ...
    <div class="common-header">
      <el-form :inline="true" :model="queryData" label-position="left" label-suffix="：">
        ...
        <el-form-item label="入库门店" class="select-input">
          <el-input v-model="queryData.cinemaName" clearable @clear="onCinemalSumit" @focus="handleDialogEvent('myCinemalDialog')" placeholder="请选择门店"></el-input>
        ...
        <el-form-item label="供应商名称" class="select-input">
          <el-input v-model="queryData.supName" clearable placeholder="请选择供应商" @clear="onSuppliersSumit" @focus="handleDialogEvent('mySuppliersDialog')"></el-input>
        ...
        <el-table :data="tableData" stripe v-loading="tableLoding">
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="{row}">
              ...
              <el-button type="text" size="small" v-if="row.approvalStatus==0 || row.approvalStatus==3" @click.stop="handleOperateEvent('2', row)">编辑
              </el-button>
              <el-button type="text" size="small" v-if="row.approvalStatus==0 || row.approvalStatus==3" @click.stop="handleOperateEvent('3', row)">提交
              </el-button>
              <el-button type="text" size="small" v-if="row.approvalStatus==0 || row.approvalStatus==3" @click.stop="handleOperateEvent('4', row)">删除
              </el-button>
            </template>
          </el-table-column>
        </el-table>
