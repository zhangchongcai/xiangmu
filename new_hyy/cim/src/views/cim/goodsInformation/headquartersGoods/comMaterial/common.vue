<template>
  <div class="material-style">
    <div class="content">
      ...
      <el-form :inline="true" :model="queryData" ref="ruleForm" label-position="left" label-width="85px" label-suffix="：" :rules="changeRules">
        <!-- 基础信息 start-->
        ...
        <el-collapse v-model="activeNames">
          <el-collapse-item title="基础信息" name="1">
            <div>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="销售别名" prop="aliasName" :rules="[
            ...
            <div>
              ...
              <div>
                <el-table :data="basicUnitData" stripe v-if="routeQuery.type != 3">
                  <el-table-column v-for="item in routeQuery.type ==2 ? basicUnitColumn2 : basicUnitColumn" :key="item.key" :prop="item.key" :label="item.label" :width="item.width" :formatter="item.formatter">
                ...
                <el-table :data="basicUnitData" stripe v-if="routeQuery.type == 3">
                  <el-table-column v-for="item in basicUnitColumn1" :key="item.key" :prop="item.key" :label="item.label" :width="item.width" :formatter="item.formatter">
              ...
              <diV>
                <el-button icon="el-icon-circle-plus-outline" @click="addUnitEvent()" type="text" v-if="routeQuery.type != 3">添加采购单位</el-button>
              </diV>
            </div>
          </el-collapse-item>
          <!-- 采购信息 end-->
          ...
          <el-collapse-item title="销售信息" name="3">
            <div>
                ...
                <el-row>
                  <el-col :span="10">
                    ...
                    <el-form-item label="售价" prop="skuVoList.price" :rules="[{ required: true, message: '售价不能为空',trigger: 'change' },{ validator: priceValidator, trigger:'change'}]">
                      <el-input placeholder class="basic-input widthInput100" type="number" v-if="routeQuery.type != 3" :value="queryData.skuVoList.price" @input="priceInputEvent($event)"></el-input>
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="安全库存" prop="storeUpLimit" :rules="[
                    { required: false,trigger: 'change' },
                ...
                <el-col :span="10">
                  <el-form-item label="下限" prop="storeDownLimit" :rules="[
                    { required: false,trigger: 'change' },
