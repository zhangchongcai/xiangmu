<template>
  <div>
    <el-dialog title="选择商品" :visible.sync="ComBankdialogVisible" width="70%" @open="openCallBack" :before-close="handleClose">
      <div class="box">
        <div class="box-left">
            ...
            <div class="box-main-table">
              <div class="page-table">
                <el-table :data="firsttable" height="360" stripe>
                  ...
                  <el-table-column v-for="item in firsttableColumn" :key="item.key" :prop="item.key" :label="item.label"></el-table-column>
                </el-table>
              </div>
              <div class="page-wrap">
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryData.page" :page-sizes="[100, 200, 300, 400]" :page-size="queryData.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="400">
                </el-pagination>
              </div>
            </div>
    ...
    <el-dialog title="为商品指定分类" :visible.sync="AppointDialogVisible" width="70%" :before-close="handleClose">
      <div class="next-box">
        <div class="next-pro-top">已选择商品</div>
        <div class="next-pro-main">
          <el-table :data="table" height="475" stripe>
            <el-table-column v-for="item in tableColumn" :key="item.key" :prop="item.key" :label="item.label"></el-table-column>
    ...
    <el-dialog title="选择商品分类" :visible.sync="selectComDialogVisible" width="20%" :before-close="handleClose">
      <div>
