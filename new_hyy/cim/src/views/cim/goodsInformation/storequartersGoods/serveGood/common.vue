<template>
  <div class="content serve-good">
        ...
        <el-collapse-item title="基础信息" name="1">
          <div>
            ...
            <el-row>
              ...
              <div class="form-item-box left">
                <el-form-item prop="shorthandCode" label="速记代码">
                ...
                <el-form-item label="销售地点">
                  ...
                  <div v-else>
                    ...
                    <span class="apply-tag select-input" v-if="queryData.salePlace!='1'">
                      ...
                      <el-button type="primary" plain v-if="routeQuery.type!=3" @click.stop="handleDialog('mySalesPlaceDialog')">选择</el-button>
                    </span>
                  </div>
                </el-form-item>
              </div>
    ...
    <!-- 选择渠道弹窗 -->
    <channel-dialog ref="myChannelDialog" @onSumit="onChanneSumit" :dialogFeedbackData="queryData.cinemaSaleChannelEntityList" :cinemaUid="routeQuery.cinemaUid" :multiple="multipleCinemal" :title="cinemalDialogTittle" :check="routeQuery.type==3 && queryData.saleCinema!=1"></channel-dialog>
    <!-- 选择销售地点 -->
    <sales-place ref="mySalesPlaceDialog" @onSumit="onSalesPlaceSumit" :cinemaUid="routeQuery.cinemaUid" :dialogFeedbackData="queryData.cinemaSalePlaceEntityList" :check="routeQuery.type==3 && queryData.salePlace!=1" :multiple="multipleCinemal" :title="salesPlaceTittle"></sales-place>
  </div>
</template>
