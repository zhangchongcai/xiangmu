    ...
    <div class="content">
      ...
      <el-form :inline="true" ref="ruleForm" :model="queryData" label-position="left" label-width="85px" label-suffix="：">
        ...
        <div>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item prop="name" label="商品名称" :rules="[{ required: true, message: '商品名称不能为空',trigger: 'change' }]">
        ...
        <div>
          ...
          <div class="recipe-box" v-for="(item,groupIndex) in formattingDataList" :key="item.id" v-show="item.options.length>0">
            <div class="add-material clearfix">
              ...
              <el-table :data="item.options" stripe v-loading="tableLoding">
                  ...
                  <template slot-scope="{row}" name="header">
                    ...
                    <div v-else-if="item.bothEdit">
                      ...
                      <div v-else>
                        ...
                        <el-input size="small" class="both-edit-inp" v-model="row[item.key].price" placeholder></el-input>
                      </div>
                    </div>
                    <div v-else>
                ...
                <el-table-column label="操作" v-if="routeQuery.type!=3">
                  <template slot-scope="{row,$index}">
                    <el-button v-if="item.isOption == 0" type="text" size="small" @click.stop="handleAddOptionalItems(row, $index)">添加可选商品</el-button>
        ...
        <div>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="售价" prop="price" :rules="[{ required: routeQuery.type==3 ? false : true, message: '售价不能为空',trigger: 'change' },{ validator: priceValidator, trigger:'change'}]">
                <el-input placeholder class="basic-input200 widthInput100" type="number" :value="queryData.price" @input="priceInputEvent($event)" v-if="routeQuery.type != 3"></el-input>
          ...
          <el-row class="putaway-timer">
            <el-col :span="12">
              <el-form-item prop="upTime" label="上架时间">
                ...
                <el-date-picker v-else class="date-picker widthInput100" v-model="queryData.upTime" type="datetime" format="yyyy-MM-dd HH:mm" value-format="yyyy-MM-dd HH:mm" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
      ...
      <!-- 添加套餐 -->
      <el-dialog class="change-dialog" width="70%" title="选择套餐及包装" :visible.sync="addRawMaterialDialog">
        <div>
          <el-row>
            <el-col :span="6">
            ...
            <el-col :span="18">
              <div>
                <el-form :inline="true" :model="materialQueryData" label-position="right" label-suffix=":">
                  <el-row>
                    <el-col :span="10">
                      <el-form-item label="商品名称">
                        <el-input placeholder class="change-dialog-inp" v-model="materialQueryData.name"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="10">
                      <el-form-item label="商品编码">
                        <el-input placeholder class="change-dialog-inp" v-model="materialQueryData.merCode"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="2">
                      <el-form-item label>
                  ...
                  <el-row>
                    <el-col :span="10">
                      <el-form-item label="SKU编码">
                        <el-input placeholder class="change-dialog-inp" v-model="materialQueryData.code"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="10">
                      <el-form-item label="速记代码">
                        <el-input placeholder class="change-dialog-inp" v-model="materialQueryData.shorthandCode"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                </el-form>
              ...
              <div>
                <el-row>
                  <el-col :span="18">
                    <div class="table-box">
                      <el-table ref="materialTable" :data="materialTableData" height="300" @selection-change="handleSelectionMaterial" stripe v-loading="tableLoding">
                        <el-table-column type="selection" width="40"></el-table-column>
                        <el-table-column v-for="item in materialTableColumn" :key="item.key" :prop="item.key" :label="item.label" :formatter="item.formatter"></el-table-column>
                      </el-table>
                      <div class="page-wrap">
                    ...
                    <div class="empty-box">
                      ...
                      <ul class="empty-content">
                        <li v-for="(item,index) in selectedMaterials" :key="item.code">
                          <el-tag size="small" @close="handleDelMaterial(item,index)" closable>{{item.name}}</el-tag>
                        </li>
                      </ul>
                    </div>
                  </el-col>
      ...
      <!-- 选择销售地点 -->
      <sales-place ref="mySalesPlaceDialog" @onSumit="onSalesPlaceSumit" :cinemaUid="newcinemaUid" multiple>
      </sales-place>
      <!-- 选择渠道弹窗 -->
      ...
      this.$cimList.storequartersGoods
        ...
        .then(resData => {
          if (resData.code == 200) {
            ...
            this.queryData.dataList == null ? [] : this.queryData.dataList;
            this.queryData.dataList.forEach((skuval) => {
              if (skuval.merType == '2' || skuval.merType == 2) {
                skuval.merName = skuval.merName + '-' + skuval.skuName;
              }
            });
