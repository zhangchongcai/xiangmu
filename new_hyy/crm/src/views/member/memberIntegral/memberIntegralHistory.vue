  ...
  <div class="_member-integral-history">
    ...
    <el-form :inline="true" :model="formData" ref="formData" class="form-data-wrap _member-search-area-custom">
      ...
      <el-form-item label="积分交易类型：" label-width="96px" prop="integralType">
        <el-select v-model="formData.integralType" placeholder="请选择积分交易类型" clearable>
          <el-option v-for="item in integralTypeOptions" :key="item.code" :label="item.desc" :value="item.code">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="交易时间：" label-width="72px" prop="startTime">
        <el-date-picker v-model="formData.startTime" value-format="yyyy-MM-dd HH:mm:ss" default-time="00:00:00" type="datetime" placeholder="开始时间"></el-date-picker>
        <span class="word-line">至</span>
        <el-form-item prop="endTime" style="margin-right: 0px!important;">
          <el-date-picker v-model="formData.endTime" value-format="yyyy-MM-dd HH:mm:ss" default-time="23:59:59" type="datetime" placeholder="结束时间"></el-date-picker>
        </el-form-item>
      </el-form-item>
    ...
    <div class="member-list-table _m-member-table-custom">
      <el-table :data="tableData" stripe style="width: 100%" :empty-text="tipMessage">
        <el-table-column prop="flowNo" label="积分流水号" min-width="170" :formatter="formateEmpty" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="integral" label="积分数量" min-width="80" :formatter="formateEmpty" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="cinemaName" label="交易影院" min-width="120" :formatter="formateEmpty" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="operator" label="操作人" min-width="100" :formatter="formateEmpty" show-overflow-tooltip>
        </el-table-column>
        <el-table-column fixed="right" label="操作" min-width="100">
          <template slot-scope="scope">
            <el-button @click="handleCheckIntegralDetail(scope.row)" type="text" size="small" class="operation-button">
              查看</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    // 请求列表
    search () {
      let params = this.formDataSelectionEmpty(
