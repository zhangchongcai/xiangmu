          ...
          <div class="goods-info">
            ...
            <el-form-item label="商品类型：" prop="goodsType" class="balance-insufficient">
              <el-select v-model="ruleForm.goodsType" placeholder="选择商品类型">
                <el-option v-for="item in goodsTypeOptions" :key="item.commodityTypeNo" :label="item.commodityTypeName" :value="item.commodityTypeNo"></el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="有效期：" class="ticket-preferential-restrictions-wrap" prop="validityType">
              <div class="ticket-preferential-restrictions-item">
                ...
                <el-date-picker style="width:360px" v-model="cooperationTime" :disabled="!(ruleForm.validityType == 'fixed_type')" align="right" unlink-panels clearable range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss" :default-time="['00:00:00', '23:59:59']"></el-date-picker>
              </div>
              <div class="ticket-preferential-restrictions-item">
                <el-radio v-model="ruleForm.validityType" label="dynamic_type">动态型</el-radio>
                <el-input @input="changeTimeNum" :value="ruleForm.validityType == 'dynamic_type'?ruleForm.timeNum:''" placeholder="请输入天数" :disabled="!(ruleForm.validityType == 'dynamic_type')" size="medium"></el-input>
                天
              </div>
            </el-form-item>
            ...
            <el-form-item label="商品说明：" prop="remark" class="remark">
              <el-input type="textarea" resize="none" :rows="5" v-model="ruleForm.remark" placeholder="请输入商品文本介绍">
              </el-input>
            </el-form-item>
            <el-form-item label="商品图片：" prop="imgPath" class="imgPath">
              ...
              <div :style="ruleForm.imgPath?'float:left;margin-left:10px;margin-top:-5px;':''">
                <el-upload style="margin-top:5px " :show-file-list="false" :action="$store.state.default.apiConfig.baseURL+$store.state.crm.imgAction" list-type="picture-card" :before-upload="beforeAvatarUpload" accept="image/*" :on-success="imgUpload" :multiple="false" name="file" :data="{type:'equity_picture'}" :headers="uploadHeaders">
        ...
        <el-collapse-item title="库存预警" name="3">
          <div class="stock-early-warning">
            ...
            <el-form-item label="预警手机号：" prop="diffGoodsWarning.warningMobileNums">
              <el-input v-model="ruleForm.diffGoodsWarning.warningMobileNums" placeholder='请输入预警手机号,多个手机号用英文";"号隔开'>
              </el-input>
            </el-form-item>
            <el-form-item label="预警邮箱地址：" prop="diffGoodsWarning.warningEmail">
              <el-input v-model="ruleForm.diffGoodsWarning.warningEmail" placeholder='请输入预警邮箱地址,多个邮箱地址用英文";"号隔开'>
              </el-input>
            </el-form-item>
          </div>
        </el-collapse-item>
