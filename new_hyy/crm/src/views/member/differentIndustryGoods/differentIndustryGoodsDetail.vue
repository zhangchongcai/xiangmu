<template>
  <div class="_different-industry-goods-detail">
      ...
      <el-collapse-item title="商品信息" name="1">
        <div class="card-type-basic-info">
          <div class="basic-info-item item-left">
            ...
            <div class="item-inner"><label class="lable-name">商品类型：</label>{{detailData.goodsTypeName | emptyShow}}
            </div>
    ...
    <div class="detail-btn-wrap">
      <el-button v-if="detailData.status == 'not_on'" class="_el-btn-custom _member-add-edit-save-btn" type="primary" @click="handleStarted">上架</el-button>
