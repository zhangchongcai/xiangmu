  ...
  <div class="commodityListReport">
    ...
    <div class="member-list-table _m-member-table-custom">
      <el-table :data="tableData" stripe style="width: 100%" :empty-text="tipMessage">
        ...
        <el-table-column prop="totalAmount" :formatter="emptyShow" label="总量" min-width="120" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="inventoryNum" :formatter="emptyShow" label="剩余" min-width="120" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="saleVolume" :formatter="emptyShow" label="发售量" min-width="120" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="writeOffNum" :formatter="emptyShow" label="已核销" min-width="120" show-overflow-tooltip>
        </el-table-column>
      </el-table>
    </div>
    <!-- 分页 start -->
