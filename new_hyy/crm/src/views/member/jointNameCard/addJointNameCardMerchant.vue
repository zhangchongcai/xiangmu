<template>
  <div class="add-jointNameCard-merchant">
    <!-- 表单区 -->
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" size="medium" label-width="100px" label-position="left" class="add-joint-name-card-form">
      ...
      <el-form-item label="合作时间：" prop="cooperationTime" class="cooperation-time">
        <el-date-picker style="width:360px" v-model="cooperationTime" type="daterange" align="right" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd">
        </el-date-picker>
      </el-form-item>
