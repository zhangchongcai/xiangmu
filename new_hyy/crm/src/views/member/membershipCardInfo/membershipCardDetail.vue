      ...
      <el-collapse-item title="交易记录" name="1">
        ...
        <div class="_m-member-table-custom">
          <el-table :data="tableDataList" stripe style="width: 100%" v-loading="listLoading" element-loading-text="拼命加载中...">
            ...
            <el-table-column prop="transactionTime" label="时间" min-width="120" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="outOrderNo" label="订单号" min-width="140" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="flowNo" label="会员交易流水" min-width="140" :formatter="formateEmpty" show-overflow-tooltip>
            </el-table-column>
            ...
            <el-table-column prop="totalBalance" label="余额" min-width="100" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
