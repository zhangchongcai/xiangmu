    ...
    <div class="_member-label-level-wrap">
      ...
      <div class="_member-item-iinner">
        ...
        <div class="_label-item-wrap" v-else>
          <div class="_member-label-item" :style="`border-color:${item.labelColor}`" v-for="(item, index) of information.labelVOS" :key="index">
        ...
        <div class="_member-level-rights-wrap">
          ...
          <ul class="_member-level-rights-items-wrap" v-if="levelData.levelEquitys.length>0">
            <li class="_member-level-rights-item" v-for="(item,index) of levelData.levelEquitys" :key="index">
              <img :src="item.equity.logoPic" :alt="index" @click="handlePreviewEquity(item.equity.id)">
      ...
      <el-collapse-item title="未使用优惠券" name="1">
        <div class="_m-member-table-custom" style="margin-left:20px;">
          <el-table :data="information.couponList" stripe style="width: 100%">
            ...
            <el-table-column prop="couponName" label="券名称" min-width="250" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="couponNo" label="券码" min-width="250" :formatter="formateEmpty" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="createTime" label="获得时间" min-width="250" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="endTime" label="过期时间" min-width="250" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
          </el-table>
        </div>
      </el-collapse-item>
      <!-- 持有卡信息 -->
      <el-collapse-item title="持有卡信息" name="2">
        <el-row style="width:100%;padding-left: 20px;">
          <div v-if="information.cardList=='' || information.cardList==null" style="text-align: center;color: #909399;">
            暂无持有卡信息</div>
          <el-col class="card-item-wrap" style="margin-bottom:20px" v-for="(item,index) in information.cardList?information.cardList:[]" :key="index">
      ...
      <el-collapse-item title="历史账单明细" name="3">
        ...
        <div class="historical-bill-table _m-member-table-custom">
          <el-table :data="consumptionList" stripe style="width: 100%" v-if="type=='CONSUME'">
            ...
            <el-table-column prop="businessName" label="交易类型" min-width="80" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="cardNo" label="会员卡号" min-width="110" :formatter="formateEmpty" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="transactionTime" label="时间" min-width="130" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="outOrderNo" label="订单号" min-width="240" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="flowNo" label="会员交易流水" min-width="130" :formatter="formateEmpty" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="cinemaName" label="门店" min-width="100" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="amount" label="消费总金额(元)" min-width="110" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="basicAmount" label="实收金额(元)" min-width="95" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="channelName" label="交易渠道" min-width="95" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
          </el-table>
          <!-- 储值 -->
          <el-table :data="consumptionList" stripe style="width: 100%" v-if="type=='CHARGE'">
            ...
            <el-table-column prop="cinemaName" label="门店" min-width="120" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="basicAmount" label="充值金额(元)" min-width="95" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="giveAmount" label="奖励金额(元)" min-width="95" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="channelName" label="交易渠道" min-width="95" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <!-- <el-table-column
              prop="modifyBy"
              label="操作人"
          ...
          <el-table :data="consumptionList" stripe style="width: 100%" v-if="type=='INTEGRAL'">
            <template slot="empty">{{tipMessage}}</template>
            <el-table-column prop="flowNo" label="积分流水号" min-width="120" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="transactionTime" label="交易时间" min-width="140" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="integral" label="积分数量" min-width="100" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="integralType" label="积分交易类型" key="integralType" min-width="110" :formatter="formateEmpty" show-overflow-tooltip>
            ...
            <el-table-column prop="cinemaName" label="交易影院" min-width="110" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
            <el-table-column prop="operator" label="操作人" min-width="100" :formatter="formateEmpty" show-overflow-tooltip></el-table-column>
          </el-table>
        </div>
        <!-- 分页 start -->
        <div class="page-wrap">
          <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="current-0" :page-size="size-0" layout="total, sizes, prev, pager, next, jumper" :page-sizes="[20 , 50 , 100]" :total="total-0"></el-pagination>
        </div>
        <!-- 分页 end -->
      </el-collapse-item>
    </el-collapse>
