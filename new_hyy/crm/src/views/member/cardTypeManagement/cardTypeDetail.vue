<template>
  <div class="card-type-detail">
    ...
    <el-collapse v-model="activeNames" class="card-type-detail-content">
      <el-collapse-item title="基础设置" name="1">
        <div class="card-type-basic-info">
          <div class="basic-info-item item-left">
            ...
            <div class="item-inner" v-if="detailData.cardTypeCode != 'cobranded_card'" style="display: flex;align-items: flex-start;"><label class="lable-name">卡样式：</label>
      ...
      <el-collapse-item title="开卡/充值设置" name="2">
        <div class="open-card-recharge-set" v-if="detailData.cardTypeCode == 'stored_card'">
          <div class="basic-info-item item-left">
            <div class="item-inner"><label class="lable-name">开卡必填：</label>{{detailData.mustFillName?detailData.mustFillName.split(',').join('、'):''}}
            </div>
        ...
        <!-- 次卡、礼品卡、包月卡 -->
        <div class="open-card-recharge-set" v-if="detailData.cardTypeCode == 'times_card' || detailData.cardTypeCode == 'gift_card' || detailData.cardTypeCode == 'month_card'">
          <div class="basic-info-item">
            <div class="item-inner"><label class="lable-name">开卡必填：</label>{{detailData.mustFillName?detailData.mustFillName.split(',').join('、'):''}}
            </div>
            <div class="item-inner"><label class="lable-name">简单密码：</label>{{detailData.weakPasswordName}}</div>
            <div class="item-inner"><label class="lable-name">卡面值：</label>{{detailData.cardProductExtVO.cardValue | emptyShow}}元</div>
            <div class="item-inner" v-if="detailData.cardTypeCode == 'times_card'"><label class="lable-name">可观影总票数：</label>{{detailData.cardProductExtVO.watchTickets | emptyShow}}张</div>
            <div class="item-inner" v-if="detailData.cardTypeCode == 'times_card' || detailData.cardTypeCode == 'month_card'"><label class="lable-name">开卡手续费：</label>{{detailData.openPrice | emptyShow}}元</div>
            <div class="item-inner" v-if="detailData.cardTypeCode == 'times_card' || detailData.cardTypeCode == 'month_card'"><label class="lable-name">补卡手续费：</label>{{detailData.makeUpPrice | emptyShow}}元</div>
      ...
      <el-collapse-item title="会员卡规则" name="3">
        <div class="card-rule">
          <div class="basic-info-item _card-rule-channel">
            <!-- 可售渠道 -->
            <div class="item-inner" v-if="detailData.cardTypeCode != 'cobranded_card'"><label class="lable-name">可售渠道：</label>{{detailData.channelList |
            ...
            <div v-else-if="detailData.cardTypeCode == 'gift_card'">
              ...
              <div class="item-inner"><label class="lable-name">是否可与优惠券同时使用：</label>{{detailData.cardProductExtVO.isWithCoupon | formatIsWithCoupon}}
              </div>
            </div>
    ...
    <div class="detail-btn-wrap">
      <el-button v-if="detailData.status == 'unstart'?true:false" class="_el-btn-custom _member-add-edit-save-btn" type="primary" @click="handleStarted">启用</el-button>
