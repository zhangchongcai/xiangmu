      ...
      <el-collapse v-model="activeNames" class="card-type-content">
        ...
        <el-collapse-item title="基础设置" name="1">
          <div class="card-type-basic-set">
            ...
            <el-form-item label="卡类型：" prop="cardTypeCode">
              <el-radio-group v-model="ruleForm.cardTypeCode" :disabled="$route.query.cardId?true:false" @change="handleChangeCardType($event,'ruleForm')">
            ...
            <el-form-item label="卡样式：" prop="cardStyle" v-if="ruleForm.cardTypeCode != 'cobranded_card'">
              <el-radio-group v-model="cardStyle" class="card-style-wrap" @change="handleChangeCardStyle">
                ...
                <div class="custom_card-item">
                  ...
                  <div v-if="ruleForm.custom" style="display:flex;flex-wrap:wrap">
                    <img v-if="ruleForm.picPath" :src="ruleForm.picPath" alt="custom_card" class="custom-card">
                    <el-upload :action="this.$store.state.default.apiConfig.baseURL+this.$store.state.crm.imgAction" list-type="picture-card" :show-file-list="false" accept="image/png" :before-upload="beforeAvatarUpload" :on-success="imgUploaded" :multiple="false" name="file" :data="{type:'product_picture'}" :headers="uploadHeaders">
        ...
        <el-collapse-item title="开卡/充值设置" name="2">
          <div class="open-card-recharge-set">
            ...
            <!-- 礼品卡 次卡 包月卡公用 start1  -->
            <div v-if="ruleForm.cardTypeCode == 'gift_card' || ruleForm.cardTypeCode == 'times_card' || ruleForm.cardTypeCode == 'month_card'">
            ...
            <div v-if="ruleForm.cardTypeCode != 'equity_card' && ruleForm.cardTypeCode != 'cobranded_card' && ruleForm.cardTypeCode != 'gift_card'">
            ...
            <!-- 储值卡 次卡 包月卡公用 start1  -->
            <div v-if="ruleForm.cardTypeCode == 'stored_card' || ruleForm.cardTypeCode == 'times_card' || ruleForm.cardTypeCode == 'month_card'">
              ...
              <div v-if="ruleForm.annualFee" class="checked-fee-wrap">
                ...
                <el-form-item label="免年费机制：" prop="yearRule.freeAnnualFee" class="freeAnnual-fee">
                  <el-radio-group v-model="ruleForm.yearRule.freeAnnualFee" @change="handleChangeFreeAnnualFee">
                    ...
                    <el-input :value="ruleForm.yearRule.freeAnnualFee == 'total_ticket'?ruleForm.yearRule.freeAnnualNum:''" @input="changeAnnualNum($event)" :disabled="ruleForm.yearRule.freeAnnualFee != 'total_ticket'" placeholder="购票次数" style="width:105px;margin-right:5px;"></el-input>
                    <span class="unit">次</span>
                    <el-radio label="total_consume" style="width:50px;margin-left:20px;">累计消费</el-radio>
                    <el-input :value="ruleForm.yearRule.freeAnnualFee == 'total_consume'?ruleForm.yearRule.freeAnnualNum:''" @input="changeAnnualNum($event)" :disabled="ruleForm.yearRule.freeAnnualFee != 'total_consume'" placeholder="消费金额" style="width:105px;margin-right:5px;"></el-input>
                    <span class="unit">元</span>
                  </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="扣年费时间：" prop="yearRule.deductionsType" class="deductions-type">
                  <el-radio-group v-model="ruleForm.yearRule.deductionsType" @change="handleChangeDeductionsType">
                    ...
                    <el-date-picker :value="ruleForm.yearRule.deductionsType == 'fixed_date'?ruleForm.yearRule.deductionsTime:''" format="MM-dd" value-format="MM-dd" type="date" @input="changeDate" :disabled="ruleForm.yearRule.deductionsType != 'fixed_date'" placeholder="选择日期" style="width:115px;">
                    </el-date-picker>
                    <el-radio label="dynamic_time" style="width:50px;margin-left:20px;">动态日期</el-radio>
                    <el-input :value="ruleForm.yearRule.deductionsType == 'dynamic_time'?ruleForm.yearRule.deductionsTime:''" @input="changeDate($event)" :disabled="ruleForm.yearRule.deductionsType != 'dynamic_time'" placeholder="天数" style="width:115px;margin-right:5px;"></el-input>
            ...
            <!-- 联名卡 end -->
            <!-- 权益卡和 联名卡的延期设置 start-->
            <el-form-item v-if="ruleForm.cardTypeCode == 'equity_card' || ruleForm.cardTypeCode == 'cobranded_card'" label="延期设置：" prop="delayPrice" class="_delay-set">
        ...
        <el-collapse-item title="会员卡规则" name="3">
          <div class="card-rule">
            ...
            <!-- 储值卡允许补现、积分规则 -->
            <div v-if="ruleForm.cardTypeCode == 'stored_card'">
              <el-form-item label="余额不足：" class="balance-insufficient" prop="withCash" :rules="[{ required: true, message: ' ', trigger: 'blur' }]">
            ...
            <div v-if="ruleForm.cardTypeCode == 'gift_card'">
              <el-form-item label="有效期：" class="gift-card-validity-wrap" prop="cardProductExtVO.validTimeType">
                <div>
                  ...
                  <el-date-picker style="width:360px" v-model="giftCardValidity" :disabled="!(ruleForm.cardProductExtVO.validTimeType == 'fixed')" align="right" unlink-panels clearable range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" type="daterange" value-format="yyyy-MM-dd"></el-date-picker>
                </div>
                <div>
                  <el-radio style="width:96px;" v-model="ruleForm.cardProductExtVO.validTimeType" label="custom">自定义有效期
                  </el-radio>
                  <el-input @input="changeTimeNum" :value="ruleForm.cardProductExtVO.validTimeType == 'custom'?ruleForm.cardProductExtVO.customTimeNum:''" placeholder="请输入天数" :disabled="!(ruleForm.cardProductExtVO.validTimeType == 'custom')" size="medium">
                  </el-input>
              ...
              <el-form-item label="是否可与优惠券同时使用：" prop="cardProductExtVO.isWithCoupon" :rules="[{ required: true, message: ' ', trigger: 'blur' }]">
            ...
            <div v-if="ruleForm.cardTypeCode == 'times_card' || ruleForm.cardTypeCode == 'month_card'">
              <el-form-item label="有效期：" class="gift-card-validity-wrap" prop="cardProductExtVO.validTimeType">
                <div>
                  ...
                  <el-select v-model="selectedMonth" placeholder="请选择" :disabled="!(ruleForm.cardProductExtVO.validTimeType == 'fixed')">
              ...
              <div v-if="ruleForm.cardTypeCode == 'month_card'">
                <el-form-item label="有效期内观影次数：" class="gift-card-validity-wrap" prop="cardProductExtVO.watchTimesIntime">
                  <div>
                  ...
                  <div>
                    ...
                    <el-input @input="changeWatchTimes" :value="watchTimesType == '1'?ruleForm.cardProductExtVO.watchTimesIntime:''" placeholder="请填写数字" :disabled="!(watchTimesType == '1')" size="medium">
                    </el-input>
                    <span class="unit">次</span>
                  </div>
                </el-form-item>
                <el-form-item label="购票限制：" class="month-card-validity-wrap" prop="cardProductExtVO.ticketLimitDay">
                  <div>
                    ...
                    <el-input @input="changeTicketLimit($event,'day')" :value="dayBuyTicketLimit?ruleForm.cardProductExtVO.ticketLimitDay:''" placeholder="请填写数字" :disabled="!(dayBuyTicketLimit)" size="medium">
                    </el-input>
                    <span class="unit">张</span>
                  </div>
                </el-form-item>
                <el-form-item label="" class="month-card-validity-wrap" prop="cardProductExtVO.ticketLimitWeek">
                  <div>
                    ...
                    <el-input @input="changeTicketLimit($event,'week')" :value="weekBuyTicketLimit?ruleForm.cardProductExtVO.ticketLimitWeek:''" placeholder="请填写数字" :disabled="!(weekBuyTicketLimit)" size="medium">
                    </el-input>
                    <span class="unit">张</span>
                  </div>
                </el-form-item>
                <el-form-item label="" class="month-card-validity-wrap" prop="cardProductExtVO.ticketLimitMonth">
                  <div>
                    ...
                    <el-input @input="changeTicketLimit($event,'month')" :value="monthBuyTicketLimit?ruleForm.cardProductExtVO.ticketLimitMonth:''" placeholder="请填写数字" :disabled="!(monthBuyTicketLimit)" size="medium">
                    </el-input>
                    <span class="unit">张</span>
                  </div>
                </el-form-item>
    ...
    <el-dialog title="自有权益" class="__equity-dialog" :visible.sync="equityDialog" width="896px">
      <div class="__table-wrap">
        <el-form :inline="true" :model="formData" ref="formData" class="__dialog-table-form">
          ...
          <el-form-item label="权益类别" prop="equityCategory" class="heightBug" v-if="ruleForm.cardTypeCode != 'times_card'">
            <el-select v-model="formData.equityCategory" placeholder="全部" clearable :disabled="formData.equityType != 'consumer_type'" @clear="handleClearCategory">
        ...
        <div class="__equity-dialog-content-wrap">
          <div class="__equity-dialog-content-left">
            ...
            <div class="page-wrap _equity-dialog-paginatioin">
              <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="formData.current-0" :page-size="formData.size-0" layout="total, prev, pager, next, jumper" :page-sizes="[20 , 50 , 100]" :total="total-0">
              </el-pagination>
            </div>
            <!-- 分页 end -->
          </div>
      ...
      <div class="__table-wrap">
        <el-form :inline="true" :model="searchData" ref="searchData" class="__dialog-table-form">
          <el-form-item label="商户编号" prop="merchantNum" :rules="[{ max: 20, message: '长度不可超过20个字符', trigger: 'blur' }]">
            <el-input v-model="searchData.merchantNum" @blur="()=>{searchData.merchantNum = searchData.merchantNum.trim()}" placeholder="请输入商户编号" clearable>
            </el-input>
          </el-form-item>
        ...
        <!-- 分页 start -->
        <div class="page-wrap _equity-dialog-paginatioin">
          <el-pagination background @size-change="handleMerchantSizeChange" @current-change="handleMerchantCurrentChange" :current-page="searchData.current-0" :page-size="searchData.size-0" layout="prev, pager, next, jumper, sizes" :page-sizes="[20 , 50 , 100]" :total="merchantTotal-0"></el-pagination>
        </div>
        <!-- 分页 end -->
      </div>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="handleChangeMerchantDialog(true)" class="_el-btn-custom _member-add-edit-save-btn">确定</el-button>
    ...
    submitForm (formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          } else if (this.ruleForm.cardTypeCode == 'times_card') {
            let equityArr = this.ruleForm.equityList;
            function checkTimeCard (item) {
              return item.equityCategory == 'time_card';
            }
            function checkMovie (item) {
              return item.equityCategory == 'movie';
            }
            if (equityArr.find(checkTimeCard) && !equityArr.find(checkMovie)) {
              this.checkEquity();
            } else if (
              equityArr.find(checkTimeCard) &&
              equityArr.find(checkMovie)
            ) {
              this.$message.warning('所选权益中不可含有影票折扣权益');
              return false;
            } else {
              this.$message.warning('请至少选择一项次卡权益');
              return false;
            }
          } else {
            this.checkEquity();
