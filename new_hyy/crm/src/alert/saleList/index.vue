<template>
  <div>
    <el-dialog :title="dialog.title" :visible.sync="dialog.visible" :width="dialog.width" :close-on-click-modal="false" style="margin-top:5vh">
      <!-- 搜索栏 -->
...
export default {
  ...
  methods: {
     ...
     */
    setParams (params) {
      params = params || this.searchConfig.param;
     ...
     */
    getData (params) {
      this.$crmList.alertSaleList(params).then(data => {
        let type = 'warning';
