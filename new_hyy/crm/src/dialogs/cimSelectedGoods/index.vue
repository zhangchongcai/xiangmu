<template>
  <el-dialog id="cim-good-select-dialog" class="retail-style cim-dialog-btn" width="1065px" :title="title" :visible="dialogVisible" @close="closeCallBack" @open="openCallBack">
    <div>
      <el-row>
        <el-col :span="5">
          ...
          <div class="query-box">
            <el-form :inline="true" :model="queryData" label-position="right" label-suffix=":">
              ...
              <div>
                ...
                <el-button class="search query-btn" type="primary" @click="onQuery">搜索</el-button>
              </div>
            </el-form>
          </div>
          <div>
              ...
              <el-col :span="19">
                <div class="table-box">
                  <el-table ref="materialTable" :data="tableData" height="450" v-loading="tableLoding" :row-key="getRowKey" @selection-change="handleSelectionMaterial">
                    <el-table-column type="selection" width="40" reserve-selection :selectable="isDisabled"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    goodsDataQueryGoodsList (param, type) {
      ...
      this.$crmList.goodsDataQueryGoodsList(param)
        .then(res => {
    ...
    goodsDataQueryCinemaGoodsList (param, type) {
      this.tableLoding = true;
      this.$crmList.goodsDataQueryCinemaGoodsList(param)
        .then(res => {
          this.reqCallBack(res, type);
        })
        .catch(err => {
