          ...
          <div class="__crm-available-coupon-dialog-content-left">
            <div class="__crm-available-coupon-dialog-table _m-member-table-custom">
              <el-table ref="multipleTable" :empty-text="tipMessage" :data="tableData" stripe style="width: 100%" @select="handleSelect" @select-all="handleSelect" :row-key="getRowKeys">
                ...
                <el-table-column prop="applyCode" :formatter="emptyShow" label="票券申请单号" min-width="110" show-overflow-tooltip></el-table-column>
                <el-table-column prop="couponName" :formatter="emptyShow" label="票券名称" min-width="110" show-overflow-tooltip></el-table-column>
                <el-table-column prop="stateRemark" :formatter="emptyShow" label="票券申请单状态" min-width="110" show-overflow-tooltip></el-table-column>
              </el-table>
              <!-- 分页 start -->
