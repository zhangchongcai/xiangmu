    ...
    children: [
      {
        ...
        component: resolve =>
          require(['../views/member/test/test2.vue'], resolve),
        name: '会员测试页面'
      }
    ]
  },
    ...
    children: [
      {
        ...
        component: resolve =>
          require(['../views/member/memberTags/memberTagsList.vue'], resolve),
        name: '会员标签列表'
      },
      {
        path: 'add',
        ...
        component: resolve =>
          require(['../views/member/memberTags/addMemberTags.vue'], resolve),
        name: '添加会员标签'
      },
      {
        path: 'edit',
      ...
      },
      {
        ...
        component: resolve =>
          require(['../views/member/memberTags/msgDetailList.vue'], resolve),
        name: '短信发送详情'
      }
    ]
  },
    ...
    children: [
      {
        ...
        component: resolve =>
          require([
            '../views/member/otherCommodity/creatCommodityType.vue'
          ], resolve),
        name: '创建商品类型'
      },
      {
      ...
      },
      {
        ...
        component: resolve =>
          require([
            '../views/member/otherCommodity/commodityTypeDetail.vue'
          ], resolve),
        name: '商品类型详情'
      },
      {
        ...
        component: resolve =>
          require([
            '../views/member/otherCommodity/commodityTypeList.vue'
          ], resolve),
        name: '商品类型列表'
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: resolve =>
          require([
            '../views/member/otherRights/otherRightsDetail.vue'
          ], resolve),
        name: '异业权益详情'
      }
    ]
    ...
    children: [
      {
        ...
        component: resolve =>
          require(['../views/member/cardTypeManagement/cardList.vue'], resolve),
        name: '会员卡政策列表'
      },
      {
        path: 'detail',
