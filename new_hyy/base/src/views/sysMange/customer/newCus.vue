      ...
      <div class="customer">
        <el-form :model="ruleForm" :rules="rules" label-width="110px" ref="ruleForm">
          ...
          <el-form-item label="所属城市：" v-if="$route.query.type!=3" style="height:34px">
            <el-col :span="4">
              <el-form-item prop="provinceCode">
                <el-select filterable v-model="ruleForm.provinceCode" @change="chooseProvince" placeholder="省级地区">
            ...
            <el-col :span="4">
              <el-form-item prop="cityCode">
                <el-select filterable v-model="ruleForm.cityCode" @change="chooseCity" placeholder="市级地区">
            ...
            <el-col :span="4">
              <el-form-item prop="areaCode">
                <el-select filterable v-model="ruleForm.areaCode" @change="chooseArea" placeholder="区级地区">
          ...
          <el-form-item label="所属城市：" prop="area" v-else>
            <el-input v-model="ruleForm.area" :disabled="flag" type="textarea" :autosize="{ minRows: 1, maxRows: 2}"></el-input>
          </el-form-item>
          <el-form-item prop="remark" label="备注：" style="clear: both">
            <el-input :disabled="flag" type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容" v-model="ruleForm.remark">
            </el-input>
          </el-form-item>
          ...
          <div class="people" style="margin-bottom: 24px;margin-left: 98px">
            <el-table :data="tableData" style="width: 100%;">
              ...
              <el-table-column v-if="$route.query.type!=3" prop="address" label="操作" width="120">
...
import { addCus, cusDetail, editCus, typeList, checkFullName, checkName, checkSocial, provinceData, areaData, checkCode } from 'baseSrc/http/interface.js';
export default {
  name: 'newCus',
