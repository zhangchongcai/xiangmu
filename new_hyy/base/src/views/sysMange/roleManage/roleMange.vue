      ...
      <div class="table">
        <el-table :data="rolelist" border>
          ...
          <el-table-column label="操作" width="180" fixed="right">
            <template slot-scope="scope">
              <el-button v-auth="'system_roleManage_see'" class="table-btn-mini" @click="handleClick(scope.row)" type="text">查看</el-button>
              <el-button v-auth="'system_roleManage_update'" class="table-btn-mini" @click="handleEdit(scope.row)" type="text">编辑</el-button>
              ...
              <!--</span>-->
              <el-button class="table-btn-mini" @click="changeStatus(scope.row)" type="text" v-auth="'system_roleManage_enableDisabling'">
...
<script>
import { roleList, useRole } from 'baseSrc/http/interface.js';
