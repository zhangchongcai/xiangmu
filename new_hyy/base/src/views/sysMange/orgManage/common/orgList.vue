  ...
  <div class="org-list-wrap">
    <div class="modal-search">
      <div class="org-left">
        ...
        <div class="org-sys">
          <el-tree @node-click="handleNodeClick" :filter-node-method="filterNode" :data="dataTree" node-key="id" ref="tree" highlight-current default-expand-all :expand-on-click-node="false" :props="defaultProps">
          </el-tree>
        </div>
      </div>
    </div>
...
<script>
import { organizationList, listOrganizationCinema, cinemaBinding } from 'baseSrc/http/interface.js';
