  ...
  <div class="role-list-wrap-1">
    <div class="modal-search">
      <div class="search-wrap ">
        <span>上级组织：</span>
        <el-input v-model.trim="parentOrgData.label" placeholder="请输入内容" disabled></el-input>
      </div>
      <div class="search-wrap plian">
        <span>组织名称：</span>
        <template>
          <el-input v-model.trim="lastOrgData.text" placeholder="请输入内容" clearable></el-input>
...
<script>
import { listOrganizationCinema, cinemaBinding, addOrg, editOrg } from 'baseSrc/http/interface.js'
  ;
export default {
  name: 'addOrg',
  data () {
