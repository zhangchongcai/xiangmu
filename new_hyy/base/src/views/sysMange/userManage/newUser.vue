<template>
    <div class="content-wrapper">
        <div class="list-wrapper">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="94px" style="margin-top: 1px">
                ...
                <el-form-item label="所属角色：" prop="rolesName">
                    ...
                    <el-button type="primary" @click='getTree(1)' plain
                               style="top: 6px;left: 365px;position: absolute;">
                        选择
                    </el-button>
                </el-form-item>
                <el-form-item label="所属组织：" prop="orgName">
                    ...
                    <el-button type="primary" @click='getTree(2)' plain
                               style="top: 6px;left: 365px;position: absolute;">
                        选择
                    </el-button>
                </el-form-item>
                <el-form-item label="数据权限：" prop="deptName">
                    ...
                    <el-button type="primary" @click='getTree(3)' plain
                               style="top: 6px;left: 365px;position: absolute;">
                        选择
                    </el-button>
                </el-form-item>
        ...
        <div class="diaWindow targetTable">
            <el-dialog v-bind="$attrs" v-on="$listeners" :title="title" :visible.sync="dialogVisible" width="892px"
...
<script>
  ...
  import {addUser, orgList, roleTree, deptTree, attributeType} from 'baseSrc/http/interface.js'
  ...
  export default {
    ...
    methods: {
      ...
      ok() {
        ...
        this.selectData = this.removeData = []
      },
      cancel(val) {
        switch (val) {
          case 1:
      ...
      rowOneRemove(row) {
        for (let index = 0; index < this.multipleSelection.length; index++) {
          if (row.uid == this.multipleSelection[index].uid) {
            this.removeData.push(this.multipleSelection[index])
            this.multipleSelection.splice(index, 1);
            return;
          }
        }
