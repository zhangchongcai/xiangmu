  ...
  <div class="content-wrapper">
    <el-form :model="ruleForm" ref="ruleForm" label-width="90px" style="margin-top: 1px">
      ...
      <el-form-item label="所属角色" prop="rolesId">
        <el-input placeholder="请点击右侧选择" type="textarea" disabled autosize v-model="ruleForm.rolesName">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="数据权限" prop="deptName">
        <el-input type="textarea" disabled autosize v-model="ruleForm.deptName">
        </el-input>
      </el-form-item>
...
<script>
import { onlyUser, attributeType } from 'baseSrc/http/interface.js';
export default {
  name: 'userDetail',
  data () {
    return {
