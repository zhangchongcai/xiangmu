<template>
  <div class="page-wrapper">
    ...
    <div>
      ...
      <el-tag>{{reviewFilmDataSingle}}</el-tag>
      <span class="table-btn-mini" @click="chooseFilm(2,1)">编辑影院多选2</span>
      <div>
        <el-tag size="small" v-for="tag in reviewFilmDataMulti" :key="tag.id" closable :type="tag.type">{{tag.name}}</el-tag>
      </div>
    </div>
    ...
    <framemultiFilmBase :innerData="paramsFilmDataMulti" :reviewData="reviewFilmDataMulti" :whereUse="mainPageUnique" @frameFilmBaseMultiCallBack="handleCallBack" ref='frameMultiFilm'>
    </framemultiFilmBase>
    <!-- <div slot="footerId">
    ...
    <frameSingleFilmBase :reviewData="reviewFilmDataSingle" :innerData="paramsFilmDataSingle" :whereUse="mainPageUnique" @frameFilmBaseSingleCallBack="frameSingleFilmBaseCallBack" ref='frameSingleFilm'>
    </frameSingleFilmBase>
    <!-- <div slot="footerId">
...
import frameSingleFilmBase from 'baseSrc/dialogs/film/singleBase';
import framemultiFilmBase from 'baseSrc/dialogs/film/multiBase';
export default {
  name: 'userList',
  components: {
    frameSingleFilmBase,
  ...
  methods: {
    ...
    chooseFilm () {
      ...
      // this.paramsFilmDataMulti = this.selectedCinemas2
      // this.reviewFilmDataMulti = this.reviewFilmDataMulti
      let abc = this.reviewFilmDataMulti;
      console.log(abc);
      console.log(this.reviewFilmDataMulti);
    ...
    */
    handleCallBack (opt) {
      this.reviewFilmDataMulti = JSON.parse(JSON.stringify(opt.data));
