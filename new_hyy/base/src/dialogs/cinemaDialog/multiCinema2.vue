  ...
  <div>
    <dialogWarp :dialogVisible="dialogVisible" name="选择影院" @crmDialogOutputFlag="handleCrmDialogFlag">
      ...
      <div class="_crm-card-type-dialog-wrap">
        ...
        <!-- 分页 start -->
        <div class="page-wrap">
          <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="searchAdition.pageNum-0" :page-size="searchAdition.pageSize-0" layout="prev, pager, next, jumper, sizes" :page-sizes="[10, 20 , 50 , 100]" :total="total-0"></el-pagination>
        </div>
        <!-- 分页 end -->
      </div>
    </dialogWarp>
