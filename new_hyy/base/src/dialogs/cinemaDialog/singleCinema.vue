<template>
  <el-dialog :title="dialogTitle" :show-close="true" :visible.sync="framedialogVisible" :before-close="beforeClose" :close-on-click-modal="false" :append-to-body="appendToBody" class="diydialog-filmsingle" width="672px">
    <div class="film-top">
    ...
    <div class="film-body">
      ...
      <div class="page-wrap">
        <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="pageNum" :page-sizes="[10, 25, 50, 100]" :page-size="pageSize" layout="total, prev, pager, next, jumper" :total="total">
        </el-pagination>
      </div>
...
.diydialog-filmsingle {
  ...
  .el-table th.is-leaf:nth-child(4),
