 ...
 */
/** 接口处理示例 */
export const showPersonal = params => {
  return axios({
    url: '/cpm/homeBlock/showHomeBlock',
    method: 'get',
    params
  });
};

export const createPlat = data => {
  // 接口备注
  return axios({
    url: '/cpm/homeBlock/defineHomeBlock',
    method: 'post',
    data
  });
};

export const hidePlat = params => {
  return axios({
    url: '/cpm/homeBlock/listUnShowBlock',
    method: 'get',
    params
  });
};
