<template>
  <div class="tag-nav">
    <scroll-bar ref="scrollBar">
      <router-link @click.native="toBreadCrumb(item)" ref="tag" class="tag-nav-item" :class="isActive(item) ? 'cur' : ''" v-for="(item, index) in tagNavList" :to="{path: item.path, query: item.query,params: item.params}" :key="index">
