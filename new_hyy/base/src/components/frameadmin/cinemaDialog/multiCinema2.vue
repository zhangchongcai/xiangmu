<template>
  <div class="diydialog-multi-cinema">
    <el-dialog title="选择影院" :visible.sync="framedialogVisible" width="70%" :show-close="false" custom-class="usual-dialog">
      <div class="film-top">
...
export default {
  ...
  methods: {
    ...
    confirmData () {
      ...
      // let params={
      //     consumerId:this.innerCinemaMultiData.consumerId,
      //     time:this.innerCinemaMultiData.time,
      ...
      //     console.log(err)
      // })
      let ab = this.multipleSelectionAll;
    ...
    changePageCoreRecordData (val, isDelete) {
      ...
      console.log(this.innerCinemaMultiData);
      if (this.multipleSelectionAll.length <= 0 && this.innerCinemaMultiData.length > 0) {
