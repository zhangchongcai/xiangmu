<template>
  <div class="diydialog">
    <el-dialog title="选择影院" :visible.sync="dialogVisible" width="70%" height="576" :show-close="false" custom-class="usual-dialog">
      <div class="film-top">
...
import { listAuthCommCinemas } from 'baseSrc/http/interface.js';
export default {
  props: {
    dialogVisible: {
      type: Boolean,
