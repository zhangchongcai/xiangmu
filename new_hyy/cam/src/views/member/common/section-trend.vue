<template>
  <div class="section">
    ...
    <div class="section-select flex">
      ...
      <target-label-view ref="labels" :activeType="type" :targetLabel="targetLabel" :otherLabel="otherLabel" @getType="changeType"></target-label-view>
      <div>
    ...
    <div class="section-content">
      <ve-line v-if="isLine" :data="targetLineData" :legend-visible="false" :settings="lineSettings" :extend="lineExtend"></ve-line>
...
<script>
import TargetLabelView from '../../partical/targetLabel';
...
export default {
  ...
  watch: {
    allData () {
      this.type = 'xzhy';
      this.$set(this.targetLineData, 'rows', this.allData['xzhy']);
    }
  },
  methods: {
    changeType (id) {
