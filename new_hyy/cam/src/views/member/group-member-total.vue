...
<template>
  ...
  <div class="sale-content-wrap">
    ...
    <!-- 趋势 -->
    <section-trend :targetLabel="trendTargetLabel" :otherLabel="trendOtherLabel" :targetType="trendFirstLabel" :timeType="timeType" :allData="allTrendData" @getOut="trendExport">
    </section-trend>
    <!-- 类型和渠道 -->
    <section-type-channel :type="orgType" :targetLabel="channelTargetLabel" :otherLabel="channelOtherLabel" :targetType="channelFirstLabel" :allData="allChannelData">
    </section-type-channel>
    <!-- 详情 -->
    <section-detail :timeType="timeType" :type="orgType" :allData="detailData" @getOut="detailExport" @getData="getDetail" @go="goDetail">
