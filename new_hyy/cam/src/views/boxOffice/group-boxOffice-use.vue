    ...
    <div class="header-fixed" ref="headerFixed">
      ...
      <div class="time-wrap">
        ...
        <div class="time-item">
          ...
          <el-select v-model="cinemaId" placeholder="请选择影院品牌" clearable @change="changeCinema">
            <el-option v-for="(item,index) in cinemaList" :key="index" :label="item.brandName" :value="item.brandCode">
            </el-option>
          </el-select>
        </div>
        <div class="time-item">
    ...
    <div class="section">
      ...
      <div class="flex-wraper">
        <div class="section-item">
          <target-label ref="targetLabel2" :activeType="activeType" :targetLabel="targetLabel2" :otherLabel="otherLabel2" @getType="changeChannelType"></target-label>
          <div style="width:100%">
            <!-- <ve-pie
              :title="channelTitle"
              :data="channelData"
            ...
            <ve-histogram :title="channelTitle1" :data="channelData" :extend="barExtendChannel" :legend-visible="false" :data-empty="channelChartEmpty" v-else></ve-histogram>
          </div>
        </div>
        <div class="section-item">
          <target-label ref="targetLabel1" :activeType="activeType" :targetLabel="targetLabel1" :otherLabel="otherLabel1" @getType="changeMovieType"></target-label>
          <div style="width:100%">
            ...
            <ve-histogram :title="movieTitle1" :data="movieData" :extend="barExtendMovie" :legend-visible="false" :data-empty="movieChartEmpty" v-else></ve-histogram>
          </div>
        </div>
