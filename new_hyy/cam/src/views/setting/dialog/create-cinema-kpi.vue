<template>
  <div class="reset-target-dialog">
    <el-dialog :visible="show" title="影院kpi创建" :before-close="handleClose" :close-on-click-modal="false">
      <div class="content" style="max-height:500px">
        <el-form class="reset-form" ref="kpiRef" label-width="150px" label-position="right" :model="infoData" :rules="rules">
          <el-form-item label="影院名称:" class="reset-form-input" prop="cinemaName">
            <el-autocomplete size="small" class="inline-input" v-model="infoData.cinemaName" :fetch-suggestions="getCinema" placeholder="请输入内容" :trigger-on-focus="false" @select="selectCinema"></el-autocomplete>
          </el-form-item>
          ...
          <el-form-item label="时间选择:" class="reset-form-select" prop="dateKey">
            <el-date-picker size="small" v-model="infoData.dateKey" type="month" placeholder="选择月" value-format="yyyy-MM">
            </el-date-picker>
          </el-form-item>
