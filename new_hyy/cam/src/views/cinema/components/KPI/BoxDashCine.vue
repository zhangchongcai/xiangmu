...
export default {
  ...
  methods: {
    // 票房KPI
    getBoxKpiData (BoxKPIvalueCine) {
      // 取到时间进度
      let tool1 = BoxKPIvalueCine.timeRate ? BoxKPIvalueCine.timeRate : 0, tool2 = BoxKPIvalueCine.boxOfficeRate ? BoxKPIvalueCine.boxOfficeRate : 0;

      // 取值title
      this.BoxRate = BoxKPIvalueCine.boxOfficeMonthToNow;
      this.BoxKPItotal = BoxKPIvalueCine.boxOfficeTarget;
      // 从新复制
      this.gaugeData = {
        columns: ['name', 'value'],
        rows: [
