<template>
  ...
  <div class="section" style="width:100%;height:300px;">
    ...
    <ul class="ulContainer">
      <li>月至今达成 : {{BoxRate | capitalizeOne}}%</li>
      <li>KPI值 : {{BoxKPItotal | capitalizeOne}}%</li>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getBoxKpiData (BoxKPIvalueShare) {
      // 取到时间进度
      let tool1 = BoxKPIvalueShare.timeRate ? BoxKPIvalueShare.timeRate : 0, tool2 = BoxKPIvalueShare.marketShareRate ? BoxKPIvalueShare.marketShareRate : 0;
      // 取值title
