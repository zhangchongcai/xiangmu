  ...
  <div class="BoxContainer">
    ...
    <div class="PerCapita_Content ModuleKPI" v-if="cur==0">
      ...
      <div class="ModuleTitleLayout">
        ...
        <ve-line :data="SelllineData" :legend-visible="false" :settings="lineSettings" :extend="lineExtend"></ve-line>
      </div>
    </div>
    ...
    <div class="Purchase_Content ModuleKPI" v-if="cur==4">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 条形图 -->
        <ve-line :data="ChartsLine" :legend-visible="false" :settings="lineSettings" :extend="lineExtendTwo"></ve-line>
      </div>
    </div>
