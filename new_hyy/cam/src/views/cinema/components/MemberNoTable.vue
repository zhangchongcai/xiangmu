  ...
  <div class="BoxContainer">
    ...
    <div class="right-col">
      <ul class="listUl">
        ...
        <li @click="MeClick('2')" :class="{active:cur==2}">
          <div>会员消费占比</div>
          <div>
            <span class="BebasNeue">{{MemberTop.memberConsumePer || '--'}}</span>%
          </div>
        </li>
    ...
    <div class="membership_Container ModuleKPI" v-if="cur==0">
      ...
      <div class="ModuleTitleLayout">
        ...
        <ve-line :data="MemberLineData" :legend-visible="false" :settings="lineSettings" :extend="lineExtend"></ve-line>
      </div>
    </div>
    ...
    <div class="membership_Container ModuleKPI" v-if="cur==1">
      ...
      <div class="ModuleTitleLayout">
        ...
        <ve-line :data="ChartsAmount" :legend-visible="false" :settings="lineSettings" :extend="lineExtendMoneyTwo"></ve-line>
      </div>
    </div>
    ...
    <div class="membership_Container ModuleKPI" v-if="cur==4">
      ...
      <div class="ModuleTitleLayout">
        ...
        <ve-line :data="ChartsProfit" :legend-visible="false" :settings="lineSettings" :extend="lineExtendMoney"></ve-line>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    goDetail () {
      this.$router.push(
        { path: '/analysis/cinema/member/total',
          query: {
            name: this.cityName,
