  ...
  <div class="SysContent">
    <div class="SysHeader">
      <div class="HeaderTop">
        <div class="flex font">
          <div>
            <span style="margin-right:60px;">影院: <span style="margin-left:16px">{{cityName ? cityName : cityJsonName}}</span></span>
            <span class="font" style="margin-right:16px">选择时间 :</span>
          ...
          <div>数据更新时间:<span style="margin-left:16px"></span>{{updateTime}}</div>
        </div>
        <div class="total">
          <div class="totalLeft">
          ...
          <div class="progress">
            <div class="ProgressBoxCoff">
              ...
              <div class="el-progress">
                <el-progress :stroke-width="10" :percentage="+boxRadio"></el-progress>
              </div>
            </div>
            ...
            <div class="ProgressBoxCoff">
              ...
              <div class="el-progress">
                <el-progress :stroke-width="10" :percentage="+sellRadio" color="#FE825E"></el-progress>
              </div>
            </div>
          </div>
          <div></div>
    ...
    <div class="SysMain">
      <el-row class="el-RowMain" :gutter="15">
        <el-col class="left" :span="8">
          <box-office-no-table ref="BoxOffice" :BoxofficeTop="BoxOffdetail" :chartIncome="ChartQuota" :cityId="cityId" :cityName="cityName || cityJsonName" :memberId="MemberId" :startDate="startTime" :endDate="endTime" :timeType="timeType" :BoxKPIDataCine="BoxKPIDataCine" :BoxKPIDataShare="BoxKPIDataShare" :BoxTotal="BoxTotal"></box-office-no-table>
        </el-col>
        <el-col class="center" :span="8">
          <sell-goods-no-table ref="GoodsSell" :GoodTop="Goodsdetail" :SelllineData="goodsLineData" :cityId="cityId" :cityName="cityName || cityJsonName" :memberId="MemberId" :startDate="startTime" :endDate="endTime" :timeType="timeType" :SellKPIDataCine="SellKPIDataCine" :SellTotal="SellTotal"></sell-goods-no-table>
        </el-col>
        <el-col class="right" :span="8">
          <member-no-table ref="Member" :MemberTop="Memberdetail" :MemberLineData="MemberLineData" :cityId="cityId" :cityName="cityName || cityJsonName" :memberId="MemberId" :startDate="startTime" :endDate="endTime" :timeType="timeType" :MemberKPIDataCine="MemberKPIDataCine" :MemberTotal="MemberTotal"></member-no-table>
        </el-col>
      </el-row>
    </div>
  </div>
      ...
      this.$camList
        ...
        .then(response => {
          ...
          if (res) {
            ...
            this.MemberId = res.cinemaId || this.$route.query.Member;
          }
          // 选取周月年判断
          if (this.timeType !== 'day') {
            // 是周月年时候隐藏KPI
    ...
    getSellLineChart (res) {
      ...
      if (!res.sellGoodsIndex || JSON.stringify(res.sellGoodsIndex) == '{}') {
        ...
        this.goodsLineData.rows = res.sellGoodsIndex.yAxis.map(item => {
          return {
            日期: item.dateKey,
            人均卖品收入: item.sppPrice && item.sppPrice.toFixed(2) || 0
          };
        });
      }
    },
