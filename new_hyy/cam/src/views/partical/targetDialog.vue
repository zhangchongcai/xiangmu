<template>
  ...
  <div class="reset-target-dialog">
    <el-dialog title="指标设置" :visible.sync="show" width="448px" :before-close="handleClose" :close-on-click-modal="false">
      <div class="content">
        <div class="select">
          ...
          <div class="item-wrap">
            ...
            <div class="item-list">
              ...
              <el-checkbox-group v-model="selectList" :max="6">
                <el-checkbox class="item" v-for="(item,index1) in sale" :label="item" :key="index1" :checked="item.userBinding ==1?true:false">
                  <span>{{item.name}}</span>
                </el-checkbox>
              </el-checkbox-group>
            </div>
            ...
            <div class="item-list">
              ...
              <el-checkbox-group v-model="selectList" :max="6">
                <el-checkbox class="item" :label="item" v-for="(item,index2) in profit" :key="index2" :checked="item.userBinding ==1?true:false">
                  <span>{{item.name}}</span>
                </el-checkbox>
              </el-checkbox-group>
            </div>
