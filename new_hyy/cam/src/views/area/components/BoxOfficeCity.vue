  ...
  <div class="BoxContainer">
    ...
    <div class="Boxoffice_Content ModuleKPI" v-if="cur==0">
            ...
            <el-tooltip class="item" effect="dark" placement="right-start">
              <div slot="content" style="width:300px">
                <ul id="ulMain">
                  ...
                  <li>环比前一日 : <span :class="[BoxKPIDataCity.boxOfficeChainDay > 0? 'green':'red']"><i class="iconfont" style="font-size:12px" :class="[BoxKPIDataCity.boxOfficeChainDay > 0? 'icon-neiye-shangshengjiantou':'icon-neiye-xiajiangjiantou']"></i>{{BoxKPIDataCity.boxOfficeChainDay | woo(true)}}%</span></li>
                  <li>月至今达成 : <span>{{BoxKPIDataCity.boxOfficeMonthToNow | capitalizeOne}}{{BoxKPIDataCity.boxOfficeMonthToNow | foo}}</span></li>
                  <li>环比上月 : <span :class="[BoxKPIDataCity.boxOfficeChainMonth > 0? 'green':'red']"><i class="iconfont" style="font-size:12px" :class="[BoxKPIDataCity.boxOfficeChainMonth > 0? 'icon-neiye-shangshengjiantou':'icon-neiye-xiajiangjiantou']"></i>{{BoxKPIDataCity.boxOfficeChainMonth | woo(true)}}%</span></li>
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 饼状图 -->
        <ve-ring width="100%" class="veRing" :data="chartIncome" :settings="categorySettings" :extend="pieExtendTwo" :colors="colors" :data-empty="chartEmpty"></ve-ring>
      </div>
      <!--区域详情 -->
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" border :data="CurrentBoxTableTop" @sort-change='SortChange' :default-sort="{prop: 'showNumCity', order: 'descending'}" ref="table0">
      ...
      <div class="reset-page">
        <el-pagination v-if="this.totalPage>10" background layout="total,prev, pager, next" @current-change="handleCurrentChange" :current-page="this.currentPage" :page-size="this.pageSize" :total="this.totalPage">
        </el-pagination>
    ...
    <div class="Viewing_Content ModuleKPI" v-if="cur==1">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 饼状图 -->
        <ve-ring ref="one" class="veRing" :data="ChartViewing" :settings="categorySettingsPerson" :extend="pieExtend" :colors="colors"></ve-ring>
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNumCity', order: 'descending'}" ref="table1">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="影院名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Average_Content ModuleKPI" v-if="cur==2">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 条形图 -->
        <ve-bar :data="ChartBarfare" :colors="barColors" :extend="barExtendTwo"></ve-bar>
      </div>
      <!--区域详情 -->
      <div class="ModuleTitleLayout CityModuleLayout">
        <div class="ModuleTitle">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNumCity', order: 'descending'}" ref="table2">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="影院名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Attendance_Content ModuleKPI" v-if="cur==3">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNumCity', order: 'descending'}" ref="table3">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="影院名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
  ...
  methods: {
    ...
    getFareChart (res) {
      ...
      if (ChartsDataX && ChartsDataY) {
        let foo = ChartsDataY.map(item => {
          return {
            newName: (item.movieName.length && item.movieName.length) > 8 ? (item.movieName.substr(0, 8) + '...') : (item.movieName),
            name: item.movieName,
