    ...
    <div class="SysMain">
      <el-row class="el-RowMain" :gutter="15">
        <el-col class="left" :span="8">
          <box-office-city ref="BoxOffice" :BoxofficeTop="BoxOffdetail" :BoxTableTop="BoxTable" :chartIncome="ChartQuota" :cityId="cityId" :cityName="cityName || cityJsonName" :BoxKPIDataCity="BoxKPIDataCity" :BoxTotal="BoxTotal" :startDate="startTime" :endDate="endTime" :timeType="timeType" :dateTypeActive='dateTypeActive' :dateTypeIndex="dateTypeIndex" :initBoxPage="initBoxPage">
          </box-office-city>
        </el-col>
        <el-col class="center" :span="8">
          <sell-goods-city ref="GoodsSell" :GoodTop="Goodsdetail" :GoodTableTop="GoodTable" :lineData="goodsLineData" :cityId="cityId" :cityName="cityName || cityJsonName" :SellKPIDataCity="SellKPIDataCity" :SellTotal="SellTotal" :startDate="startTime" :endDate="endTime" :timeType="timeType" :dateTypeActive='dateTypeActive' :dateTypeIndex="dateTypeIndex" :initSellPage="initSellPage"></sell-goods-city>
        </el-col>
        <el-col class="right" :span="8">
          <member-city ref="Member" :MemberTop="Memberdetail" :MemberTableTop="MemberTable" :lineData="memberLineData" :cityId="cityId" :cityName="cityName || cityJsonName" :MemberKPIDataCity="MemberKPIDataCity" :MemberTotal="MemberTotal" :startDate="startTime" :endDate="endTime" :timeType="timeType" :dateTypeActive='dateTypeActive' :dateTypeIndex="dateTypeIndex" :initMemberPage="initMemberPage"></member-city>
        </el-col>
      </el-row>
    </div>
  </div>
