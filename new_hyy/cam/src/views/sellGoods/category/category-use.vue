  ...
  <div class="category-content-wrap">
    ...
    <div class="section">
      ...
      <div class="section-content">
        <TreeGrid :columns="columns" :tree-structure="true" :default-expand-all="false" @tableSortChange="tableSortChange" :default-sort="{prop: 'salesVolume', order: 'descending'}" :data-source="dataSource">
