...
<template>
  <div class="sale-content-wrap">
    ...
    <section-target :targetArr="targetArr" :timeType="timeType" @showTargetSetting="showTargetSetting"></section-target>
    <section-trend :allData="allTrendData" @getOut="trendExport"></section-trend>
    <section-detail ref="detail" :orgType="orgType" :tableData="tableData" @showCompar="showCompar" @getTableData="getTableData" @getOut="detailExport" @goDetail="goDetail">
      <div class="reset-page">
        <el-pagination size="mini" v-if="total>15" layout="total,sizes,prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="page" :page-sizes="sizes" :page-size="size" :total="total">
        </el-pagination>
