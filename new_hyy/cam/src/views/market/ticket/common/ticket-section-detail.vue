  ...
  <div class="section">
    ...
    <div class="section-content">
      ...
      <div class="reset-table mt10 flex" style="position:relative">
        <el-table border ref=refTable :height="height" :data="tableData" @selection-change='changeSelect' @sort-change="sortChange">
        ...
        <div v-if="isCompar" class="computed-wrap">
          ...
          <div class="content">
            <target-label :activeType="targetType" :targetLabel="trendTargetLabel" :otherLabel="trendOtherLabel" @getType="changeType">
            </target-label>
            <ve-line :colors="colors" :data="lineData" :extend="lineExtend" :settings="lineSettings">
            </ve-line>
          </div>
        </div>
      </div>
