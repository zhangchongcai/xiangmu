<template>
  <div class="section">
    ...
    <div class="section-select flex">
      ...
      <target-label :activeType="targetType" :targetLabel="trendTargetLabel" :otherLabel="trendOtherLabel" @getType="changeType"></target-label>
      <div>
    ...
    <div class="section-content">
      <ve-line v-if="isLine" :data="lineData" :legend-visible="false" :settings="lineSettings" :extend="lineExtend">
      </ve-line>
      <!-- 趋势表格下载 -->
