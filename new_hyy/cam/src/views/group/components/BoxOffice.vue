  ...
  <div class="BoxContainer">
    ...
    <div class="Boxoffice_Content" v-if="cur==0">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" border :data="CurrentBoxTableTop" @sort-change='SortChange' :default-sort="{prop: 'showNum', order: 'descending'}" ref="table0">
    ...
    <div class="Viewing_Content ModuleKPI" v-if="cur==1">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNum', order: 'descending'}" ref="table1">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Average_Content ModuleKPI" v-if="cur==2">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNum', order: 'descending'}" ref="table2">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Attendance_Content ModuleKPI" v-if="cur==3">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table size="mini" :data="CurrentBoxTableTop" border @sort-change='SortChange' :default-sort="{prop: 'showNum', order: 'descending'}" ref="table3">
            <el-table-column label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
