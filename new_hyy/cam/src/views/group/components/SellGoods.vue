  ...
  <div class="BoxContainer">
    ...
    <div class="right-col">
      <ul class="listUl">
        <li class="first-li" @click="MeClick('0')" :class="{active:cur==0}">
          <div class="cont">
            <h1 class="BebasNeue">{{GoodTop.sppPrice | capitalizeOne}}</h1>
        ...
        <li @click="MeClick('1')" :class="{active:cur==1}">
          <div>卖品收入</div>
          <div>
            <span class="BebasNeue">{{GoodTop.salesVolume | capitalizeOne}}</span>{{GoodTop.salesVolume | foo}}
          </div>
        </li>
        <li @click="MeClick('2')" :class="{active:cur==2}">
          <div>购买率</div>
          <div>
            <span class="BebasNeue">{{GoodTop.buyRate | woo}}</span>%
          </div>
        </li>
        <li @click="MeClick('3')" :class="{active:cur==3}">
          <div>客单价</div>
          <div>
            <span class="BebasNeue">{{GoodTop.unitPrice | capitalizeOne}}</span>{{GoodTop.unitPrice | foo}}
          </div>
        </li>
        <li @click="MeClick('4')" :class="{active:cur==4}">
          <div>套餐销售占比</div>
          <div>
            <span class="BebasNeue">{{GoodTop.setmealSalesVolumePercent | woo}}</span>%
          </div>
        </li>
      </ul>
    </div>
    ...
    <div class="PerCapita_Content" v-if="cur==0">
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table :data="CurrentGoodTableTop" border size="mini" @sort-change='SortChange' :default-sort="{prop: 'showNumSell', order: 'descending'}" ref="table0">
    ...
    <div class="Revenue_Content ModuleKPI" v-if="cur==1">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 饼状图 -->
        <ve-ring class="veRing" :data="ChartRevenue" :settings="categorySettings" :extend="pieExtend" :colors="colors"></ve-ring>
      </div>
      <!--区域详情 -->
      <div class="ModuleTitleLayout CityModuleLayout">
        <div class="ModuleTitle">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table :data="CurrentGoodTableTop" border size="mini" @sort-change='SortChange' :default-sort="{prop: 'showNumSell', order: 'descending'}" ref="table1">
            <el-table-column prop="id" label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Purchase_Content ModuleKPI" v-if="cur==2">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 条形图 -->
        <ve-bar :data="ChartRate" :colors="barColors" :extend="barExtend"></ve-bar>
      ...
      <div class="ModuleTitleLayout CityModuleLayout">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table :data="CurrentGoodTableTop" border size="mini" @sort-change='SortChange' :default-sort="{prop: 'showNumSell', order: 'descending'}" ref="table2">
            <el-table-column prop="id" label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Customer_Content ModuleKPI" v-if="cur==3">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 条形图 -->
        <ve-bar :data="ChartsCust" :colors="barColors" :extend="barExtendTwo"></ve-bar>
      </div>
      <!--区域详情 -->
      <div class="ModuleTitleLayout CityModuleLayout">
        <div class="ModuleTitle">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table :data="CurrentGoodTableTop" border size="mini" @sort-change='SortChange' :default-sort="{prop: 'showNumSell', order: 'descending'}" ref="table3">
            <el-table-column prop="id" label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
    ...
    <div class="Purchase_Content ModuleKPI" v-if="cur==4">
      ...
      <div class="ModuleTitleLayout">
        ...
        <!-- 条形图 -->
        <ve-line :data="ChartsLine" :legend-visible="false" :settings="lineSettings" :extend="lineExtendMain"></ve-line>
      </div>
      <!--区域详情 -->
      <div class="ModuleTitleLayout CityModuleLayout">
        <div class="ModuleTitle">
        ...
        <div class="ModuleTable reset-table topTable">
          <el-table :data="CurrentGoodTableTop" border size="mini" @sort-change='SortChange' :default-sort="{prop: 'showNumSell', order: 'descending'}" ref="table4">
            <el-table-column prop="id" label="序号" min-width="68" type="index" align="left"></el-table-column>
            <el-table-column prop="name" label="城市名称" min-width="100" align="left">
              <template slot-scope="scope">
                <span class="color" @click="clickCity(scope.$index, scope.row)">{{ scope.row.name }}</span>
  ...
  data () {
      ...
      tooltip: {
        ...
        formatter: (params) => {
          let name = params[0].name,
            value = this.formatValue(params[0].value[1], '元');
    ...
    return {
      ...
      categorySettings: {
        ...
        label: {
          formatter: (params) => {
            let value = this.formatValue(params.value * 1, '元');
            let percent = params.percent;
            let str = percent + '%';
            return str;
          }
  ...
  methods: {
      ...
      if (ChartsDataX && ChartsDataY) {
        let foo = ChartsDataY.map(item => {
          return {
            ...
            value: (item.salesVolume || 0).toFixed(2)
          };
        });
      ...
      if (ChartsDataX && ChartsDataY) {
        let foo = ChartsDataY.map(item => {
          return {
            ...
            name: item.categoryName,
            '购买率': item.sellGoodsBuyRate && item.sellGoodsBuyRate.toFixed(2) || 0
          };
        });
      ...
      if (ChartsDataX && ChartsDataY) {
        let foo = ChartsDataY.map(item => {
          return {
            newName: item.categoryName.length > 8 ? (item.categoryName.substr(0, 8) + '...') : (item.categoryName),
            name: item.categoryName,
            '客单价': item.unitPrice && item.unitPrice.toFixed(2) || 0
          };
        });
    ...
    getSalesChart (res) {
      ...
      this.ChartsLine.rows = res.sellGoodsIndex.yAxis.map(item => {
        return {
          日期: item.dateKey,
          套餐销售占比: item.setmealSalesVolumePercent && item.setmealSalesVolumePercent.toFixed(2) || 0
        };
      });
    }
  }
