<template>
  <div class="mer-class-wrapper">
    ...
    <my-dialog title="商品类别" :isShow="dialogVisible" :dialogWidth="448" :dialogHeight="576" :marginTop="1" :marginBottom="1" :dialogContentHeight="440" @handleBtnComfirmClick="confirmTreeBtn" @handleBtnCancelClick="cancelTreeBtn" @close="handleClose">
      <div slot="dialog-content">
        ...
        <div class="tree-content">
          <el-tree :data="merClassObj.merClassArr" show-checkbox default-expand-all :node-key="String(Math.random())" ref="tree" highlight-current :props="defaultProps" icon-class="iconfont icon-neiye-zhankaijiantou"></el-tree>
        </div>
      </div>
    </my-dialog>
  </div>
