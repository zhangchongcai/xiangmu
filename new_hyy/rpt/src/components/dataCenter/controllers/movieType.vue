<template>
  <div>
    <el-select popper-class="rpt-select" v-model="movieTypeObj.movieType" placeholder="请选择" @change="getdataValue" @focus="focusBTn">
      <el-option label="全部" value></el-option>
      <el-option v-for="item in options" :key="item.propertyCode" :label="item.propertyValue" v-loading="loading" :value="item.propertyValue"></el-option>
    </el-select>
  </div>
</template>
