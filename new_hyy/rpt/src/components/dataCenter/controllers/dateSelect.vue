<template>
  <div style="display:inline-block;">
    <el-date-picker unlink-panels class="rpt-data-picker" v-model="dateSelectObj.dateTime" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="dateTimeChange"></el-date-picker>
  </div>
</template>
