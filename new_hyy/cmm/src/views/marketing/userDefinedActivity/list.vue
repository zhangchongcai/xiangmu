...
export default {
  ...
  methods: {
    ...
    //新建活动
    addAct () {
      this.$router.push({ path: 'userDefinedActivity/create' })
    },
    //修订活动
    reviseAct (scope) {
      this.$router.push({ path: 'userDefinedActivity/revise', query: { id: scope.row.id, activityState: scope.row.activityState } })
    },
    //修改活动
    updateAct (scope) {
      this.$router.push({ path: 'userDefinedActivity/edit', query: { id: scope.row.id } })
    },
    //查看活动
    actDetail (scope) {
    ...
    //复制活动
    copyAct (scope) {
      this.$router.push({ path: 'userDefinedActivity/copy', query: { id: scope.row.id, approvalResult: scope.row.approvalResult } })
    },
    //提交审批
