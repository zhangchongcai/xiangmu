                ...
                <el-collapse-item title="设置活动条件" name="2">
                    ...
                    <div v-if="basicDataForm.activityType==29">
                        ...
                        <el-form-item label="放映有效期:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.screeningValidity"  clearable @change="handleScreeningValidityChange">
                                    <el-option label="不限" value></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.screeningValidity=='TimeBetweenOperator'" prop="screeningValidityOption">
                                    <el-date-picker v-model="basicDataForm.screeningValidityOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd"  @change="setScreeningValidity" style="position: relative;top: 3px;margin-top: 0;"></el-date-picker>
                                </el-form-item>
                                ...
                                <div v-if="basicDataForm.openCardYears=='BetweenOperator'||basicDataForm.openCardYears=='not_BetweenOperator'">
                                    <el-row class="flex-base">
                                        <el-form-item :prop="'openCardYearsLimits.'+0" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[0]"  ></el-input>
                                        </el-form-item>
                                        <span>-</span>
                                        <el-form-item :prop="'openCardYearsLimits.'+1" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[1]"  ></el-input>
                                        </el-form-item>
                                    </el-row>
                                </div>
                            </el-row>
                                ...
                                <div v-if="basicDataForm.openCardMonths=='BetweenOperator'||basicDataForm.openCardMonths=='not_BetweenOperator'">
                                    <el-row class="flex-base">
                                        <el-form-item :prop="'openCardMonthsLimits.'+0" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[0]"  ></el-input>
                                        </el-form-item>
                                        <span>-</span>
                                        <el-form-item :prop="'openCardMonthsLimits.'+1" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[1]"  ></el-input>
                                        </el-form-item>
                                    </el-row>
                                </div>
                            </el-row>
                    ...
                    <el-form-item label="开卡日期:" v-if="basicDataForm.activityType!=29">
                        <el-row class="flex-base">
                            ...
                            <el-form-item prop="openDateCardOption" v-if="basicDataForm.openCardDate=='DateRangeContainOperator'||basicDataForm.openCardDate=='not_DateRangeContainOperator'">
                                <el-date-picker v-model="basicDataForm.openDateCardOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd"  @change="setOpenCardDate" style="position: relative;top: 3px;"></el-date-picker>
                            </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            subComName:"giftBalanceActivity_"+this.pageType,//缓存数据唯一标识
            //限制过去时间不可选
            pickerOptions: {
                disabledDate(time) {
            ...
            basicDataRule: {
                ...
                tradingMerchantInput: [{
                    ...
                    validator: (rules, value, callback) => {
                        if (!value) {
                            return callback(new Error(this.basicDataForm.activityType == 27?'注册影院不能为空':'交易影院不能为空'));
                        }
                        return callback();
                    },
                    trigger: "change"
    ...
    methods: {
        ...
        returnList() {
            ...
            this.$router.push({name:'赠送余额活动管理'});
        },
        //验证开卡年限
