            ...
            <el-form :model="basicDataForm" :rules="basicDataRule" ref="basicDataForm" label-width="120px" class="common-form">
                ...
                <el-collapse-item title="设置活动条件" name="2">
                    ...
                    <el-form-item label="支付方式:">
                        <el-row class="flex-base">
                            ...
                            <el-form-item v-if="basicDataForm.payType!=''" prop="payTypeInput">
                                <el-input class="chooseWidth1 input-dialog" v-if="basicDataForm.payType!=''" v-model="basicDataForm.payTypeInput" readonly></el-input>
                    ...
                    <el-form-item :label="basicDataForm.activityType == 23 || basicDataForm.activityType == 24?'单次充值金额:':'单次消费金额:'" style="margin-bottom:28px">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.sumPrice"  v-if="basicDataForm.activityType == 23 || basicDataForm.activityType == 24">
                                <el-option label="不限" value></el-option>
                            ...
                            <el-select v-model="basicDataForm.sumPrice"  v-else>
                                <el-option label="不限" value></el-option>
                            ...
                            <el-form-item v-if="basicDataForm.sumPrice!=''" prop="sumPriceInput">
                                <el-input class="input-type-94" v-model="basicDataForm.sumPriceInput"  placeholder="请输入"></el-input>
                                <span>元</span>
                            </el-form-item>
                        </el-row>
                    </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            subComName:"giftPointsActivity_"+this.pageType,//缓存数据唯一标识
            //限制过去时间不可选
            pickerOptions: {
                disabledDate(time) {
