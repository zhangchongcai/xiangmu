<template>
    <div class="movie-plan_default">
            ...
            <el-form :model="basicDataForm" :rules="basicDataRule" ref="basicDataForm" label-width="120px" class="common-form">
                ...
                <el-collapse-item title="活动基础信息" name="1">
                    <el-form-item label="活动类型:" size="small" prop="activityType">
                        <el-radio-group v-model="basicDataForm.activityType"  @change="change">
                            <el-radio-button :label="30">开卡送票券</el-radio-button>
                            <el-radio-button :label="31">充值送票券</el-radio-button>
                            <el-radio-button :label="32">消费送票券</el-radio-button>
                        </el-radio-group>
                    </el-form-item>
                    ...
                    <el-form-item :label="basicDataForm.activityType == 30?'注册渠道:':'交易渠道:'">
                ...
                <el-collapse-item title="设置活动条件" name="2">
                    <el-row class="flex-base">
                        <el-form-item :label="basicDataForm.activityType == 30?'注册影院:':'交易影院:'" prop="tradingMerchant">
                            <el-select v-model="basicDataForm.tradingMerchant"  @change="clearSelfValidate(basicDataForm.tradingMerchant)">
                                <el-option label="包含" value="normalIn"></el-option>
                                <el-option label="不包含" value="normalNotIn"></el-option>
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item prop="tradingMerchantInput" class="tradingMerchantInput">
                            ...
                            <el-tooltip placement="bottom" v-show="basicDataForm.tradingMerchantInput">
                                <el-input class="chooseWidth1 input-dialog" v-model="basicDataForm.tradingMerchantInput" v-if="basicDataForm.tradingMerchant=='normalIn'" readonly></el-input>
                                <div slot="content">
                    ...
                    <el-form-item label="会员卡政策:">
                        <el-row class="flex-base">
                            ...
                            <el-form-item v-if="basicDataForm.membershipLevel=='normalIn' || basicDataForm.membershipLevel=='normalNotIn'" prop="membershipLevelInput">
                                <el-input class="chooseWidth1 input-dialog" v-model="basicDataForm.membershipLevelInput" readonly></el-input>
                    ...
                    <div v-if="basicDataForm.activityType==32">
                        <el-form-item label="放映效果:">
                            <el-row class="flex-base">
                                ...
                                <el-form-item v-if="basicDataForm.projectionEffect!=''" prop="projectionEffectInput">
                                    <el-input class="chooseWidth1 input-dialog" v-model="basicDataForm.projectionEffectInput" ></el-input>
                        ...
                        <el-form-item label="影片:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.film" >
                                    <el-option label="不限" value></el-option>
                                    <el-option label="包含" value="normalIn"></el-option>
                                    <el-option label="不包含" value="normalNotIn"></el-option>
                                </el-select>
                                ...
                                <el-form-item v-if="basicDataForm.film!=''" prop="filmInput">
                                    <el-input class="chooseWidth1 input-dialog" v-model="basicDataForm.filmInput" readonly></el-input>
                        ...
                        <el-form-item label="放映有效期:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.screeningValidity" >
                                    <el-option label="不限" value></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.screeningValidity=='TimeBetweenOperator'" prop="screeningValidityOption">
                                    <el-date-picker v-model="basicDataForm.screeningValidityOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd"  style="position: relative;top: 3px;margin-top: 0;" @change="setOpenCardDate"></el-date-picker>
                                </el-form-item>
                    ...
                    <!-- 开卡送余额 -->
                    <el-form-item label="支付方式:" v-if="basicDataForm.activityType!=31">
                        <el-row class="flex-base">
                    ...
                    <el-form-item label="首充金额:" v-if="basicDataForm.activityType==30">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.firstChargeAmount" >
                                <el-option label="不限" value=""></el-option>
                                <el-option label="大于" value="normalGreater"></el-option>
                                <el-option label="等于" value="normalEqual"></el-option>
                                <el-option label="小于" value="normalLess"></el-option>
                            ...
                            <el-form-item v-if="basicDataForm.firstChargeAmount!=''&&basicDataForm.firstChargeAmount!='BetweenOperator'&&basicDataForm.firstChargeAmount!='not_BetweenOperator'" prop="firstChargeAmountInput">
                                <el-row>
                                    <el-input class="input-type-94" v-model="basicDataForm.firstChargeAmountInput"  placeholder="请输入"></el-input>
                                    <span>元</span>
                                </el-row>
                            </el-form-item>
                            ...
                            <div v-if="basicDataForm.firstChargeAmount=='BetweenOperator'||basicDataForm.firstChargeAmount=='not_BetweenOperator'">
                                <el-row class="flex-base">
                                    <el-form-item :prop="'firstChargeAmountLimits.'+0" :rules="{required: true, validator: verificationFirstCharge, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.firstChargeAmountLimits[0]"  ></el-input>
                                    </el-form-item>

                                    <span>-</span>

                                    <el-form-item :prop="'firstChargeAmountLimits.'+1" :rules="{required: true, validator: verificationFirstCharge, trigger: 'blur'}">
                                        <el-input class="input-type-94" v-model="basicDataForm.firstChargeAmountLimits[1]"  ></el-input>
                                    </el-form-item>
                                </el-row>
                            </div>
                        </el-row>
                    </el-form-item>
                    <div v-if="basicDataForm.activityType==31">
                        <!-- 充值送票券 -->
                        <el-form-item label="单次充值金额:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.chargeAmount" >
                                    <el-option label="不限" value></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.chargeAmount!=''" prop="chargeAmountInput">
                                    <el-row class="flex-base">
                                        <el-input class="input-type-94" v-model="basicDataForm.chargeAmountInput"  placeholder="请输入"></el-input>
                                        <span>元</span>
                                    </el-row>
                                </el-form-item>
                            </el-row>
                        ...
                        <el-form-item label="累计充值金额:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.chargeAmountSum" >
                                    <el-option label="不限" value></el-option>
                                    <el-option label="大于" value="normalGreater"></el-option>
                                    <el-option label="等于" value="normalEqual"></el-option>
                                    <el-option label="小于" value="normalLess"></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.chargeAmountSum!=''" prop="chargeAmountSumInput">
                                    <el-row class="flex-base">
                                        <el-input class="input-type-94" v-model="basicDataForm.chargeAmountSumInput"  placeholder="请输入"></el-input>
                                        <span>元</span>
                                    </el-row>
                                </el-form-item>
                            </el-row>
                        ...
                        <el-form-item label="累计消费金额:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.consumeAmountSum" >
                                    <el-option label="不限" value></el-option>
                                    <el-option label="大于" value="normalGreater"></el-option>
                                    <el-option label="等于" value="normalEqual"></el-option>
                                    <el-option label="小于" value="normalLess"></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.consumeAmountSum!=''" prop="consumeAmountSumInput">
                                    <el-row class="flex-base">
                                        <el-input class="input-type-94" v-model="basicDataForm.consumeAmountSumInput"  placeholder="请输入"></el-input>
                                        <span>元</span>
                                    </el-row>
                                </el-form-item>
                            </el-row>
                        ...
                        <el-form-item label="生日:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.birthday" >
                                    <el-option label="不限" value></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.birthday=='EqualCurrentMonthOffset'" prop="birthdayInput">
                                    <el-input class="input-type-94" v-model="basicDataForm.birthdayInput"  placeholder="请输入"></el-input>
                                </el-form-item>
                            </el-row>
                        </el-form-item>
                        ...
                        <el-form-item label="开卡年限:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.openCardYears" >
                                    <el-option label="不限" value></el-option>
                                    <el-option label="大于" value="normalGreater"></el-option>
                                    <el-option label="等于" value="normalEqual"></el-option>
                                    <el-option label="小于" value="normalLess"></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.openCardYears!=''&&basicDataForm.openCardYears!='BetweenOperator'&&basicDataForm.openCardYears!='not_BetweenOperator'" prop="openCardYearsInput">
                                    <el-input class="input-type-94" v-model="basicDataForm.openCardYearsInput"  placeholder="请输入"></el-input>
                                </el-form-item>
                                ...
                                <div v-if="basicDataForm.openCardYears=='BetweenOperator'||basicDataForm.openCardYears=='not_BetweenOperator'">
                                    <el-row class="flex-base">
                                        <el-form-item :prop="'openCardYearsLimits.'+0" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[0]"  placeholder="请输入"></el-input>
                                        </el-form-item>

                                        <span>-</span>

                                        <el-form-item :prop="'openCardYearsLimits.'+1" :rules="{required: true, validator: verificationYears, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardYearsLimits[1]"  placeholder="请输入"></el-input>
                                        </el-form-item>
                                    </el-row>
                                </div>
                            </el-row>
                        ...
                        <el-form-item label="开卡月限:">
                            <el-row class="flex-base">
                                <el-select v-model="basicDataForm.openCardMonths" >
                                    <el-option label="不限" value></el-option>
                                    <el-option label="大于" value="normalGreater"></el-option>
                                    <el-option label="等于" value="normalEqual"></el-option>
                                    <el-option label="小于" value="normalLess"></el-option>
                                ...
                                <el-form-item v-if="basicDataForm.openCardMonths!=''&&basicDataForm.openCardMonths!='BetweenOperator'&&basicDataForm.openCardMonths!='not_BetweenOperator'" prop="openCardMonthsInput">
                                    <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsInput"  placeholder="请输入"></el-input>
                                </el-form-item>
                                ...
                                <div v-if="basicDataForm.openCardMonths=='BetweenOperator'||basicDataForm.openCardMonths=='not_BetweenOperator'">
                                    <el-row class="flex-base">
                                        <el-form-item :prop="'openCardMonthsLimits.'+0" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[0]"  placeholder="请输入"></el-input>
                                        </el-form-item>

                                        <span>-</span>

                                        <el-form-item :prop="'openCardMonthsLimits.'+1" :rules="{required: true, validator: verificationMonths, trigger: 'blur'}">
                                            <el-input class="input-type-94" v-model="basicDataForm.openCardMonthsLimits[1]"  placeholder="请输入"></el-input>
                                        </el-form-item>
                                    </el-row>
                                </div>
                            </el-row>
                    ...
                    <el-form-item label="开卡日期:" v-if="basicDataForm.activityType!=32">
                        <el-row class="flex-base">
                            <el-select v-model="basicDataForm.openCardDate" >
                                <el-option label="不限" value></el-option>
                            ...
                            <el-form-item prop="openDateCardOption" v-if="basicDataForm.openCardDate=='DateRangeContainOperator'||basicDataForm.openCardDate=='not_DateRangeContainOperator'">
                                <el-date-picker v-model="basicDataForm.openDateCardOption" :picker-options="pickerOptions" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd"  style="position: relative;top: 3px;margin-top: 0;" @change="setOpenCardDate"></el-date-picker>
                            </el-form-item>
                            ...
                            <el-form-item prop="openCardDateInput" v-if="basicDataForm.openCardDate!='DateRangeContainOperator'&&basicDataForm.openCardDate!='not_DateRangeContainOperator'&&basicDataForm.openCardDate!=''">
                                <el-date-picker v-model="basicDataForm.openCardDateInput" :picker-options="pickerOptions" style="width: 200px;" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" ></el-date-picker>
                            </el-form-item>
                        </el-row>
                    </el-form-item>
                </el-collapse-item>
                ...
                <el-collapse-item title="设置优惠方案" name="3">
                    <el-form-item label="选择赠送票券:" prop="giftTicketInput">
                        <el-input class="input-type-166" v-model="basicDataForm.giftTicketInput"   readonly></el-input>
                        <el-button type="primary" class="windowBtn" @click="couponBatchSingleClick('giftCouponBatchSingleDialog',{value:basicDataForm.giftTicketId,text:basicDataForm.giftTicketInput})" plain>选择</el-button>
                    </el-form-item>

                    <el-form-item label="数量:" prop="num">
                        <el-input class="input-type-94" v-model="basicDataForm.num"  placeholder="请输入"></el-input>
                    </el-form-item>

                    <el-form-item label="是否发送短信:">
                        <el-select v-model="basicDataForm.isSendSms" >
                            <el-option label="是" value="send"></el-option>
                            <el-option label="否" value="unsend"></el-option>
                        </el-select>
                    </el-form-item>
                    <!-- 隐藏短信模板（需要等后端提供接口） -->
                    <!-- <div v-if="basicDataForm.isSendSms == 'send'">
                        <el-form-item label="选择方式:">
                            <el-form-item>
                                <el-radio v-model="basicDataForm.messageMode" label="template">按已有模板发送短信内容</el-radio>
                                <el-select v-if="basicDataForm.messageMode == 'template'" v-model="basicDataForm.messageTemplate" >
                                    <el-option label="短信模板1" value="messageTemplate1"></el-option>
                                    <el-option label="短信模板2" value="messageTemplate2"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item >
                                <el-radio v-model="basicDataForm.messageMode" label="customized">发送自定义内容</el-radio>
                            </el-form-item>
                        </el-form-item>
                        <el-form-item label="短信内容:">
                            <el-input type="textarea" :rows="8" style="width: 400px;" v-model="basicDataForm.messageContent"  placeholder="请输入短信内容(提醒:一条短信超过70个字的部分，以新的短信计算)" ></el-input>
                            <span>当前输入:<span v-text="basicDataForm.messageNum"></span>个字</span>
                        </el-form-item>
                    </div> -->
                </el-collapse-item>
                ...
                <el-collapse-item title="设置活动预算" name="4">
                    <el-form-item label="活动总预算:" >
                        <el-select v-model="basicDataForm.activityBudgetSum" >
                            <el-option label="不限制" value></el-option>
                            <el-option label="指定预算限制" value="1"></el-option>
                        </el-select>

                        <el-form-item v-if="basicDataForm.activityBudgetSum==1">
                            <el-form-item prop="activityBudgetSumInput">
                                <span>{{basicDataForm.activityType == 30 ? '开卡总数量限制' : basicDataForm.activityType==31 ? '充值次数限制' : basicDataForm.activityType==32 ? '交易次数限制' : ''}}</span>
                                <el-input class="input-type-94" v-model="basicDataForm.activityBudgetSumInput"  placeholder="请输入"></el-input>
                                <span>{{basicDataForm.activityType == 30 ? '张' : '次'}}</span>
                            </el-form-item>
                        </el-form-item>
                    </el-form-item>

                    <el-form-item label="单用户限制:" v-if="basicDataForm.activityType!=30">
                        <el-select v-model="basicDataForm.singleUserLimit" >
                            <el-option label="不限制" value></el-option>
                            <el-option label="指定预算限制" value="1"></el-option>
                        </el-select>

                        <el-form-item v-if="basicDataForm.singleUserLimit==1">
                            <el-form-item prop="singleUserLimitInput">
                                <span>{{basicDataForm.activityType==31?'充值':'交易'}}次数限制</span>
                                <el-input class="input-type-94" v-model="basicDataForm.singleUserLimitInput"  placeholder="请输入"></el-input>
                                <span>次</span>
                            </el-form-item>
                        </el-form-item>
                    </el-form-item>
        ...
        <section class="alert-group">
            ...
            <!-- 票券批次弹窗 -->
            <couponBatchDialog :title="couponBatchDialog.title" :dialogTableVisible.sync="couponBatchDialog.couponBatchDialogVisible" ref="giftCouponBatchDialog" @callBack="handleGiftCouponBatchCallBack"></couponBatchDialog>
            <!-- 票券批次单选弹窗 -->
            <couponBatchSingleDialog :title="couponBatchSingleDialog.title" :dialogTableVisible.sync="couponBatchSingleDialog.couponBatchSingleDialogVisible" ref="giftCouponBatchSingleDialog" @callBack="handleGiftCouponBatchSingleCallBack"></couponBatchSingleDialog>
            <!-- 交易渠道弹窗 -->
...
export default {
    ...
    data() {
        return {
            ...
            subComName:"giftTicketsActivity_"+this.pageType,//缓存数据唯一标识
            //限制过去时间不可选
            pickerOptions: {
                disabledDate(time) {
            ...
            basicDataRule: {
                ...
                tradingMerchantInput: [{
                    ...
                    validator: (rules, value, callback) => {
                        if (!value) {
                            return callback(new Error(this.basicDataForm.activityType == 30?'注册影院不能为空':'交易影院不能为空'));
                        }
                        return callback();
                    },
                    trigger: "change"
                ...
                activityBudgetSumInput:[{
                    ...
                    validator: (rules, value, callback) => {
                        if (!value) {
                            return callback(new Error('活动总预算不能为空'));
                        }
                        let regExp = /^[1-9]\d*$/;
                        if (!regExp.test(value) || value == 0) {
                            return callback(new TypeError('请输入正整数'));
    ...
    methods: {
            ...
            for (let item of ruleConditions) {
                switch (item.key) {
                    ...
                    case "openDate": //开卡日期
                        ...
                        if(item.opUniqueName=='DateRangeContainOperator'||item.opUniqueName=='not_DateRangeContainOperator'){
                            this.basicDataForm.openDateCardOption = JSON.parse(item.value);
                        }else{
                    ...
                    case "openYears": //开卡年限
                        if(item.opUniqueName!=''&&item.opUniqueName!='BetweenOperator'&&item.opUniqueName!='not_BetweenOperator'){
                            ...
                            console.log(this.basicDataForm.openCardYearsLimits)
                        }
                        break;
        ...
        showActionsData(actions){
            for (let item of actions) {
                if (item.key == "couponApplyCode") {
                    this.basicDataForm.giftTicketId = item.value;
                    this.basicDataForm.giftTicketInput = item.text;
                } else if (item.key == "amount") {
                    this.basicDataForm.num = item.value;
                } else if (item.key == "isSendSms") {
                    this.basicDataForm.isSendSms = item.value;
                }
            }
        },
        //回显活动预算数据 
        showBizPropertyMapData(bizPropertyMap){
            ...
            if (this.basicDataForm.activityType == 30) {
        ...
        //验证首充金额
        verificationFirstCharge(rules, value, callback){
            if (!value) {
                return callback(new Error('首充金额不能为空'));
            }
            let regExp = /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/;
        ...
        setOpenCardDate(val) {
            if (val) {
                ...
                this.basicDataForm.openDateCardOption = val;
            } else {
        ...
        //取消验证
        clearSelfValidate(isClude) {
            if(isClude=='normalNotIn'){
                this.$refs["basicDataForm"].clearValidate();
            }
        },
        //验证时段范围
        ...
        buildCommonInfoData() {
            ...
            //开卡送票券
            if(this.basicDataForm.activityType==30) tradeTypeValue="MEMBER_ACTIVE_CARD"
            //充值送票券
            if(this.basicDataForm.activityType==31) tradeTypeValue="MEMBER_ADD_AMOUNT"
        ...
        buildRuleConditionsData() {
            ...
            if (this.basicDataForm.activityType != 31) {
                // 支付方式
            ...
            if (this.basicDataForm.openCardDate != "") {
                if(this.basicDataForm.openCardDate=='DateRangeContainOperator'||this.basicDataForm.openCardDate=='not_DateRangeContainOperator'){
                    this.ruleConditions.push({
                        category: "MemberInfo",
                        key: "openDate",
                        groupId: 12,
                        value: JSON.stringify(this.basicDataForm.openDateCardOption),
                        text: "",
                        opUniqueName: this.basicDataForm.openCardDate
                    });
                }else{
                    console.log(this.basicDataForm.openCardDateInput)
                    this.ruleConditions.push({
                        category: "MemberInfo",
                        key: "openDate",
                        groupId: 12,
            ...
            if (this.basicDataForm.activityType == 32) {
                // 放映效果
        ...
        buildActionsData() {
            ...
            //赠送票券
            if (this.basicDataForm.giftTicketInput != "") {
                this.actions.push({
                    key: "couponApplyCode",
                    groupId: 3,
                    value: this.basicDataForm.giftTicketId,
                    text: this.basicDataForm.giftTicketInput,
                    opUniqueName: "PresentCoupon"
                });
            }
            if (this.basicDataForm.num != "") {
                this.actions.push({
                    key: "amount",
                    groupId: 3,
                    value: this.basicDataForm.num,
                    text: "",
                    opUniqueName: "PresentCoupon"
                });
            }
            if (this.basicDataForm.isSendSms != "") {
                //是否发送短信
                this.actions.push({
                    key: "isSendSms",
                    groupId: 3,
                    value: this.basicDataForm.isSendSms,
                    text: "",
                    opUniqueName: "PresentCoupon"
                });
                // //短信选择方式value(选择已有短信模板:template,发送自定义内容:customized)
                // this.actions.push({
                //     key: "isUseModel",
                //     groupId: 3,
                //     value:this.basicDataForm.messageMode,
                //     text: "",
                //     opUniqueName: "PresentCoupon"
                // });
                // //短信模板
                ...
                //     key: "smsModelCode",
                //     groupId: 3,
                //     value:this.basicDataForm.messageTemplate,
                //     text: "",
                //     opUniqueName: "PresentCoupon"
                // });
                // //短信内容
                ...
                //     key: "msgContent",
                //     groupId: 3,
                //     value:this.basicDataForm.messageContent,
                //     text: "",
                //     opUniqueName: "PresentCoupon"
                // });
            }
        ...
        buildBizPropertyMap() {
            ...
            }else if(this.basicDataForm.activityType == 31){
                this.bizPropertyMap = {
                    runAmount: runAmount, //执行次数
                    userTradeAmount: userTradeAmount, //单用户交易限制
                };
            }else if(this.basicDataForm.activityType == 32){
                this.bizPropertyMap = {
                    runAmount: runAmount, //执行次数
                    userTradeAmount: userTradeAmount, //单用户交易限制
                };
