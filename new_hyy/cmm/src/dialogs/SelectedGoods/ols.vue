    ...
    <div class="my_dialog">
      <el-dialog title="商品" :close-on-click-modal="false" :visible.sync="dialigVisible" @close="closeDialog">
        ...
        <div class="choose_table">
          <div>
            <el-table :data="tableData" :cell-style="{padding:0}" :row-style="{height:30}" :header-cell-style="{padding:0}" :height="354" ref="multipleTable" @select="selectRow" @select-all="selectAll" :row-key="getRowKeys">
