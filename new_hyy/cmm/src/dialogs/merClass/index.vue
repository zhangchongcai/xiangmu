<template>
  <div class="mer-class-wrapper">
    <my-dialog title="商品类别" :isShow="dialogVisible" :dialogWidth="448" :dialogHeight="576" :dialogContentHeight="473" @handleBtnComfirmClick="confirmTreeBtn" @handleBtnCancelClick="cancelTreeBtn" @close="handleClose" :close-on-click-modal="false">
      <div slot="dialog-content">
        ...
        <div class="tree-content">
          <el-tree :data="merClassArr" show-checkbox default-expand-all node-key="seq" ref="tree" highlight-current :props="defaultProps" icon-class="iconfont icon-neiye-zhankaijiantou"></el-tree>
        </div>
      </div>
    </my-dialog>
  </div>
