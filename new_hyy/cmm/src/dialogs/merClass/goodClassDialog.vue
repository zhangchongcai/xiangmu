  ...
  <div class="my_dialog">
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="mydialogTableVisible">
      ...
      <div style="max-height:410px;overflow-x:hidden;overflow-y:scroll;">
        <el-tree @node-click="handleNodeClick" show-checkbox :data="dataTree" node-key="uid" ref="tree" default-expand-all :filter-node-method="filterNode" :check-strictly="false" :expand-on-click-node="false" :props="defaultProps" :default-checked-keys="reviewList" style="min-height:410px;">
        </el-tree>
      </div>
...
<script>
import { getCategoryTrees } from "cmmSrc/http/interface.js"
export default {
  props: {
    dialogTableVisible: {
      type: Boolean,
