  ...
  <div class="my_dialog">
    <el-dialog :title="title" :close-on-click-modal="false" :visible.sync="mydialogTableVisible">
      ...
      <div style="max-height:410px;overflow-x:hidden;overflow-y:scroll;">
        <el-tree @node-click="handleNodeClick" show-checkbox :data="dataTree" node-key="id" ref="tree" default-expand-all :filter-node-method="filterNode" :check-strictly="true" :expand-on-click-node="false" :props="defaultProps" :default-checked-keys="reviewList" style="min-height:410px;">
        </el-tree>
      </div>
