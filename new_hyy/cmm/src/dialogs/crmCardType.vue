          ...
          <div class="__crm-available-coupon-dialog-content-left">
            <div class="__crm-available-coupon-dialog-table _m-member-table-custom">
              <el-table ref="multipleTable" :data="tableData" stripe style="width: 100%" @select="handleSelect" @select-all="handleSelect" :row-key="getRowKeys">
                ...
                <el-table-column prop="cardType" :formatter="emptyShow" label="会员卡类型名称" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column prop="cardTypeCode" :formatter="emptyShow" label="会员卡类型编号" min-width="120" show-overflow-tooltip></el-table-column>
              </el-table>
            </div>
          </div>
