          ...
          <div class="__crm-available-coupon-dialog-content-left">
            <div class="__crm-available-coupon-dialog-table _m-member-table-custom">
              <el-table ref="multipleTable" :empty-text="tipMessage" :data="tableData" stripe style="width: 100%" @select="handleSelect" @select-all="handleSelect" :row-key="getRowKeys">
                ...
                <el-table-column prop="productNo" :formatter="emptyShow" label="政策编号" min-width="100" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="cardName" :formatter="emptyShow" label="政策名称" min-width="100" show-overflow-tooltip>
                </el-table-column>
              </el-table>
              <!-- 分页 start -->
...
import dialogWarp from './dialogWarp.vue';
