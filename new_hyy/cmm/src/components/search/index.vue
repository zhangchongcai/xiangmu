<template>
  <div class="search-window">
    ...
    <section class="alert-group">
      <!-- 选择组织结构 -->
      <orgStructureDialog :title="orgStructureDialog.title" :dialogTableVisible.sync="orgStructureDialog.orgStructureDialogVisible" ref="orgStructureDialog" @callBack="handleOrgStructureBack">
      </orgStructureDialog>
      <!-- 选择影院 -->
      <cinemaDialog :title="cinemaDialog.title" :dialogTableVisible.sync="cinemaDialog.cinemaDialogVisible" ref="cinemaDialog" @callBack="handleCinemaBack">
      </cinemaDialog>
      <!-- 选择审批人 -->
      <userDialog :title="userApprovalDialog.title" :dialogTableVisible.sync="userApprovalDialog.userApprovalDialogVisible" ref="userApprovalDialog" @callBack="handleUserApprovalBack">
      </userDialog>
      <!-- 选择创建人 -->
      <userDialog :title="userCreaterDialog.title" :dialogTableVisible.sync="userCreaterDialog.userCreaterDialogVisible" ref="userCreaterDialog" @callBack="handleUserCreaterBack">
      </userDialog>
